...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__assets_metamorphous_regular_ttf);
...
@:sound("/usr/local/lib/haxe/lib/flixel/4,1,1/assets/sounds/beep.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_beep_ogg extends flash.media.Sound {}
@:sound("/usr/local/lib/haxe/lib/flixel/4,1,1/assets/sounds/flixel.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends flash.media.Sound {}
@:font("/usr/local/lib/haxe/lib/flixel/4,1,1/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("/usr/local/lib/haxe/lib/flixel/4,1,1/assets/fonts/monsterrat.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends flash.text.Font {}
@:bitmap("/usr/local/lib/haxe/lib/flixel/4,1,1/assets/images/ui/button.png") @:keep #if display private #end class __ASSET__flixel_images_ui_button_png extends flash.display.BitmapData {}



@:keep class __ASSET__assets_achafont_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/Achafont.ttf"; fontName = "A Charming Font"; }}
@:keep class __ASSET__assets_metamorphous_regular_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/Metamorphous-Regular.ttf"; fontName = "Metamorphous"; }}


#else


class __ASSET__assets_achafont_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/Achafont.ttf"; fontName = "A Charming Font";  }}
class __ASSET__assets_metamorphous_regular_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/Metamorphous-Regular.ttf"; fontName = "Metamorphous";  }}
...
@:keep #if display private #end class __ASSET__assets_achafont_ttf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/Achafont.ttf"; name = "A Charming Font"; super (); }}
@:keep #if display private #end class __ASSET__assets_metamorphous_regular_ttf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/Metamorphous-Regular.ttf"; name = "Metamorphous"; super (); }}


#if (windows || mac || linux || cpp)


@:file("/usr/local/lib/haxe/lib/flixel/4,1,1/assets/sounds/beep.ogg") #if display private #end class __ASSET__flixel_sounds_beep_ogg extends lime.utils.ByteArray {}
@:file("/usr/local/lib/haxe/lib/flixel/4,1,1/assets/sounds/flixel.ogg") #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends lime.utils.ByteArray {}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_achafont_ttf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/Achafont.ttf"; name = "A Charming Font"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__assets_metamorphous_regular_ttf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/Metamorphous-Regular.ttf"; name = "Metamorphous"; super (); }}
