...
class HXCPP_CLASS_ATTRIBUTES Matrix3D_obj : public hx::Object
{
	...
	public:
		...
		void copyRawDataFrom(::Array< Float > vector,hx::Null< Int >  index,hx::Null< Bool >  transpose);
		::Dynamic copyRawDataFrom_dyn();

		void copyRawDataTo(::Array< Float > vector,hx::Null< Int >  index,hx::Null< Bool >  transpose);
		...
		::Array< ::Dynamic> decompose( ::Dynamic orientationStyle);
		...
		Bool recompose(::Array< ::Dynamic> components, ::Dynamic orientationStyle);
		::Dynamic recompose_dyn();

		 ::openfl::geom::Vector3D transformVector( ::openfl::geom::Vector3D v);
		::Dynamic transformVector_dyn();

		void transformVectors(::Array< Float > vin,::Array< Float > vout);
