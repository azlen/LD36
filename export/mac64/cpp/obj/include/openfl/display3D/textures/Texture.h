...
class HXCPP_CLASS_ATTRIBUTES Texture_obj : public  ::openfl::display3D::textures::TextureBase_obj
{
	...
	public:
		...
		void uploadFromBitmapData( ::openfl::_legacy::display::BitmapData bitmapData,hx::Null< Int >  miplevel);
		::Dynamic uploadFromBitmapData_dyn();

		void uploadFromByteArray( ::openfl::_legacy::utils::ByteArray data,Int byteArrayOffset,hx::Null< Int >  miplevel);
		::Dynamic uploadFromByteArray_dyn();

		void uploadFromUInt8Array( ::openfl::_legacy::utils::UInt8Array data,hx::Null< Int >  miplevel);
