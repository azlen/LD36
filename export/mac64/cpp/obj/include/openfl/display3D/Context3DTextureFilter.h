...
class Context3DTextureFilter_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("openfl.display3D.Context3DTextureFilter","\xcc","\x86","\xe2","\x3c"); }
		::String __ToString() const { return HX_HCSTRING("Context3DTextureFilter.","\x3b","\x62","\xc5","\xf2") + _hx_tag; }
