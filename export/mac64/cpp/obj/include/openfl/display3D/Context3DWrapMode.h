...
class Context3DWrapMode_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("openfl.display3D.Context3DWrapMode","\x14","\xe1","\xdf","\xf5"); }
		::String __ToString() const { return HX_HCSTRING("Context3DWrapMode.","\xe1","\xb8","\xa8","\x0d") + _hx_tag; }
