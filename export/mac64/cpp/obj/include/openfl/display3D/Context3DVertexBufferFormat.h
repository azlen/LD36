...
class Context3DVertexBufferFormat_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("openfl.display3D.Context3DVertexBufferFormat","\x62","\x07","\x92","\xfd"); }
		::String __ToString() const { return HX_HCSTRING("Context3DVertexBufferFormat.","\x93","\xd5","\xa9","\x7f") + _hx_tag; }
