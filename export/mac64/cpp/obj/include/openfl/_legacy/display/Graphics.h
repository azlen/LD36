...
class HXCPP_CLASS_ATTRIBUTES Graphics_obj : public hx::Object
{
	...
	public:
		...
		void beginGradientFill(::hx::EnumBase type,::cpp::VirtualArray colors,::cpp::VirtualArray alphas,::cpp::VirtualArray ratios, ::openfl::_legacy::geom::Matrix matrix,::hx::EnumBase spreadMethod,::hx::EnumBase interpolationMethod,hx::Null< Float >  focalPointRatio);
		...
		void drawTriangles(::Array< Float > vertices,::Array< Int > indices,::Array< Float > uvtData,::hx::EnumBase culling,::Array< Int > colors,hx::Null< Int >  blendMode);
		...
		void lineGradientStyle(::hx::EnumBase type,::cpp::VirtualArray colors,::cpp::VirtualArray alphas,::cpp::VirtualArray ratios, ::openfl::_legacy::geom::Matrix matrix,::hx::EnumBase spreadMethod,::hx::EnumBase interpolationMethod,hx::Null< Float >  focalPointRatio);
		::Dynamic lineGradientStyle_dyn();

		void lineStyle( ::Dynamic thickness,hx::Null< Int >  color,hx::Null< Float >  alpha,hx::Null< Bool >  pixelHinting,::hx::EnumBase scaleMode,::hx::EnumBase caps,::hx::EnumBase joints,hx::Null< Float >  miterLimit);
