...
class HXCPP_CLASS_ATTRIBUTES Assets_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"openfl._legacy.Assets"); }
		...
		static Bool exists(::String id,::hx::EnumBase type);
		...
		static Bool isLocal(::String id,::hx::EnumBase type,hx::Null< Bool >  useCache);
		...
		static ::Array< ::String > list(::hx::EnumBase type);
