...
class HXCPP_CLASS_ATTRIBUTES AudioThreadState_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._legacy.media.AudioThreadState"); }
		...
		::Array< ::Dynamic> channelList;
		 ...
		 ::cpp::vm::Mutex mutex;
		void add( ::openfl::_legacy::media::SoundChannel channel);
		::Dynamic add_dyn();

		void remove( ::openfl::_legacy::media::SoundChannel channel);
		::Dynamic remove_dyn();
