...
class HXCPP_CLASS_ATTRIBUTES FlxPoint_obj : public hx::Object
{
	...
	public:
		...
		virtual  ::flixel::math::FlxPoint scale(Float k);
		::Dynamic scale_dyn();
		...
		::Dynamic copyTo_dyn();
		 ...
		 ::flixel::math::FlxPoint copyFromFlash( ::openfl::_legacy::geom::Point FlashPoint);
		::Dynamic copyFromFlash_dyn();

		 ::openfl::_legacy::geom::Point copyToFlash( ::openfl::_legacy::geom::Point FlashPoint);
		::Dynamic copyToFlash_dyn();

		 ::openfl::_legacy::geom::Point addToFlash( ::openfl::_legacy::geom::Point FlashPoint);
		::Dynamic addToFlash_dyn();

		 ::openfl::_legacy::geom::Point subtractFromFlash( ::openfl::_legacy::geom::Point FlashPoint);
		...
		::Dynamic destroy_dyn();
		 ...
		 ::flixel::math::FlxPoint transform( ::openfl::_legacy::geom::Matrix matrix);
