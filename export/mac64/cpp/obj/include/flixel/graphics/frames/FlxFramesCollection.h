...
class HXCPP_CLASS_ATTRIBUTES FlxFramesCollection_obj : public hx::Object
{
	...
	public:
		void __construct( ::flixel::graphics::FlxGraphic parent,::hx::EnumBase type, ::flixel::math::FlxPoint border);
		...
		static hx::ObjectPtr< FlxFramesCollection_obj > __new( ::flixel::graphics::FlxGraphic parent,::hx::EnumBase type, ::flixel::math::FlxPoint border);
