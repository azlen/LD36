...
class FlxDrawItemType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("flixel.graphics.tile.FlxDrawItemType","\xb4","\xaa","\x75","\xd0"); }
		::String __ToString() const { return HX_HCSTRING("FlxDrawItemType.","\xcb","\xf1","\x5f","\x54") + _hx_tag; }
