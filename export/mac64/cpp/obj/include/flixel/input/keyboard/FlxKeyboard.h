...
class HXCPP_CLASS_ATTRIBUTES FlxKeyboard_obj : public  ::flixel::input::FlxKeyManager_obj
{
	...
	public:
		...
		void onKeyUp( ::openfl::_legacy::events::KeyboardEvent event);

		void onKeyDown( ::openfl::_legacy::events::KeyboardEvent event);

		Int resolveKeyCode( ::openfl::_legacy::events::KeyboardEvent e);
