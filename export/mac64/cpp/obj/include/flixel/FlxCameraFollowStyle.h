...
class FlxCameraFollowStyle_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("flixel.FlxCameraFollowStyle","\xfb","\x4d","\x2f","\xfa"); }
		::String __ToString() const { return HX_HCSTRING("FlxCameraFollowStyle.","\x65","\xa9","\xb1","\xad") + _hx_tag; }
