...
class HXCPP_CLASS_ATTRIBUTES IFlxPool_obj {
	public:
		...
		static inline void preAllocate( ::Dynamic _hx_,Int numObjects) {
			(_hx_.mPtr->*( static_cast< ::flixel::util::IFlxPool_obj *>(_hx_.mPtr->_hx_getInterface(0x5a90a383)))->_hx_preAllocate)(numObjects);
		}
		::cpp::VirtualArray (hx::Object :: *_hx_clear)(); 
		static inline ::cpp::VirtualArray clear( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( static_cast< ::flixel::util::IFlxPool_obj *>(_hx_.mPtr->_hx_getInterface(0x5a90a383)))->_hx_clear)();
		}
};
