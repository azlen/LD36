...
class HXCPP_CLASS_ATTRIBUTES IFlxSignal_obj {
	public:
		...
		static inline void add( ::Dynamic _hx_, ::Dynamic listener) {
			(_hx_.mPtr->*( static_cast< ::flixel::util::IFlxSignal_obj *>(_hx_.mPtr->_hx_getInterface(0x540588cf)))->_hx_add)(listener);
		}
		void (hx::Object :: *_hx_addOnce)( ::Dynamic listener); 
		static inline void addOnce( ::Dynamic _hx_, ::Dynamic listener) {
			(_hx_.mPtr->*( static_cast< ::flixel::util::IFlxSignal_obj *>(_hx_.mPtr->_hx_getInterface(0x540588cf)))->_hx_addOnce)(listener);
		}
		void (hx::Object :: *_hx_remove)( ::Dynamic listener); 
		static inline void remove( ::Dynamic _hx_, ::Dynamic listener) {
			(_hx_.mPtr->*( static_cast< ::flixel::util::IFlxSignal_obj *>(_hx_.mPtr->_hx_getInterface(0x540588cf)))->_hx_remove)(listener);
		}
		void (hx::Object :: *_hx_removeAll)(); 
		static inline void removeAll( ::Dynamic _hx_) {
			(_hx_.mPtr->*( static_cast< ::flixel::util::IFlxSignal_obj *>(_hx_.mPtr->_hx_getInterface(0x540588cf)))->_hx_removeAll)();
		}
		Bool (hx::Object :: *_hx_has)( ::Dynamic listener); 
		static inline Bool has( ::Dynamic _hx_, ::Dynamic listener) {
			return (_hx_.mPtr->*( static_cast< ::flixel::util::IFlxSignal_obj *>(_hx_.mPtr->_hx_getInterface(0x540588cf)))->_hx_has)(listener);
		}
		void (hx::Object :: *_hx_destroy)(); 
		static inline void destroy( ::Dynamic _hx_) {
			(_hx_.mPtr->*( static_cast< ::flixel::util::IFlxSignal_obj *>(_hx_.mPtr->_hx_getInterface(0x540588cf)))->_hx_destroy)();
		}
};
