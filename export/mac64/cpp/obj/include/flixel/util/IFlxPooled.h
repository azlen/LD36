...
class HXCPP_CLASS_ATTRIBUTES IFlxPooled_obj {
	public:
		...
		static inline void put( ::Dynamic _hx_) {
			(_hx_.mPtr->*( static_cast< ::flixel::util::IFlxPooled_obj *>(_hx_.mPtr->_hx_getInterface(0x9aa322a2)))->_hx_put)();
		}
		void (hx::Object :: *_hx_destroy)(); 
		static inline void destroy( ::Dynamic _hx_) {
			(_hx_.mPtr->*( static_cast< ::flixel::util::IFlxPooled_obj *>(_hx_.mPtr->_hx_getInterface(0x9aa322a2)))->_hx_destroy)();
		}
};
