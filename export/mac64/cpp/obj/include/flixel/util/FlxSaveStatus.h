...
class FlxSaveStatus_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("flixel.util.FlxSaveStatus","\xa7","\xaa","\xc7","\x52"); }
		::String __ToString() const { return HX_HCSTRING("FlxSaveStatus.","\xcd","\x4b","\x96","\xee") + _hx_tag; }
