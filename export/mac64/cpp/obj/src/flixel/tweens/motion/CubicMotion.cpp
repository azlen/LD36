...
HXLINE(  51)		Float _hx_tmp = ((((this->scale * this->scale) * this->scale) * ((this->_toX + ((int)3 * (this->_aX - this->_bX))) - this->_fromX)) + ((((int)3 * this->scale) * this->scale) * ((this->_fromX - ((int)2 * this->_aX)) + this->_bX)));
HXDLIN(  51)		Float _hx_tmp1 = (((int)3 * this->scale) * (this->_aX - this->_fromX));
HXDLIN(  51)		this->x = ((_hx_tmp + _hx_tmp1) + this->_fromX);
HXLINE(  52)		Float _hx_tmp2 = ((((this->scale * this->scale) * this->scale) * ((this->_toY + ((int)3 * (this->_aY - this->_bY))) - this->_fromY)) + ((((int)3 * this->scale) * this->scale) * ((this->_fromY - ((int)2 * this->_aY)) + this->_bY)));
HXDLIN(  52)		Float _hx_tmp3 = (((int)3 * this->scale) * (this->_aY - this->_fromY));
HXDLIN(  52)		this->y = ((_hx_tmp2 + _hx_tmp3) + this->_fromY);
HXLINE(  53)		Bool _hx_tmp4 = this->finished;
