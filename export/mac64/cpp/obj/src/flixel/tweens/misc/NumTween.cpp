...
HXLINE(  50)		Float _hx_tmp = this->_start;
HXDLIN(  50)		Float _hx_tmp1 = (this->_range * this->scale);
HXDLIN(  50)		this->value = (_hx_tmp + _hx_tmp1);
HXLINE(  52)		Bool _hx_tmp2 = hx::IsNotNull( this->_tweenFunction );
...
static void NumTween_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(NumTween_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void NumTween_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
void NumTween_obj::__register()
{
	...
	__mClass->mMarkFunc = NumTween_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = NumTween_obj_sVisitStatics;
#endif
