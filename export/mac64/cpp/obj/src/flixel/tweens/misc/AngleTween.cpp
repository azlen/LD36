...
void AngleTween_obj::__construct( ::Dynamic Options){
            	HX_STACK_FRAME("flixel.tweens.misc.AngleTween","new",0x28853ef8,"flixel.tweens.misc.AngleTween.new","flixel/tweens/misc/AngleTween.hx",9,0x989494f7)
            	HX_STACK_THIS(this)
...
void AngleTween_obj::destroy(){
            	HX_STACK_FRAME("flixel.tweens.misc.AngleTween","destroy",0x51eec792,"flixel.tweens.misc.AngleTween.destroy","flixel/tweens/misc/AngleTween.hx",25,0x989494f7)
            	HX_STACK_THIS(this)
...
HXLINE(  27)		this->sprite = null();
 ...
 ::flixel::tweens::misc::AngleTween AngleTween_obj::tween(Float FromAngle,Float ToAngle,Float Duration, ::flixel::FlxSprite Sprite){
            	HX_STACK_FRAME("flixel.tweens.misc.AngleTween","tween",0xc3ccef03,"flixel.tweens.misc.AngleTween.tween","flixel/tweens/misc/AngleTween.hx",38,0x989494f7)
            	HX_STACK_THIS(this)
...
HXLINE(  43)		Bool _hx_tmp = hx::IsNotNull( this->sprite );
HXDLIN(  43)		if (_hx_tmp) {
HXLINE(  45)			Float _hx_tmp1 = hx::Mod(this->angle,(int)360);
HXDLIN(  45)			this->sprite->set_angle(_hx_tmp1);
            		}
...
void AngleTween_obj::update(Float elapsed){
            	HX_STACK_FRAME("flixel.tweens.misc.AngleTween","update",0xed654671,"flixel.tweens.misc.AngleTween.update","flixel/tweens/misc/AngleTween.hx",52,0x989494f7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE(  53)		this->super::update(elapsed);
HXLINE(  54)		Float _hx_tmp = this->_start;
HXDLIN(  54)		Float _hx_tmp1 = (this->_range * this->scale);
HXDLIN(  54)		this->angle = (_hx_tmp + _hx_tmp1);
HXLINE(  56)		Bool _hx_tmp2 = hx::IsNotNull( this->sprite );
HXDLIN(  56)		if (_hx_tmp2) {
HXLINE(  58)			HX_VARI( Float,spriteAngle) = hx::Mod(this->angle,(int)360);
