...
HXLINE(  26)		super::__construct(Options);
            	}
...
void VarTween_obj::initializeVars(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  86)		HX_VAR( ::Array< ::String >,fields);
HXLINE(  88)		Bool _hx_tmp = ::Reflect_obj::isObject(this->_properties);
HXDLIN(  88)		if (_hx_tmp) {
HXLINE(  90)			fields = ::Reflect_obj::fields(this->_properties);
            		}
            		else {
HXLINE(  94)			HX_STACK_DO_THROW(HX_("Unsupported properties container - use an object containing key/value pairs.",0b,19,89,5b));
            		}
HXLINE(  97)		{
HXLINE(  97)			HX_VARI( Int,_g) = (int)0;
HXDLIN(  97)			while((_g < fields->length)){
HXLINE(  97)				HX_VARI( ::String,p) = fields->__get(_g);
HXDLIN(  97)				++_g;
HXLINE(  99)				 ::Dynamic _hx_tmp1 = ::Reflect_obj::getProperty(this->_object,p);
HXDLIN(  99)				Bool _hx_tmp2 = hx::IsNull( _hx_tmp1 );
HXDLIN(  99)				if (_hx_tmp2) {
HXLINE( 101)					HX_STACK_DO_THROW(((HX_("The Object does not have the property \"",3c,1e,c1,a6) + p) + HX_("\"",22,00,00,00)));
            				}
HXLINE( 104)				HX_VARI(  ::Dynamic,a) = ::Reflect_obj::getProperty(this->_object,p);
HXLINE( 106)				Bool _hx_tmp3 = ::Math_obj::isNaN(a);
HXDLIN( 106)				if (_hx_tmp3) {
HXLINE( 108)					HX_STACK_DO_THROW(((HX_("The property \"",06,e3,80,a4) + p) + HX_("\" is not numeric.",66,4f,2a,cf)));
            				}
HXLINE( 111)				 ::Dynamic _hx_tmp4 = ::Reflect_obj::getProperty(this->_properties,p);
HXDLIN( 111)				this->_propertyInfos->push( ::Dynamic(hx::Anon_obj::Create(3)
