...
HXDLIN(  22)		Float _hx_tmp1 = (this->b * cos);
HXDLIN(  22)		this->b = (_hx_tmp + _hx_tmp1);
HXLINE(  23)		this->a = a1;
HXLINE(  25)		HX_VARI( Float,c1) = ((this->c * cos) - (this->d * sin));
HXLINE(  26)		Float _hx_tmp2 = (this->c * sin);
HXDLIN(  26)		Float _hx_tmp3 = (this->d * cos);
HXDLIN(  26)		this->d = (_hx_tmp2 + _hx_tmp3);
HXLINE(  27)		this->c = c1;
HXLINE(  29)		HX_VARI( Float,tx1) = ((this->tx * cos) - (this->ty * sin));
HXLINE(  30)		Float _hx_tmp4 = (this->tx * sin);
HXDLIN(  30)		Float _hx_tmp5 = (this->ty * cos);
HXDLIN(  30)		this->ty = (_hx_tmp4 + _hx_tmp5);
