...
HXLINE(  61)				++_g1;
HXLINE(  63)				hx::MultEq(mult,(int)10);
            			}
            		}
HXLINE(  65)		Int _hx_tmp = ::Math_obj::round((Value * mult));
HXDLIN(  65)		return ((Float)_hx_tmp / (Float)mult);
            	}
...
HXDLIN(  80)		Bool _hx_tmp1 = hx::IsNotNull( Min );
HXDLIN(  80)		if (_hx_tmp1) {
HXLINE(  80)			_hx_tmp = hx::IsLess( Value,Min );
            		}
            		else {
...
HXDLIN(  81)		Bool _hx_tmp3 = hx::IsNotNull( Max );
...
Float FlxMath_obj::lerp(Float a,Float b,Float ratio){
            	HX_STACK_FRAME("flixel.math.FlxMath","lerp",0xfe2b17ff,"flixel.math.FlxMath.lerp","flixel/math/FlxMath.hx",99,0x837802f8)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
...
Bool FlxMath_obj::inBounds(Float Value, ::Dynamic Min, ::Dynamic Max){
            	HX_STACK_FRAME("flixel.math.FlxMath","inBounds",0x4dfc39c2,"flixel.math.FlxMath.inBounds","flixel/math/FlxMath.hx",112,0x837802f8)
            	HX_STACK_ARG(Value,"Value")
            	HX_STACK_ARG(Min,"Min")
            	HX_STACK_ARG(Max,"Max")
HXLINE( 112)		Bool _hx_tmp;
HXDLIN( 112)		Bool _hx_tmp1 = hx::IsNotNull( Min );
...
HXLINE( 112)			Bool _hx_tmp2 = hx::IsNotNull( Max );
...
Bool FlxMath_obj::isOdd(Float n){
            	HX_STACK_FRAME("flixel.math.FlxMath","isOdd",0xb67c8d5d,"flixel.math.FlxMath.isOdd","flixel/math/FlxMath.hx",120,0x837802f8)
            	HX_STACK_ARG(n,"n")
HXLINE( 120)		Int _hx_tmp = ::Std_obj::_hx_int(n);
HXDLIN( 120)		return (((int)_hx_tmp & (int)(int)1) != (int)0);
            	}
...
Bool FlxMath_obj::isEven(Float n){
            	HX_STACK_FRAME("flixel.math.FlxMath","isEven",0xeff0abac,"flixel.math.FlxMath.isEven","flixel/math/FlxMath.hx",128,0x837802f8)
            	HX_STACK_ARG(n,"n")
HXLINE( 128)		Int _hx_tmp = ::Std_obj::_hx_int(n);
HXDLIN( 128)		return (((int)_hx_tmp & (int)(int)1) == (int)0);
            	}
...
Bool FlxMath_obj::pointInFlxRect(Float pointX,Float pointY, ::flixel::math::FlxRect rect){
            	HX_STACK_FRAME("flixel.math.FlxMath","pointInFlxRect",0x061f0269,"flixel.math.FlxMath.pointInFlxRect","flixel/math/FlxMath.hx",181,0x837802f8)
            	HX_STACK_ARG(pointX,"pointX")
            	HX_STACK_ARG(pointY,"pointY")
...
Bool FlxMath_obj::mouseInFlxRect(Bool useWorldCoords, ::flixel::math::FlxRect rect){
            	...
            	HX_STACK_ARG(rect,"rect")
HXLINE( 195)		Bool _hx_tmp = hx::IsNull( rect );
HXDLIN( 195)		if (_hx_tmp) {
HXLINE( 197)			return true;
            		}
HXLINE( 200)		if (useWorldCoords) {
HXLINE( 202)			Int _hx_tmp1 = ::Math_obj::floor(::flixel::FlxG_obj::mouse->x);
HXDLIN( 202)			Int _hx_tmp2 = ::Math_obj::floor(::flixel::FlxG_obj::mouse->y);
HXDLIN( 202)			return ::flixel::math::FlxMath_obj::pointInFlxRect(_hx_tmp1,_hx_tmp2,rect);
            		}
            		else {
...
Bool FlxMath_obj::pointInRectangle(Float pointX,Float pointY, ::openfl::_legacy::geom::Rectangle rect){
            	HX_STACK_FRAME("flixel.math.FlxMath","pointInRectangle",0x49240aa2,"flixel.math.FlxMath.pointInRectangle","flixel/math/FlxMath.hx",221,0x837802f8)
            	HX_STACK_ARG(pointX,"pointX")
            	HX_STACK_ARG(pointY,"pointY")
            	HX_STACK_ARG(rect,"rect")
HXLINE( 221)		Bool _hx_tmp;
HXDLIN( 221)		Bool _hx_tmp1;
HXDLIN( 221)		Bool _hx_tmp2 = (pointX >= rect->x);
HXDLIN( 221)		if (_hx_tmp2) {
HXLINE( 221)			Float _hx_tmp3 = rect->get_right();
HXDLIN( 221)			_hx_tmp1 = (pointX <= _hx_tmp3);
            		}
            		else {
...
HXLINE( 221)			Float _hx_tmp4 = rect->get_bottom();
HXDLIN( 221)			return (pointY <= _hx_tmp4);
            		}
            		else {
...
Int min = __o_min.Default(0);
            	...
            	HX_STACK_ARG(max,"max")
            	HX_STACK_ARG(min,"min")
HXLINE( 236)		hx::AddEq(value,amount);
HXLINE( 238)		Bool _hx_tmp = (value > max);
HXDLIN( 238)		if (_hx_tmp) {
HXLINE( 240)			value = max;
            		}
            		else {
HXLINE( 242)			Bool _hx_tmp1 = (value <= min);
...
HXLINE( 264)			Int _hx_tmp = ::Std_obj::_hx_int((((Float)(min - value) / (Float)range) + (int)1));
HXDLIN( 264)			hx::AddEq(value,(range * _hx_tmp));
            		}
...
Float FlxMath_obj::remapToRange(Float value,Float start1,Float stop1,Float start2,Float stop2){
            	HX_STACK_FRAME("flixel.math.FlxMath","remapToRange",0x60fbca01,"flixel.math.FlxMath.remapToRange","flixel/math/FlxMath.hx",281,0x837802f8)
            	HX_STACK_ARG(value,"value")
...
Float FlxMath_obj::dotProduct(Float ax,Float ay,Float bx,Float by){
            	HX_STACK_FRAME("flixel.math.FlxMath","dotProduct",0x8564032e,"flixel.math.FlxMath.dotProduct","flixel/math/FlxMath.hx",296,0x837802f8)
            	HX_STACK_ARG(ax,"ax")
            	HX_STACK_ARG(ay,"ay")
            	HX_STACK_ARG(bx,"bx")
            	HX_STACK_ARG(by,"by")
...
Float FlxMath_obj::vectorLength(Float dx,Float dy){
            	HX_STACK_FRAME("flixel.math.FlxMath","vectorLength",0x2dfefb91,"flixel.math.FlxMath.vectorLength","flixel/math/FlxMath.hx",304,0x837802f8)
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
...
HXLINE( 318)		Float _hx_tmp = ::Math_obj::sqrt(((dx * dx) + (dy * dy)));
HXDLIN( 318)		return ::Std_obj::_hx_int(_hx_tmp);
            	}
...
HXLINE( 354)		Bool _hx_tmp = Target->_weak;
HXDLIN( 354)		if (_hx_tmp) {
HXLINE( 354)			Target->put();
            		}
HXLINE( 355)		Float _hx_tmp1 = ::Math_obj::sqrt(((dx * dx) + (dy * dy)));
HXDLIN( 355)		return ::Std_obj::_hx_int(_hx_tmp1);
            	}
...
HXLINE( 374)		Bool _hx_tmp = Target->_weak;
...
HXLINE( 393)		Float _hx_tmp = ::Math_obj::sqrt(((dx * dx) + (dy * dy)));
HXDLIN( 393)		return ::Std_obj::_hx_int(_hx_tmp);
            	}
...
Float aDiff = __o_aDiff.Default(((Float)0.0000001));
            	HX_STACK_FRAME("flixel.math.FlxMath","equal",0x67aca12c,"flixel.math.FlxMath.equal","flixel/math/FlxMath.hx",471,0x837802f8)
            	HX_STACK_ARG(aValueA,"aValueA")
            	HX_STACK_ARG(aValueB,"aValueB")
            	HX_STACK_ARG(aDiff,"aDiff")
HXLINE( 471)		Float _hx_tmp = ::Math_obj::abs((aValueA - aValueB));
HXDLIN( 471)		return (_hx_tmp <= aDiff);
            	}
...
Int FlxMath_obj::signOf(Float n){
            	HX_STACK_FRAME("flixel.math.FlxMath","signOf",0x43f3963c,"flixel.math.FlxMath.signOf","flixel/math/FlxMath.hx",479,0x837802f8)
            	HX_STACK_ARG(n,"n")
...
Bool FlxMath_obj::sameSign(Float a,Float b){
            	HX_STACK_FRAME("flixel.math.FlxMath","sameSign",0xc637544b,"flixel.math.FlxMath.sameSign","flixel/math/FlxMath.hx",487,0x837802f8)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
...
Float FlxMath_obj::fastSin(Float n){
            	...
            	HX_STACK_ARG(n,"n")
HXLINE( 499)		hx::MultEq(n,((Float)0.3183098862));
HXLINE( 502)		if ((n > (int)1)) {
HXLINE( 504)			Int _hx_tmp = ::Math_obj::ceil(n);
HXDLIN( 504)			hx::SubEq(n,((int)((int)_hx_tmp >> (int)(int)1) << (int)(int)1));
            		}
            		else {
HXLINE( 506)			if ((n < (int)-1)) {
HXLINE( 508)				Int _hx_tmp1 = ::Math_obj::ceil(-(n));
HXDLIN( 508)				hx::AddEq(n,((int)((int)_hx_tmp1 >> (int)(int)1) << (int)(int)1));
            			}
            		}
...
Float FlxMath_obj::fastCos(Float n){
            	HX_STACK_FRAME("flixel.math.FlxMath","fastCos",0xce7b1e83,"flixel.math.FlxMath.fastCos","flixel/math/FlxMath.hx",531,0x837802f8)
            	HX_STACK_ARG(n,"n")
HXLINE( 531)		HX_VARI_NAME( Float,n1,"n") = (n + ((Float)1.570796327));
HXDLIN( 531)		hx::MultEq(n1,((Float)0.3183098862));
HXDLIN( 531)		if ((n1 > (int)1)) {
HXLINE( 531)			Int _hx_tmp = ::Math_obj::ceil(n1);
HXDLIN( 531)			hx::SubEq(n1,((int)((int)_hx_tmp >> (int)(int)1) << (int)(int)1));
            		}
            		else {
HXLINE( 531)			if ((n1 < (int)-1)) {
HXLINE( 531)				Int _hx_tmp1 = ::Math_obj::ceil(-(n1));
HXDLIN( 531)				hx::AddEq(n1,((int)((int)_hx_tmp1 >> (int)(int)1) << (int)(int)1));
            			}
            		}
...
Float FlxMath_obj::sinh(Float n){
            	HX_STACK_FRAME("flixel.math.FlxMath","sinh",0x02ce9bd8,"flixel.math.FlxMath.sinh","flixel/math/FlxMath.hx",539,0x837802f8)
            	HX_STACK_ARG(n,"n")
HXLINE( 539)		Float _hx_tmp = ::Math_obj::exp(n);
HXDLIN( 539)		Float _hx_tmp1 = ::Math_obj::exp(-(n));
HXDLIN( 539)		return ((Float)(_hx_tmp - _hx_tmp1) / (Float)(int)2);
            	}
...
Int FlxMath_obj::maxInt(Int a,Int b){
            	HX_STACK_FRAME("flixel.math.FlxMath","maxInt",0x4dbb7033,"flixel.math.FlxMath.maxInt","flixel/math/FlxMath.hx",547,0x837802f8)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
HXLINE( 547)		if ((a > b)) {
HXLINE( 547)			return a;
...
Int FlxMath_obj::minInt(Int a,Int b){
            	HX_STACK_FRAME("flixel.math.FlxMath","minInt",0xe253f205,"flixel.math.FlxMath.minInt","flixel/math/FlxMath.hx",555,0x837802f8)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
HXLINE( 555)		if ((a > b)) {
HXLINE( 555)			return b;
...
Int FlxMath_obj::absInt(Int n){
            	HX_STACK_FRAME("flixel.math.FlxMath","absInt",0x118b9f25,"flixel.math.FlxMath.absInt","flixel/math/FlxMath.hx",563,0x837802f8)
            	HX_STACK_ARG(n,"n")
...
{
{
            	HX_STACK_FRAME("flixel.math.FlxMath","boot",0xf79689ba,"flixel.math.FlxMath.boot","flixel/math/FlxMath.hx",24,0x837802f8)
HXLINE(  24)		MIN_VALUE_FLOAT = ((Float)5e-324);
            	}
{
            	HX_STACK_FRAME("flixel.math.FlxMath","boot",0xf79689ba,"flixel.math.FlxMath.boot","flixel/math/FlxMath.hx",29,0x837802f8)
HXLINE(  29)		MAX_VALUE_FLOAT = ((Float)1.79e+308);
            	}
{
            	HX_STACK_FRAME("flixel.math.FlxMath","boot",0xf79689ba,"flixel.math.FlxMath.boot","flixel/math/FlxMath.hx",33,0x837802f8)
HXLINE(  33)		MIN_VALUE_INT = (int)-2147483647;
            	}
{
            	HX_STACK_FRAME("flixel.math.FlxMath","boot",0xf79689ba,"flixel.math.FlxMath.boot","flixel/math/FlxMath.hx",37,0x837802f8)
HXLINE(  37)		MAX_VALUE_INT = (int)2147483647;
            	}
{
            	HX_STACK_FRAME("flixel.math.FlxMath","boot",0xf79689ba,"flixel.math.FlxMath.boot","flixel/math/FlxMath.hx",41,0x837802f8)
HXLINE(  41)		SQUARE_ROOT_OF_TWO = ((Float)1.41421356237);
            	}
{
            	HX_STACK_FRAME("flixel.math.FlxMath","boot",0xf79689ba,"flixel.math.FlxMath.boot","flixel/math/FlxMath.hx",45,0x837802f8)
