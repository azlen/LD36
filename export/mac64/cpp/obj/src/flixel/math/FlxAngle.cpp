...
Float FlxAngle_obj::wrapAngle(Float angle){
            	HX_STACK_FRAME("flixel.math.FlxAngle","wrapAngle",0xae3043f0,"flixel.math.FlxAngle.wrapAngle","flixel/math/FlxAngle.hx",65,0x32e99189)
            	HX_STACK_ARG(angle,"angle")
HXLINE(  66)		Bool _hx_tmp = (angle > (int)180);
HXDLIN(  66)		if (_hx_tmp) {
HXLINE(  68)			Float _hx_tmp1 = (angle - (int)360);
HXDLIN(  68)			angle = ::flixel::math::FlxAngle_obj::wrapAngle(_hx_tmp1);
            		}
            		else {
HXLINE(  70)			Bool _hx_tmp2 = (angle < (int)-180);
HXDLIN(  70)			if (_hx_tmp2) {
HXLINE(  72)				Float _hx_tmp3 = (angle + (int)360);
HXDLIN(  72)				angle = ::flixel::math::FlxAngle_obj::wrapAngle(_hx_tmp3);
            			}
            		}
...
Bool AsDegrees = __o_AsDegrees.Default(false);
            	HX_STACK_FRAME("flixel.math.FlxAngle","angleBetween",0x83e3464e,"flixel.math.FlxAngle.angleBetween","flixel/math/FlxAngle.hx",112,0x32e99189)
...
HXLINE( 117)			Float radians = ::Math_obj::atan2(dy,dx);
HXDLIN( 117)			return (radians * ((Float)(int)180 / (Float)::Math_obj::PI));
            		}
            		else {
...
Bool AsDegrees = __o_AsDegrees.Default(false);
            	HX_STACK_FRAME("flixel.math.FlxAngle","angleBetweenPoint",0x0a124322,"flixel.math.FlxAngle.angleBetweenPoint","flixel/math/FlxAngle.hx",132,0x32e99189)
...
HXLINE( 136)		Bool _hx_tmp = Target->_weak;
HXDLIN( 136)		if (_hx_tmp) {
HXLINE( 136)			Target->put();
            		}
HXLINE( 138)		if (AsDegrees) {
HXLINE( 139)			Float radians = ::Math_obj::atan2(dy,dx);
HXDLIN( 139)			return (radians * ((Float)(int)180 / (Float)::Math_obj::PI));
            		}
            		else {
...
Bool AsDegrees = __o_AsDegrees.Default(false);
            	HX_STACK_FRAME("flixel.math.FlxAngle","angleBetweenMouse",0x4fe7a4f7,"flixel.math.FlxAngle.angleBetweenMouse","flixel/math/FlxAngle.hx",154,0x32e99189)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(AsDegrees,"AsDegrees")
HXLINE( 156)		Bool _hx_tmp = hx::IsNull( Object );
...
HXLINE( 167)			Float radians = ::Math_obj::atan2(dy,dx);
HXDLIN( 167)			return (radians * ((Float)(int)180 / (Float)::Math_obj::PI));
            		}
            		else {
...
Bool AsDegrees = __o_AsDegrees.Default(false);
            	HX_STACK_FRAME("flixel.math.FlxAngle","angleFromFacing",0x8474a75e,"flixel.math.FlxAngle.angleFromFacing","flixel/math/FlxAngle.hx",208,0x32e99189)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAngle_obj,angleFromFacing,return )
 ...
 ::flixel::math::FlxPoint FlxAngle_obj::getCartesianCoords(Float Radius,Float Angle, ::flixel::math::FlxPoint point){
            	HX_STACK_FRAME("flixel.math.FlxAngle","getCartesianCoords",0x688d1f29,"flixel.math.FlxAngle.getCartesianCoords","flixel/math/FlxAngle.hx",233,0x32e99189)
            	HX_STACK_ARG(Radius,"Radius")
            	HX_STACK_ARG(Angle,"Angle")
            	HX_STACK_ARG(point,"point")
HXLINE( 234)		HX_VARI(  ::flixel::math::FlxPoint,p) = point;
HXLINE( 235)		Bool _hx_tmp = hx::IsNull( point );
...
HXLINE( 238)		Float _hx_tmp1 = (Angle * ((Float)::Math_obj::PI / (Float)(int)180));
HXDLIN( 238)		Float _hx_tmp2 = ::Math_obj::cos(_hx_tmp1);
HXDLIN( 238)		p->set_x((Radius * _hx_tmp2));
HXLINE( 239)		Float _hx_tmp3 = (Angle * ((Float)::Math_obj::PI / (Float)(int)180));
HXDLIN( 239)		Float _hx_tmp4 = ::Math_obj::sin(_hx_tmp3);
HXDLIN( 239)		p->set_y((Radius * _hx_tmp4));
HXLINE( 240)		return p;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxAngle_obj,getCartesianCoords,return )
 ...
 ::flixel::math::FlxPoint FlxAngle_obj::getPolarCoords(Float X,Float Y, ::flixel::math::FlxPoint point){
            	HX_STACK_FRAME("flixel.math.FlxAngle","getPolarCoords",0xf74e15df,"flixel.math.FlxAngle.getPolarCoords","flixel/math/FlxAngle.hx",252,0x32e99189)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
            	HX_STACK_ARG(point,"point")
HXLINE( 253)		HX_VARI(  ::flixel::math::FlxPoint,p) = point;
HXLINE( 254)		Bool _hx_tmp = hx::IsNull( point );
...
HXLINE( 257)		Float _hx_tmp1 = ::Math_obj::sqrt(((X * X) + (Y * Y)));
HXDLIN( 257)		p->set_x(_hx_tmp1);
HXLINE( 258)		Float _hx_tmp2 = ::Math_obj::atan2(Y,X);
HXDLIN( 258)		Float _hx_tmp3 = (_hx_tmp2 * ((Float)(int)180 / (Float)::Math_obj::PI));
HXDLIN( 258)		p->set_y(_hx_tmp3);
HXLINE( 259)		return p;
            	}
...
Float FlxAngle_obj::get_TO_DEG(){
            	HX_STACK_FRAME("flixel.math.FlxAngle","get_TO_DEG",0x36e6a544,"flixel.math.FlxAngle.get_TO_DEG","flixel/math/FlxAngle.hx",264,0x32e99189)
...
Float FlxAngle_obj::get_TO_RAD(){
            	HX_STACK_FRAME("flixel.math.FlxAngle","get_TO_RAD",0x36f14153,"flixel.math.FlxAngle.get_TO_RAD","flixel/math/FlxAngle.hx",269,0x32e99189)
