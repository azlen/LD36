...
void FlxTextFormat_obj::__construct( ::Dynamic FontColor, ::Dynamic Bold, ::Dynamic Italic, ::Dynamic BorderColor){
            	HX_STACK_FRAME("flixel.text.FlxTextFormat","new",0x67be2279,"flixel.text.FlxTextFormat.new","flixel/text/FlxText.hx",1071,0xdf165a6e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(FontColor,"FontColor")
            	HX_STACK_ARG(Bold,"Bold")
            	HX_STACK_ARG(Italic,"Italic")
            	HX_STACK_ARG(BorderColor,"BorderColor")
HXLINE(1072)		this->format =  ::openfl::_legacy::text::TextFormat_obj::__new(null(),null(),FontColor,Bold,Italic,null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(1073)		Int _hx_tmp;
HXDLIN(1073)		Bool _hx_tmp1 = hx::IsNull( BorderColor );
HXDLIN(1073)		if (_hx_tmp1) {
HXLINE(1073)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE(1073)			_hx_tmp = BorderColor;
            		}
HXDLIN(1073)		this->borderColor = _hx_tmp;
            	}
...
hx::ObjectPtr< FlxTextFormat_obj > FlxTextFormat_obj::__new( ::Dynamic FontColor, ::Dynamic Bold, ::Dynamic Italic, ::Dynamic BorderColor)
{
	...
	_hx_result->__construct(FontColor,Bold,Italic,BorderColor);
	return _hx_result;
}
