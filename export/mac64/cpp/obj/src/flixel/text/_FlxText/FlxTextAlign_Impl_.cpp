...
::String FlxTextAlign_Impl__obj::fromOpenFL(::String align){
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","fromOpenFL",0xc584ea03,"flixel.text._FlxText.FlxTextAlign_Impl_.fromOpenFL","flixel/text/FlxText.hx",1136,0xdf165a6e)
...
::String FlxTextAlign_Impl__obj::toOpenFL(::String align){
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","toOpenFL",0xa34e3094,"flixel.text._FlxText.FlxTextAlign_Impl_.toOpenFL","flixel/text/FlxText.hx",1148,0xdf165a6e)
            	HX_STACK_ARG(align,"align")
HXLINE(1148)		::String _hx_switch_0 = align;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE(1148)			return HX_("center",d5,25,db,05);
HXDLIN(1148)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("justify",50,df,b5,83)) ){
...
HXDLIN(1148)			goto _hx_goto_1;
            		...
            		if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE(1148)			return HX_("left",07,08,b0,47);
HXDLIN(1148)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE(1148)			return HX_("right",dc,0b,64,e9);
HXDLIN(1148)			goto _hx_goto_1;
            		}
            		/* default */{
HXLINE(1148)			return HX_("left",07,08,b0,47);
...
{
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1121,0xdf165a6e)
HXLINE(1121)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1128,0xdf165a6e)
HXLINE(1128)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1130,0xdf165a6e)
HXLINE(1130)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1132,0xdf165a6e)
HXLINE(1132)		JUSTIFY = HX_("justify",50,df,b5,83);
            	}
}
