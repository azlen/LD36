...
HXLINE(  48)		this->_times = ::Array_obj< Float >::fromData( _hx_array_data_1,5);
HXLINE(  49)		this->_colors = ::Array_obj< Int >::fromData( _hx_array_data_2,5);
...
HXDLIN(  52)				++_g;
HXLINE(  54)				 ::flixel::util::FlxTimer_obj::__new()->start(time,this->timerCallback_dyn(),null());
            			}
            		}
...
HXLINE(  60)		this->_sprite =  ::openfl::_legacy::display::Sprite_obj::__new();
...
HXLINE(  64)		this->_text =  ::openfl::_legacy::text::TextField_obj::__new();
HXLINE(  65)		this->_text->set_selectable(false);
HXLINE(  66)		this->_text->set_embedFonts(true);
HXLINE(  67)		HX_VARI(  ::openfl::_legacy::text::TextFormat,dtf) =  ::openfl::_legacy::text::TextFormat_obj::__new(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,(int)16,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE(  76)		 ::openfl::_legacy::media::Sound _hx_tmp = ::openfl::_legacy::Assets_obj::getSound((HX_("flixel/sounds/flixel",54,41,d6,5d) + HX_(".ogg",e1,64,bc,1e)),null());
HXDLIN(  76)		::flixel::FlxG_obj::sound->load(_hx_tmp,null(),null(),null(),null(),null(),null(),null())->play(null(),null());
            	}
...
HXLINE(  96)		Float _hx_tmp = ((Float)Height / (Float)(int)2);
HXDLIN(  96)		Float _hx_tmp1 = ::flixel::FlxG_obj::game->get_scaleY();
HXDLIN(  96)		this->_sprite->set_y((_hx_tmp - ((int)20 * _hx_tmp1)));
HXLINE(  98)		Float _hx_tmp2 = ::flixel::FlxG_obj::game->get_scaleX();
HXDLIN(  98)		this->_text->set_width(((Float)Width / (Float)_hx_tmp2));
HXLINE(  99)		this->_text->set_x((int)0);
HXLINE( 100)		Float _hx_tmp3 = this->_sprite->get_y();
HXDLIN( 100)		Float _hx_tmp4 = ::flixel::FlxG_obj::game->get_scaleY();
HXDLIN( 100)		this->_text->set_y((_hx_tmp3 + ((int)80 * _hx_tmp4)));
HXLINE( 102)		Float _hx_tmp5 = ::flixel::FlxG_obj::game->get_scaleX();
HXDLIN( 102)		Float _hx_tmp6 = this->_text->set_scaleX(_hx_tmp5);
HXDLIN( 102)		this->_sprite->set_scaleX(_hx_tmp6);
HXLINE( 103)		Float _hx_tmp7 = ::flixel::FlxG_obj::game->get_scaleY();
HXDLIN( 103)		Float _hx_tmp8 = this->_text->set_scaleY(_hx_tmp7);
HXDLIN( 103)		this->_sprite->set_scaleY(_hx_tmp8);
            	}
...
HXLINE( 108)		 ::Dynamic _hx_tmp = this->_functions->__get(this->_curPart);
HXDLIN( 108)		_hx_tmp();
HXLINE( 109)		Int _hx_tmp1 = this->_colors->__get(this->_curPart);
HXDLIN( 109)		this->_text->set_textColor(_hx_tmp1);
HXLINE( 110)		this->_text->set_text(HX_("HaxeFlixel",42,8f,0c,ac));
HXLINE( 111)		this->_curPart++;
HXLINE( 113)		Bool _hx_tmp2 = (this->_curPart == (int)5);
...
HXDLIN( 194)			Bool _hx_tmp = ::flixel::FlxG_obj::game->_state->switchTo(nextState);
