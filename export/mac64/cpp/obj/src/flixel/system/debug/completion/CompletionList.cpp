...
hx::ObjectPtr< CompletionList_obj > CompletionList_obj::__new(Int capacity)
{
	...
	_hx_result->__construct(capacity);
	return _hx_result;
}
...
void CompletionList_obj::setY(Float y){
            	HX_STACK_FRAME("flixel.system.debug.completion.CompletionList","setY",0x8c8445e1,"flixel.system.debug.completion.CompletionList.setY","flixel/system/debug/completion/CompletionList.hx",55,0x5d64787a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(y,"y")
HXLINE(  55)		Float _hx_tmp = (y - this->actualHeight);
HXDLIN(  55)		this->set_y(_hx_tmp);
            	}
...
HXLINE(  63)		Bool _hx_tmp = hx::IsNotNull( this->closed );
...
HXLINE(  71)			HX_VARI(  ::flixel::_hx_system::debug::completion::CompletionListEntry,entry) =  ::flixel::_hx_system::debug::completion::CompletionListEntry_obj::__new();
...
void CompletionList_obj::createScrollBar(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  80)		this->scrollBar =  ::flixel::_hx_system::debug::completion::CompletionListScrollBar_obj::__new((int)150,(int)0,(int)5,this->actualHeight);
...
void CompletionList_obj::onKeyDown( ::openfl::_legacy::events::KeyboardEvent e){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(e,"e")
HXLINE(  87)		Bool _hx_tmp = !(this->get_visible());
HXDLIN(  87)		if (_hx_tmp) {
HXLINE(  88)			return;
            		}
HXLINE(  90)		{
HXLINE(  90)			HX_VARI( Int,_g) = e->keyCode;
HXDLIN(  90)			switch((int)(_g)){
            				case (int)13: {
HXLINE(  99)					Bool _hx_tmp1 = hx::IsNotNull( this->completed );
HXDLIN(  99)					if (_hx_tmp1) {
HXLINE( 100)						::String _hx_tmp2 = this->items->__get(this->selectedIndex);
HXDLIN( 100)						this->completed(_hx_tmp2);
            					}
...
HXLINE( 114)		Int _hx_tmp = (this->selectedIndex + modifier);
HXDLIN( 114)		this->selectedIndex = this->bound(_hx_tmp);
...
HXDLIN( 115)		Bool _hx_tmp3 = hx::IsNotNull( Min );
HXDLIN( 115)		if (_hx_tmp3) {
HXLINE( 115)			_hx_tmp2 = hx::IsGreaterEq( Value,Min );
            		}
            		else {
HXLINE( 115)			_hx_tmp2 = true;
            		}
HXDLIN( 115)		if (_hx_tmp2) {
HXLINE( 115)			Bool _hx_tmp4 = hx::IsNotNull( Max );
HXDLIN( 115)			if (_hx_tmp4) {
HXLINE( 115)				_hx_tmp1 = hx::IsLessEq( Value,Max );
            			}
            			else {
...
HXLINE( 119)		Int _hx_tmp5 = (this->lowerVisibleIndex + modifier);
HXDLIN( 119)		this->lowerVisibleIndex = this->bound(_hx_tmp5);
HXLINE( 120)		Int _hx_tmp6 = (this->upperVisibleIndex + modifier);
HXDLIN( 120)		this->upperVisibleIndex = this->bound(_hx_tmp6);
HXLINE( 123)		if (((this->upperVisibleIndex - this->lowerVisibleIndex) == this->items->length)) {
HXLINE( 124)			return;
            		}
HXLINE( 127)		Bool _hx_tmp7 = (this->lowerVisibleIndex == (int)0);
HXDLIN( 127)		if (_hx_tmp7) {
HXLINE( 128)			this->upperVisibleIndex = (this->entries->length - (int)1);
            		}
            		else {
HXLINE( 129)			Bool _hx_tmp8 = (this->upperVisibleIndex == (this->items->length - (int)1));
...
Int CompletionList_obj::bound(Int index){
            	HX_STACK_FRAME("flixel.system.debug.completion.CompletionList","bound",0xa405f994,"flixel.system.debug.completion.CompletionList.bound","flixel/system/debug/completion/CompletionList.hx",135,0x5d64787a)
            	HX_STACK_THIS(this)
...
HXDLIN( 135)		Bool _hx_tmp2 = hx::IsNotNull( Max );
...
HXLINE( 160)		Int _hx_tmp = (this->selectedIndex - this->lowerVisibleIndex);
HXDLIN( 160)		this->entries->__get(_hx_tmp).StaticCast<  ::flixel::_hx_system::debug::completion::CompletionListEntry >()->set_selected(true);
HXLINE( 162)		Bool _hx_tmp1 = hx::IsNotNull( this->selectionChanged );
HXDLIN( 162)		if (_hx_tmp1) {
HXLINE( 163)			::String _hx_tmp2 = this->items->__get(this->selectedIndex);
HXDLIN( 163)			this->selectionChanged(_hx_tmp2);
            		}
            	}
...
void CompletionList_obj::setItems(::Array< ::String > items){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(items,"items")
HXLINE( 168)		Bool _hx_tmp = hx::IsNull( items );
HXDLIN( 168)		if (_hx_tmp) {
HXLINE( 169)			return;
            		}
HXLINE( 170)		Bool _hx_tmp1 = (items->length == (int)0);
...
::Array< ::String > CompletionList_obj::filterItems(::String filter){
            		...
            		Bool _hx_run(::String item){
            			HX_STACK_FRAME("flixel.system.debug.completion.CompletionList","filterItems",0xe29aeefe,"flixel.system.debug.completion.CompletionList.filterItems","flixel/system/debug/completion/CompletionList.hx",188,0x5d64787a)
            			HX_STACK_ARG(item,"item")
HXLINE( 188)			::String s = item.toLowerCase();
HXDLIN( 188)			::String str = filter.toLowerCase();
HXDLIN( 188)			Int _hx_tmp2 = s.indexOf(str,null());
HXDLIN( 188)			return (_hx_tmp2 != (int)-1);
            		}
...
HXLINE( 183)		Bool _hx_tmp = hx::IsNull( filter );
HXDLIN( 183)		if (_hx_tmp) {
HXLINE( 184)			filter = HX_("",00,00,00,00);
            		}
HXLINE( 186)		::Array< ::String > _hx_tmp1 = this->originalItems->filter( ::Dynamic(new _hx_Closure_0(filter)));
HXDLIN( 186)		return this->sortItems(filter,_hx_tmp1);
            	}
...
::Array< ::String > CompletionList_obj::sortItems(::String filter,::Array< ::String > items){
            		...
            		Int _hx_run(::String a,::String b){
            			HX_STACK_FRAME("flixel.system.debug.completion.CompletionList","sortItems",0x34d82c18,"flixel.system.debug.completion.CompletionList.sortItems","flixel/system/debug/completion/CompletionList.hx",203,0x5d64787a)
            			HX_STACK_ARG(a,"a")
            			HX_STACK_ARG(b,"b")
...
HXLINE( 212)				Int _hx_tmp = (a.length - b.length);
HXDLIN( 212)				return ::Std_obj::_hx_int(_hx_tmp);
            			}
...
HXLINE( 223)		Bool _hx_tmp = ::StringTools_obj::startsWith(s,start);
HXDLIN( 223)		if (_hx_tmp) {
HXLINE( 224)			return (int)2;
            		}
HXLINE( 225)		::String _hx_tmp1 =  ::EReg_obj::__new(HX_("^[_]+",30,59,19,5c),HX_("",00,00,00,00))->replace(s,HX_("",00,00,00,00));
HXDLIN( 225)		Bool _hx_tmp2 = ::StringTools_obj::startsWith(_hx_tmp1,start);
...
HXLINE( 235)		::Array< ::String > _hx_tmp = this->filterItems(filter);
HXDLIN( 235)		this->setItems(_hx_tmp);
