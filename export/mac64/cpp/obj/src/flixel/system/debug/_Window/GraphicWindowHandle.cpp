...
void GraphicWindowHandle_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.system.debug._Window.GraphicWindowHandle","new",0x4f36000b,"flixel.system.debug._Window.GraphicWindowHandle.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_Window::GraphicWindowHandle_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug._Window.GraphicWindowHandle","boot",0xf8230a27,"flixel.system.debug._Window.GraphicWindowHandle.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__Window_GraphicWindowHandle",b1,52,a1,65);
            	}
}
