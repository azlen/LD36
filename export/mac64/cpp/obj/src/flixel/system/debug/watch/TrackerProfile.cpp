...
void TrackerProfile_obj::__construct(hx::Class ObjectClass,::Array< ::String > Variables,::Array< ::Dynamic> Extensions){
            	HX_STACK_FRAME("flixel.system.debug.watch.TrackerProfile","new",0x3f8f952a,"flixel.system.debug.watch.TrackerProfile.new","flixel/system/debug/watch/Tracker.hx",232,0x14368dcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ObjectClass,"ObjectClass")
            	HX_STACK_ARG(Variables,"Variables")
            	HX_STACK_ARG(Extensions,"Extensions")
HXLINE( 233)		this->objectClass = ObjectClass;
HXLINE( 234)		this->variables = Variables;
HXLINE( 235)		this->extensions = Extensions;
            	}
...
::String TrackerProfile_obj::toString(){
            	HX_STACK_FRAME("flixel.system.debug.watch.TrackerProfile","toString",0x9a236fa2,"flixel.system.debug.watch.TrackerProfile.toString","flixel/system/debug/watch/Tracker.hx",240,0x14368dcf)
            	HX_STACK_THIS(this)
HXLINE( 241)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 241)		_this->label = HX_("variables",b7,e2,62,82);
HXDLIN( 241)		_this->value = this->variables;
HXLINE( 242)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 242)		_this1->label = HX_("extensions",14,7c,70,89);
HXDLIN( 242)		_this1->value = this->extensions;
HXLINE( 240)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_this)->init(1,_this1));
            	}
