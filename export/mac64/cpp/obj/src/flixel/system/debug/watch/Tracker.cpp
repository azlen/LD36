...
void Tracker_obj::__construct(::String Title, ::openfl::_legacy::display::BitmapData Icon, ::Dynamic Width, ::Dynamic Height, ::Dynamic Resizable, ::openfl::_legacy::geom::Rectangle Bounds, ::Dynamic Closable){
            	HX_STACK_FRAME("flixel.system.debug.watch.Tracker","new",0xf6eed663,"flixel.system.debug.watch.Tracker.new","flixel/system/debug/watch/Tracker.hx",36,0x14368dcf)
            	HX_STACK_THIS(this)
...
HXLINE(  36)		super::__construct(Title,Icon,Width,Height,Resizable,Bounds,Closable);
            	}
