...
void GraphicWatch_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.system.debug.GraphicWatch","new",0xb737cfa1,"flixel.system.debug.GraphicWatch.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::GraphicWatch_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.GraphicWatch","boot",0x91b6ddd1,"flixel.system.debug.GraphicWatch.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicWatch",66,8f,5d,86);
            	}
}
