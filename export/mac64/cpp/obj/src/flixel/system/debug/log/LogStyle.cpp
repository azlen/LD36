...
Bool OpenConsole = __o_OpenConsole.Default(false);
            	...
            	HX_STACK_ARG(OpenConsole,"OpenConsole")
...
hx::ObjectPtr< LogStyle_obj > LogStyle_obj::__new(::String __o_Prefix,::String __o_Color,hx::Null< Int >  __o_Size,hx::Null< Bool >  __o_Bold,hx::Null< Bool >  __o_Italic,hx::Null< Bool >  __o_Underlined,::String ErrorSound,hx::Null< Bool >  __o_OpenConsole, ::Dynamic CallbackFunction)
{
	...
	_hx_result->__construct(__o_Prefix,__o_Color,__o_Size,__o_Bold,__o_Italic,__o_Underlined,ErrorSound,__o_OpenConsole,CallbackFunction);
	return _hx_result;
}
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.log.LogStyle","boot",0x6b6ebf21,"flixel.system.debug.log.LogStyle.boot","flixel/system/debug/log/LogStyle.hx",9,0x39dedcdd)
HXLINE(   9)		NORMAL =  ::flixel::_hx_system::debug::log::LogStyle_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null());
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.log.LogStyle","boot",0x6b6ebf21,"flixel.system.debug.log.LogStyle.boot","flixel/system/debug/log/LogStyle.hx",10,0x39dedcdd)
HXLINE(  10)		WARNING =  ::flixel::_hx_system::debug::log::LogStyle_obj::__new(HX_("[WARNING] ",a4,a2,0d,4e),HX_("D9F85C",15,36,8b,30),(int)12,false,false,false,HX_("flixel/sounds/beep",e6,b5,a9,33),true,null());
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.log.LogStyle","boot",0x6b6ebf21,"flixel.system.debug.log.LogStyle.boot","flixel/system/debug/log/LogStyle.hx",11,0x39dedcdd)
HXLINE(  11)		ERROR =  ::flixel::_hx_system::debug::log::LogStyle_obj::__new(HX_("[ERROR] ",d0,1f,cd,be),HX_("FF8888",40,7f,36,70),(int)12,false,false,false,HX_("flixel/sounds/beep",e6,b5,a9,33),true,null());
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.log.LogStyle","boot",0x6b6ebf21,"flixel.system.debug.log.LogStyle.boot","flixel/system/debug/log/LogStyle.hx",12,0x39dedcdd)
HXLINE(  12)		NOTICE =  ::flixel::_hx_system::debug::log::LogStyle_obj::__new(HX_("[NOTICE] ",96,5e,07,09),HX_("5CF878",41,9b,32,f3),(int)12,false,null(),null(),null(),null(),null());
            	}
{
            	HX_STACK_FRAME("flixel.system.debug.log.LogStyle","boot",0x6b6ebf21,"flixel.system.debug.log.LogStyle.boot","flixel/system/debug/log/LogStyle.hx",13,0x39dedcdd)
HXLINE(  13)		CONSOLE =  ::flixel::_hx_system::debug::log::LogStyle_obj::__new(HX_("&#62; ",7e,ad,6d,7c),HX_("5A96FA",c4,34,cc,c3),(int)12,false,null(),null(),null(),null(),null());
            	}
}
