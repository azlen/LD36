...
void GraphicMinimizeButton_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.system.debug.stats._Stats.GraphicMinimizeButton","new",0x3ce68c53,"flixel.system.debug.stats._Stats.GraphicMinimizeButton.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::stats::_Stats::GraphicMinimizeButton_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.stats._Stats.GraphicMinimizeButton","boot",0x04ed3cdf,"flixel.system.debug.stats._Stats.GraphicMinimizeButton.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_stats__Stats_GraphicMinimizeButton",38,20,46,56);
            	}
}
