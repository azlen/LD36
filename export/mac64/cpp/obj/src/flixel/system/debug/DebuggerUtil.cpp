...
Int Size = __o_Size.Default(12);
            	HX_STACK_FRAME("flixel.system.debug.DebuggerUtil","createTextField",0x34b9b52e,"flixel.system.debug.DebuggerUtil.createTextField","flixel/system/debug/DebuggerUtil.hx",19,0x13434d32)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
            	HX_STACK_ARG(Color,"Color")
            	HX_STACK_ARG(Size,"Size")
HXLINE(  19)		return ( ( ::openfl::_legacy::text::TextField)(::flixel::_hx_system::debug::DebuggerUtil_obj::initTextField( ::openfl::_legacy::text::TextField_obj::__new(),X,Y,Color,Size)) );
            	}
...
HXLINE(  34)		( ( ::openfl::_legacy::text::TextField)(tf) )->set_defaultTextFormat( ::openfl::_legacy::text::TextFormat_obj::__new(::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,Size,((int)Color & (int)(int)16777215),null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
