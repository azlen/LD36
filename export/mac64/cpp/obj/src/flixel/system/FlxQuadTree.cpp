...
hx::ObjectPtr< FlxQuadTree_obj > FlxQuadTree_obj::__new(Float X,Float Y,Float Width,Float Height, ::flixel::_hx_system::FlxQuadTree Parent)
{
	...
	_hx_result->__construct(X,Y,Width,Height,Parent);
	return _hx_result;
}
...
HXLINE( 252)		Bool _hx_tmp = hx::IsNotNull( Parent );
HXDLIN( 252)		if (_hx_tmp) {
HXLINE( 254)			HX_VAR(  ::flixel::_hx_system::FlxLinkedList,iterator);
HXLINE( 255)			HX_VAR(  ::flixel::_hx_system::FlxLinkedList,ot);
HXLINE( 256)			Bool _hx_tmp1 = hx::IsNotNull( Parent->_headA->object );
HXDLIN( 256)			if (_hx_tmp1) {
HXLINE( 258)				iterator = Parent->_headA;
HXLINE( 259)				while(true){
HXLINE( 259)					Bool _hx_tmp2 = !(hx::IsNotNull( iterator ));
HXDLIN( 259)					if (_hx_tmp2) {
HXLINE( 259)						goto _hx_goto_0;
            					}
HXLINE( 261)					Bool _hx_tmp3 = hx::IsNotNull( this->_tailA->object );
...
HXLINE( 271)			Bool _hx_tmp4 = hx::IsNotNull( Parent->_headB->object );
HXDLIN( 271)			if (_hx_tmp4) {
HXLINE( 273)				iterator = Parent->_headB;
HXLINE( 274)				while(true){
HXLINE( 274)					Bool _hx_tmp5 = !(hx::IsNotNull( iterator ));
HXDLIN( 274)					if (_hx_tmp5) {
HXLINE( 274)						goto _hx_goto_1;
            					}
HXLINE( 276)					Bool _hx_tmp6 = hx::IsNotNull( this->_tailB->object );
...
HXLINE( 289)			Float _hx_tmp7 = ((Float)(this->width + this->height) / (Float)((int)2 * ::flixel::_hx_system::FlxQuadTree_obj::divisions));
HXDLIN( 289)			::flixel::_hx_system::FlxQuadTree_obj::_min = ::Math_obj::floor(_hx_tmp7);
            		}
HXLINE( 291)		Bool _hx_tmp8;
HXDLIN( 291)		if (!((this->width > ::flixel::_hx_system::FlxQuadTree_obj::_min))) {
HXLINE( 291)			_hx_tmp8 = (this->height > ::flixel::_hx_system::FlxQuadTree_obj::_min);
            		}
            		else {
HXLINE( 291)			_hx_tmp8 = true;
            		}
HXDLIN( 291)		this->_canSubdivide = _hx_tmp8;
...
HXLINE( 349)		Bool _hx_tmp = hx::IsNotNull( ObjectOrGroup2 );
...
HXLINE( 374)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
HXLINE( 375)		Bool _hx_tmp = hx::IsNotNull( group );
HXDLIN( 375)		if (_hx_tmp) {
HXLINE( 377)			HX_VARI( Int,i) = (int)0;
HXLINE( 378)			HX_VAR(  ::flixel::FlxBasic,basic);
HXLINE( 379)			HX_VARI( ::Array< ::Dynamic>,members) = group->members;
HXLINE( 380)			HX_VARI( Int,l) = group->length;
HXLINE( 381)			while((i < l)){
HXLINE( 383)				Int _hx_tmp1 = i++;
HXDLIN( 383)				basic = members->__get(_hx_tmp1).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 384)				Bool _hx_tmp2;
HXDLIN( 384)				Bool _hx_tmp3 = hx::IsNotNull( basic );
HXDLIN( 384)				if (_hx_tmp3) {
HXLINE( 384)					_hx_tmp2 = basic->exists;
            				}
            				else {
...
HXLINE( 387)					Bool _hx_tmp4 = hx::IsNotNull( group );
...
HXLINE( 394)						Bool _hx_tmp5;
HXDLIN( 394)						if (::flixel::_hx_system::FlxQuadTree_obj::_object->exists) {
HXLINE( 394)							_hx_tmp5 = (::flixel::_hx_system::FlxQuadTree_obj::_object->allowCollisions != (int)0);
            						}
            						else {
HXLINE( 394)							_hx_tmp5 = false;
            						}
...
HXLINE( 398)							Float _hx_tmp6 = ::flixel::_hx_system::FlxQuadTree_obj::_object->x;
HXDLIN( 398)							Float _hx_tmp7 = ::flixel::_hx_system::FlxQuadTree_obj::_object->get_width();
HXDLIN( 398)							::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge = (_hx_tmp6 + _hx_tmp7);
HXLINE( 399)							Float _hx_tmp8 = ::flixel::_hx_system::FlxQuadTree_obj::_object->y;
HXDLIN( 399)							Float _hx_tmp9 = ::flixel::_hx_system::FlxQuadTree_obj::_object->get_height();
HXDLIN( 399)							::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge = (_hx_tmp8 + _hx_tmp9);
...
HXLINE( 409)			Bool _hx_tmp10;
HXDLIN( 409)			if (::flixel::_hx_system::FlxQuadTree_obj::_object->exists) {
HXLINE( 409)				_hx_tmp10 = (::flixel::_hx_system::FlxQuadTree_obj::_object->allowCollisions != (int)0);
            			}
            			else {
HXLINE( 409)				_hx_tmp10 = false;
            			}
HXDLIN( 409)			if (_hx_tmp10) {
...
HXLINE( 413)				Float _hx_tmp11 = ::flixel::_hx_system::FlxQuadTree_obj::_object->x;
HXDLIN( 413)				Float _hx_tmp12 = ::flixel::_hx_system::FlxQuadTree_obj::_object->get_width();
HXDLIN( 413)				::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge = (_hx_tmp11 + _hx_tmp12);
HXLINE( 414)				Float _hx_tmp13 = ::flixel::_hx_system::FlxQuadTree_obj::_object->y;
HXDLIN( 414)				Float _hx_tmp14 = ::flixel::_hx_system::FlxQuadTree_obj::_object->get_height();
HXDLIN( 414)				::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge = (_hx_tmp13 + _hx_tmp14);
...
HXLINE( 438)				Bool _hx_tmp5 = hx::IsNull( this->_northWestTree );
...
HXLINE( 445)				_hx_tmp6 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge < this->_bottomEdge);
            			}
            			else {
HXLINE( 445)				_hx_tmp6 = false;
            			}
HXDLIN( 445)			if (_hx_tmp6) {
HXLINE( 447)				Bool _hx_tmp7 = hx::IsNull( this->_southWestTree );
...
HXLINE( 455)			_hx_tmp8 = (::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge < this->_rightEdge);
            		}
            		else {
HXLINE( 455)			_hx_tmp8 = false;
            		}
HXDLIN( 455)		if (_hx_tmp8) {
HXLINE( 457)			Bool _hx_tmp9;
HXDLIN( 457)			if ((::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge > this->_topEdge)) {
HXLINE( 457)				_hx_tmp9 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge < this->_midpointY);
            			}
            			else {
HXLINE( 457)				_hx_tmp9 = false;
            			}
HXDLIN( 457)			if (_hx_tmp9) {
HXLINE( 459)				Bool _hx_tmp10 = hx::IsNull( this->_northEastTree );
...
HXLINE( 466)			Bool _hx_tmp11;
HXDLIN( 466)			if ((::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge > this->_midpointY)) {
HXLINE( 466)				_hx_tmp11 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge < this->_bottomEdge);
            			}
            			else {
HXLINE( 466)				_hx_tmp11 = false;
            			}
HXDLIN( 466)			if (_hx_tmp11) {
HXLINE( 468)				Bool _hx_tmp12 = hx::IsNull( this->_southEastTree );
HXDLIN( 468)				if (_hx_tmp12) {
...
HXLINE( 478)			_hx_tmp15 = (::flixel::_hx_system::FlxQuadTree_obj::_objectLeftEdge < this->_midpointX);
            		}
            		else {
HXLINE( 478)			_hx_tmp15 = false;
            		}
HXDLIN( 478)		if (_hx_tmp15) {
HXLINE( 478)			_hx_tmp14 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge > this->_topEdge);
            		}
            		else {
HXLINE( 478)			_hx_tmp14 = false;
            		}
HXDLIN( 478)		if (_hx_tmp14) {
HXLINE( 478)			_hx_tmp13 = (::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge < this->_midpointY);
            		}
            		else {
HXLINE( 478)			_hx_tmp13 = false;
            		}
HXDLIN( 478)		if (_hx_tmp13) {
HXLINE( 480)			Bool _hx_tmp16 = hx::IsNull( this->_northWestTree );
...
HXLINE( 486)		Bool _hx_tmp17;
HXDLIN( 486)		Bool _hx_tmp18;
HXDLIN( 486)		Bool _hx_tmp19;
HXDLIN( 486)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge > this->_midpointX)) {
HXLINE( 486)			_hx_tmp19 = (::flixel::_hx_system::FlxQuadTree_obj::_objectLeftEdge < this->_rightEdge);
            		}
            		else {
HXLINE( 486)			_hx_tmp19 = false;
            		}
HXDLIN( 486)		if (_hx_tmp19) {
HXLINE( 486)			_hx_tmp18 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge > this->_topEdge);
            		}
            		else {
HXLINE( 486)			_hx_tmp18 = false;
            		}
HXDLIN( 486)		if (_hx_tmp18) {
HXLINE( 486)			_hx_tmp17 = (::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge < this->_midpointY);
            		}
            		else {
HXLINE( 486)			_hx_tmp17 = false;
            		}
HXDLIN( 486)		if (_hx_tmp17) {
HXLINE( 488)			Bool _hx_tmp20 = hx::IsNull( this->_northEastTree );
...
HXLINE( 494)		Bool _hx_tmp21;
HXDLIN( 494)		Bool _hx_tmp22;
HXDLIN( 494)		Bool _hx_tmp23;
HXDLIN( 494)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge > this->_midpointX)) {
HXLINE( 494)			_hx_tmp23 = (::flixel::_hx_system::FlxQuadTree_obj::_objectLeftEdge < this->_rightEdge);
            		}
            		else {
HXLINE( 494)			_hx_tmp23 = false;
            		}
HXDLIN( 494)		if (_hx_tmp23) {
HXLINE( 494)			_hx_tmp22 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge > this->_midpointY);
            		}
            		else {
HXLINE( 494)			_hx_tmp22 = false;
            		}
HXDLIN( 494)		if (_hx_tmp22) {
HXLINE( 494)			_hx_tmp21 = (::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge < this->_bottomEdge);
            		}
            		else {
HXLINE( 494)			_hx_tmp21 = false;
            		}
HXDLIN( 494)		if (_hx_tmp21) {
HXLINE( 496)			Bool _hx_tmp24 = hx::IsNull( this->_southEastTree );
HXDLIN( 496)			if (_hx_tmp24) {
...
HXLINE( 502)		Bool _hx_tmp25;
HXDLIN( 502)		Bool _hx_tmp26;
HXDLIN( 502)		Bool _hx_tmp27;
HXDLIN( 502)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge > this->_leftEdge)) {
HXLINE( 502)			_hx_tmp27 = (::flixel::_hx_system::FlxQuadTree_obj::_objectLeftEdge < this->_midpointX);
            		}
            		else {
HXLINE( 502)			_hx_tmp27 = false;
            		}
HXDLIN( 502)		if (_hx_tmp27) {
HXLINE( 502)			_hx_tmp26 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge > this->_midpointY);
            		}
            		else {
HXLINE( 502)			_hx_tmp26 = false;
            		}
HXDLIN( 502)		if (_hx_tmp26) {
HXLINE( 502)			_hx_tmp25 = (::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge < this->_bottomEdge);
            		}
            		else {
HXLINE( 502)			_hx_tmp25 = false;
            		}
HXDLIN( 502)		if (_hx_tmp25) {
HXLINE( 504)			Bool _hx_tmp28 = hx::IsNull( this->_southWestTree );
HXDLIN( 504)			if (_hx_tmp28) {
...
void FlxQuadTree_obj::addToList(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 517)		HX_VAR(  ::flixel::_hx_system::FlxLinkedList,ot);
HXLINE( 518)		Bool _hx_tmp = (::flixel::_hx_system::FlxQuadTree_obj::_list == (int)0);
HXDLIN( 518)		if (_hx_tmp) {
HXLINE( 520)			Bool _hx_tmp1 = hx::IsNotNull( this->_tailA->object );
...
HXLINE( 530)			Bool _hx_tmp2 = hx::IsNotNull( this->_tailB->object );
...
HXLINE( 542)		Bool _hx_tmp3 = hx::IsNotNull( this->_northWestTree );
HXDLIN( 542)		if (_hx_tmp3) {
HXLINE( 544)			this->_northWestTree->addToList();
            		}
HXLINE( 546)		Bool _hx_tmp4 = hx::IsNotNull( this->_northEastTree );
HXDLIN( 546)		if (_hx_tmp4) {
HXLINE( 548)			this->_northEastTree->addToList();
            		}
HXLINE( 550)		Bool _hx_tmp5 = hx::IsNotNull( this->_southEastTree );
HXDLIN( 550)		if (_hx_tmp5) {
HXLINE( 552)			this->_southEastTree->addToList();
            		}
HXLINE( 554)		Bool _hx_tmp6 = hx::IsNotNull( this->_southWestTree );
...
Bool FlxQuadTree_obj::execute(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 567)		HX_VARI( Bool,overlapProcessed) = false;
HXLINE( 569)		Bool _hx_tmp = hx::IsNotNull( this->_headA->object );
HXDLIN( 569)		if (_hx_tmp) {
HXLINE( 571)			HX_VARI(  ::flixel::_hx_system::FlxLinkedList,iterator) = this->_headA;
HXLINE( 572)			while(true){
HXLINE( 572)				Bool _hx_tmp1 = !(hx::IsNotNull( iterator ));
HXDLIN( 572)				if (_hx_tmp1) {
HXLINE( 572)					goto _hx_goto_3;
            				}
HXLINE( 574)				::flixel::_hx_system::FlxQuadTree_obj::_object = iterator->object;
HXLINE( 575)				Bool _hx_tmp2 = ::flixel::_hx_system::FlxQuadTree_obj::_useBothLists;
...
HXDLIN( 583)				Bool _hx_tmp8 = hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_object );
HXDLIN( 583)				if (_hx_tmp8) {
HXLINE( 583)					_hx_tmp7 = ::flixel::_hx_system::FlxQuadTree_obj::_object->exists;
            				}
            				else {
HXLINE( 583)					_hx_tmp7 = false;
            				}
HXDLIN( 583)				if (_hx_tmp7) {
HXLINE( 583)					_hx_tmp6 = (::flixel::_hx_system::FlxQuadTree_obj::_object->allowCollisions > (int)0);
            				}
            				else {
HXLINE( 583)					_hx_tmp6 = false;
            				}
HXDLIN( 583)				if (_hx_tmp6) {
HXLINE( 583)					_hx_tmp5 = hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_iterator );
            				}
            				else {
HXLINE( 583)					_hx_tmp5 = false;
            				}
HXDLIN( 583)				if (_hx_tmp5) {
HXLINE( 583)					_hx_tmp4 = hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_iterator->object );
            				}
            				else {
HXLINE( 583)					_hx_tmp4 = false;
            				}
HXDLIN( 583)				if (_hx_tmp4) {
HXLINE( 583)					_hx_tmp3 = this->overlapNode();
            				}
            				else {
...
HXLINE( 593)		Bool _hx_tmp9;
HXDLIN( 593)		Bool _hx_tmp10 = hx::IsNotNull( this->_northWestTree );
HXDLIN( 593)		if (_hx_tmp10) {
HXLINE( 593)			_hx_tmp9 = this->_northWestTree->execute();
            		}
            		else {
HXLINE( 593)			_hx_tmp9 = false;
            		}
HXDLIN( 593)		if (_hx_tmp9) {
HXLINE( 595)			overlapProcessed = true;
            		}
HXLINE( 597)		Bool _hx_tmp11;
HXDLIN( 597)		Bool _hx_tmp12 = hx::IsNotNull( this->_northEastTree );
HXDLIN( 597)		if (_hx_tmp12) {
HXLINE( 597)			_hx_tmp11 = this->_northEastTree->execute();
            		}
            		else {
HXLINE( 597)			_hx_tmp11 = false;
            		}
HXDLIN( 597)		if (_hx_tmp11) {
HXLINE( 599)			overlapProcessed = true;
            		}
HXLINE( 601)		Bool _hx_tmp13;
HXDLIN( 601)		Bool _hx_tmp14 = hx::IsNotNull( this->_southEastTree );
HXDLIN( 601)		if (_hx_tmp14) {
HXLINE( 601)			_hx_tmp13 = this->_southEastTree->execute();
            		}
            		else {
HXLINE( 601)			_hx_tmp13 = false;
            		}
HXDLIN( 601)		if (_hx_tmp13) {
HXLINE( 603)			overlapProcessed = true;
            		}
HXLINE( 605)		Bool _hx_tmp15;
HXDLIN( 605)		Bool _hx_tmp16 = hx::IsNotNull( this->_southWestTree );
HXDLIN( 605)		if (_hx_tmp16) {
HXLINE( 605)			_hx_tmp15 = this->_southWestTree->execute();
            		}
            		else {
...
HXLINE( 628)		HX_VARI( Bool,overlapProcessed) = false;
HXLINE( 629)		HX_VAR(  ::flixel::FlxObject,checkObject);
HXLINE( 631)		while(true){
HXLINE( 631)			Bool _hx_tmp6 = !(hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_iterator ));
HXDLIN( 631)			if (_hx_tmp6) {
HXLINE( 631)				goto _hx_goto_4;
            			}
HXLINE( 633)			checkObject = ::flixel::_hx_system::FlxQuadTree_obj::_iterator->object;
HXLINE( 634)			Bool _hx_tmp7;
HXDLIN( 634)			Bool _hx_tmp8;
HXDLIN( 634)			if (hx::IsNotEq( ::flixel::_hx_system::FlxQuadTree_obj::_object,checkObject )) {
HXLINE( 634)				_hx_tmp8 = !(checkObject->exists);
            			}
            			else {
HXLINE( 634)				_hx_tmp8 = true;
            			}
HXDLIN( 634)			if (!(_hx_tmp8)) {
HXLINE( 634)				_hx_tmp7 = (checkObject->allowCollisions <= (int)0);
            			}
            			else {
...
HXLINE( 641)			Float _hx_tmp9;
HXDLIN( 641)			if ((checkObject->x < checkObject->last->x)) {
HXLINE( 641)				_hx_tmp9 = checkObject->x;
            			}
            			else {
HXLINE( 641)				_hx_tmp9 = checkObject->last->x;
            			}
HXDLIN( 641)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullX = _hx_tmp9;
HXLINE( 642)			Float _hx_tmp10;
HXDLIN( 642)			if ((checkObject->y < checkObject->last->y)) {
HXLINE( 642)				_hx_tmp10 = checkObject->y;
            			}
            			else {
HXLINE( 642)				_hx_tmp10 = checkObject->last->y;
            			}
HXDLIN( 642)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullY = _hx_tmp10;
HXLINE( 643)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth = (checkObject->x - checkObject->last->x);
HXLINE( 644)			Float _hx_tmp11 = checkObject->get_width();
HXDLIN( 644)			Float _hx_tmp12;
HXDLIN( 644)			if ((::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth > (int)0)) {
HXLINE( 644)				_hx_tmp12 = ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth;
            			}
            			else {
HXLINE( 644)				_hx_tmp12 = -(::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth);
            			}
HXDLIN( 644)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth = (_hx_tmp11 + _hx_tmp12);
HXLINE( 645)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight = (checkObject->y - checkObject->last->y);
HXLINE( 646)			Float _hx_tmp13 = checkObject->get_height();
HXDLIN( 646)			Float _hx_tmp14;
HXDLIN( 646)			if ((::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight > (int)0)) {
HXLINE( 646)				_hx_tmp14 = ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight;
            			}
            			else {
HXLINE( 646)				_hx_tmp14 = -(::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight);
            			}
HXDLIN( 646)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight = (_hx_tmp13 + _hx_tmp14);
HXLINE( 649)			Bool _hx_tmp15;
HXDLIN( 649)			Bool _hx_tmp16;
HXDLIN( 649)			Bool _hx_tmp17;
...
HXLINE( 649)				_hx_tmp17 = (::flixel::_hx_system::FlxQuadTree_obj::_objectHullX < (::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullX + ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth));
            			}
            			else {
HXLINE( 649)				_hx_tmp17 = false;
            			}
HXDLIN( 649)			if (_hx_tmp17) {
HXLINE( 649)				_hx_tmp16 = ((::flixel::_hx_system::FlxQuadTree_obj::_objectHullY + ::flixel::_hx_system::FlxQuadTree_obj::_objectHullHeight) > ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullY);
            			}
            			else {
HXLINE( 649)				_hx_tmp16 = false;
            			}
HXDLIN( 649)			if (_hx_tmp16) {
HXLINE( 649)				_hx_tmp15 = (::flixel::_hx_system::FlxQuadTree_obj::_objectHullY < (::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullY + ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight));
            			}
            			else {
HXLINE( 649)				_hx_tmp15 = false;
            			}
HXDLIN( 649)			if (_hx_tmp15) {
HXLINE( 655)				Bool _hx_tmp18;
HXDLIN( 655)				Bool _hx_tmp19 = hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_processingCallback );
HXDLIN( 655)				if (_hx_tmp19) {
HXLINE( 655)					_hx_tmp18 = ( (Bool)(::flixel::_hx_system::FlxQuadTree_obj::_processingCallback(::flixel::_hx_system::FlxQuadTree_obj::_object,checkObject)) );
            				}
            				else {
HXLINE( 655)					_hx_tmp18 = true;
            				}
HXDLIN( 655)				if (_hx_tmp18) {
HXLINE( 657)					overlapProcessed = true;
HXLINE( 658)					Bool _hx_tmp20 = hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_notifyCallback );
HXDLIN( 658)					if (_hx_tmp20) {
HXLINE( 660)						::flixel::_hx_system::FlxQuadTree_obj::_notifyCallback(::flixel::_hx_system::FlxQuadTree_obj::_object,checkObject);
            					}
            				}
            			}
HXLINE( 664)			Bool _hx_tmp21 = hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_iterator );
HXDLIN( 664)			if (_hx_tmp21) {
...
Int FlxQuadTree_obj::_NUM_CACHED_QUAD_TREES;
 ...
 ::flixel::_hx_system::FlxQuadTree FlxQuadTree_obj::recycle(Float X,Float Y,Float Width,Float Height, ::flixel::_hx_system::FlxQuadTree Parent){
            	HX_STACK_FRAME("flixel.system.FlxQuadTree","recycle",0x77ad32af,"flixel.system.FlxQuadTree.recycle","flixel/system/FlxQuadTree.hx",215,0xb5742814)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
            	HX_STACK_ARG(Parent,"Parent")
HXLINE( 215)		Bool _hx_tmp = hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_cachedTreesHead );
HXDLIN( 215)		if (_hx_tmp) {
HXLINE( 217)			HX_VARI(  ::flixel::_hx_system::FlxQuadTree,cachedTree) = ::flixel::_hx_system::FlxQuadTree_obj::_cachedTreesHead;
...
HXLINE( 225)			return  ::flixel::_hx_system::FlxQuadTree_obj::__new(X,Y,Width,Height,Parent);
            		}
...
HXLINE( 233)			Bool _hx_tmp = !(hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_cachedTreesHead ));
HXDLIN( 233)			if (_hx_tmp) {
HXLINE( 233)				goto _hx_goto_5;
            			}
HXLINE( 235)			HX_VARI(  ::flixel::_hx_system::FlxQuadTree,node) = ::flixel::_hx_system::FlxQuadTree_obj::_cachedTreesHead;
...
{
{
            	HX_STACK_FRAME("flixel.system.FlxQuadTree","boot",0xe5aee816,"flixel.system.FlxQuadTree.boot","flixel/system/FlxQuadTree.hx",21,0xb5742814)
HXLINE(  21)		A_LIST = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.system.FlxQuadTree","boot",0xe5aee816,"flixel.system.FlxQuadTree.boot","flixel/system/FlxQuadTree.hx",25,0xb5742814)
HXLINE(  25)		B_LIST = (int)1;
            	}
{
            	HX_STACK_FRAME("flixel.system.FlxQuadTree","boot",0xe5aee816,"flixel.system.FlxQuadTree.boot","flixel/system/FlxQuadTree.hx",191,0xb5742814)
HXLINE( 191)		_NUM_CACHED_QUAD_TREES = (int)0;
            	}
}
