...
void SignalFrontEnd_obj::__construct(){
            	HX_STACK_FRAME("flixel.system.frontEnds.SignalFrontEnd","new",0xa84da1e6,"flixel.system.frontEnds.SignalFrontEnd.new","flixel/system/frontEnds/SignalFrontEnd.hx",5,0x6eb9cd09)
            	HX_STACK_THIS(this)
HXLINE(  28)		this->focusLost =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  27)		this->focusGained =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  26)		this->postDraw =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  25)		this->preDraw =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  24)		this->postUpdate =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  23)		this->preUpdate =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  22)		this->gameStarted =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  18)		this->postGameReset =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  17)		this->preGameReset =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
HXLINE(  16)		this->gameResized =  ::flixel::util::_FlxSignal::FlxSignal2_obj::__new();
HXLINE(  11)		this->preStateCreate =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__new();
HXLINE(  10)		this->stateSwitched =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
            	}
