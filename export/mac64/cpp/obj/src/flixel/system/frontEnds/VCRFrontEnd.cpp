...
void VCRFrontEnd_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  51)		this->stepRequested = false;
HXLINE(  47)		this->paused = false;
            	}
...
void VCRFrontEnd_obj::pause(){
            	HX_STACK_FRAME("flixel.system.frontEnds.VCRFrontEnd","pause",0x6797a245,"flixel.system.frontEnds.VCRFrontEnd.pause","flixel/system/frontEnds/VCRFrontEnd.hx",58,0xa1666a42)
            	HX_STACK_THIS(this)
HXLINE(  58)		Bool _hx_tmp = !(this->paused);
HXDLIN(  58)		if (_hx_tmp) {
HXLINE(  61)			Bool _hx_tmp1 = !(::flixel::FlxG_obj::mouse->useSystemCursor);
HXDLIN(  61)			if (_hx_tmp1) {
HXLINE(  62)				::openfl::_legacy::ui::Mouse_obj::show();
            			}
HXLINE(  65)			this->paused = true;
            		}
            	}
...
void VCRFrontEnd_obj::resume(){
            	HX_STACK_FRAME("flixel.system.frontEnds.VCRFrontEnd","resume",0x5616837e,"flixel.system.frontEnds.VCRFrontEnd.resume","flixel/system/frontEnds/VCRFrontEnd.hx",78,0xa1666a42)
            	HX_STACK_THIS(this)
HXLINE(  78)		Bool _hx_tmp = this->paused;
HXDLIN(  78)		if (_hx_tmp) {
HXLINE(  81)			Bool _hx_tmp1 = !(::flixel::FlxG_obj::mouse->useSystemCursor);
HXDLIN(  81)			if (_hx_tmp1) {
HXLINE(  82)				::openfl::_legacy::ui::Mouse_obj::hide();
            			}
HXLINE(  85)			this->paused = false;
            		}
            	}
