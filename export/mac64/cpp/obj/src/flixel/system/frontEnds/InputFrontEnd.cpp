...
HXDLIN(  30)				++_g;
HXLINE(  32)				HX_VAR( hx::Class,cl);
HXDLIN(  32)				Bool _hx_tmp = ::Std_obj::is(Input,hx::ClassOf< ::hx::Class >());
HXDLIN(  32)				if (_hx_tmp) {
HXLINE(  32)					cl = Input;
            				}
            				else {
HXLINE(  32)					cl = ::Type_obj::getClass(Input);
            				}
HXDLIN(  32)				HX_VARI( ::String,s) = ::Type_obj::getClassName(cl);
HXDLIN(  32)				Bool _hx_tmp1 = hx::IsNotNull( s );
HXDLIN(  32)				if (_hx_tmp1) {
HXLINE(  32)					s = ::StringTools_obj::replace(s,HX_("::",c0,32,00,00),HX_(".",2e,00,00,00));
HXDLIN(  32)					{
HXLINE(  32)						Int _hx_tmp2 = s.lastIndexOf(HX_(".",2e,00,00,00),null());
HXDLIN(  32)						s = s.substr((_hx_tmp2 + (int)1),null());
            					}
            				}
HXDLIN(  32)				::String _hx_tmp3 = s;
HXDLIN(  32)				HX_VAR_NAME( hx::Class,cl1,"cl");
HXDLIN(  32)				Bool _hx_tmp4 = ::Std_obj::is(input,hx::ClassOf< ::hx::Class >());
HXDLIN(  32)				if (_hx_tmp4) {
HXLINE(  32)					cl1 = input;
            				}
            				else {
HXLINE(  32)					cl1 = ::Type_obj::getClass(input);
            				}
HXDLIN(  32)				HX_VARI_NAME( ::String,s1,"s") = ::Type_obj::getClassName(cl1);
HXDLIN(  32)				Bool _hx_tmp5 = hx::IsNotNull( s1 );
HXDLIN(  32)				if (_hx_tmp5) {
HXLINE(  32)					s1 = ::StringTools_obj::replace(s1,HX_("::",c0,32,00,00),HX_(".",2e,00,00,00));
HXDLIN(  32)					{
HXLINE(  32)						Int _hx_tmp6 = s1.lastIndexOf(HX_(".",2e,00,00,00),null());
HXDLIN(  32)						s1 = s1.substr((_hx_tmp6 + (int)1),null());
            					}
            				}
HXDLIN(  32)				if ((_hx_tmp3 == s1)) {
...
void InputFrontEnd_obj::onStateSwitch(){
            	HX_STACK_FRAME("flixel.system.frontEnds.InputFrontEnd","onStateSwitch",0x594606fa,"flixel.system.frontEnds.InputFrontEnd.onStateSwitch","flixel/system/frontEnds/InputFrontEnd.hx",136,0x759f67bd)
            	HX_STACK_THIS(this)
HXLINE( 136)		Bool _hx_tmp = this->resetOnStateSwitch;
