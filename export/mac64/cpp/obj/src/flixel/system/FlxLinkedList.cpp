...
void FlxLinkedList_obj::__construct(){
            	HX_STACK_FRAME("flixel.system.FlxLinkedList","new",0xf2c6bf4e,"flixel.system.FlxLinkedList.new","flixel/system/FlxLinkedList.hx",65,0xa1edd602)
            	HX_STACK_THIS(this)
HXLINE(  65)		this->exists = true;
            	}
...
HXLINE(  82)		Bool _hx_tmp = hx::IsNotNull( this->next );
...
HXLINE(  25)		Bool _hx_tmp = hx::IsNotNull( ::flixel::_hx_system::FlxLinkedList_obj::_cachedListsHead );
HXDLIN(  25)		if (_hx_tmp) {
HXLINE(  27)			HX_VARI(  ::flixel::_hx_system::FlxLinkedList,cachedList) = ::flixel::_hx_system::FlxLinkedList_obj::_cachedListsHead;
...
HXLINE(  36)			return  ::flixel::_hx_system::FlxLinkedList_obj::__new();
            		}
...
HXLINE(  46)			Bool _hx_tmp = !(hx::IsNotNull( ::flixel::_hx_system::FlxLinkedList_obj::_cachedListsHead ));
HXDLIN(  46)			if (_hx_tmp) {
HXLINE(  46)				goto _hx_goto_0;
            			}
HXLINE(  48)			HX_VARI(  ::flixel::_hx_system::FlxLinkedList,node) = ::flixel::_hx_system::FlxLinkedList_obj::_cachedListsHead;
...
{
{
            	HX_STACK_FRAME("flixel.system.FlxLinkedList","boot",0x7339a584,"flixel.system.FlxLinkedList.boot","flixel/system/FlxLinkedList.hx",17,0xa1edd602)
HXLINE(  17)		_NUM_CACHED_FLX_LIST = (int)0;
            	}
}
