...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxAssets_obj,drawLogo,(void))
 ...
 ::openfl::_legacy::display::BitmapData FlxAssets_obj::getBitmapData(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 126)		Bool _hx_tmp = ::openfl::_legacy::Assets_obj::exists(id,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxAssets_obj,getBitmapData,return )
 ...
 ::openfl::_legacy::display::BitmapData FlxAssets_obj::getBitmapFromClass(hx::Class source){
            	HX_STACK_FRAME("flixel.system.FlxAssets","getBitmapFromClass",0x223d9eaf,"flixel.system.FlxAssets.getBitmapFromClass","flixel/system/FlxAssets.hx",140,0xd3ac1356)
            	HX_STACK_ARG(source,"source")
HXLINE( 140)		return ( ( ::openfl::_legacy::display::BitmapData)(::Type_obj::createInstance(source,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
            	}
...
HXLINE( 155)		Bool _hx_tmp = ::Std_obj::is(Graphic,hx::ClassOf< ::openfl::_legacy::display::BitmapData >());
HXDLIN( 155)		if (_hx_tmp) {
HXLINE( 157)			return ( ( ::openfl::_legacy::display::BitmapData)(Graphic) );
            		}
            		else {
HXLINE( 159)			Bool _hx_tmp1 = ::Std_obj::is(Graphic,hx::ClassOf< ::hx::Class >());
...
HXLINE( 163)				Bool _hx_tmp2 = ::Std_obj::is(Graphic,hx::ClassOf< ::String >());
HXDLIN( 163)				if (_hx_tmp2) {
HXLINE( 165)					 ::openfl::_legacy::display::BitmapData _hx_tmp3;
HXDLIN( 165)					Bool _hx_tmp4 = ::openfl::_legacy::Assets_obj::exists(Graphic,null());
HXDLIN( 165)					if (_hx_tmp4) {
HXLINE( 165)						_hx_tmp3 = ::openfl::_legacy::Assets_obj::getBitmapData(Graphic,false);
            					}
            					else {
HXLINE( 165)						_hx_tmp3 = null();
            					}
HXDLIN( 165)					return _hx_tmp3;
            				}
            			}
            		}
...
HXLINE( 184)		Bool _hx_tmp = hx::IsNotNull( Key );
HXDLIN( 184)		if (_hx_tmp) {
HXLINE( 186)			return Key;
            		}
HXLINE( 189)		Bool _hx_tmp1 = ::Std_obj::is(Graphic,hx::ClassOf< ::openfl::_legacy::display::BitmapData >());
HXDLIN( 189)		if (_hx_tmp1) {
HXLINE( 191)			return Key;
            		}
            		else {
HXLINE( 193)			Bool _hx_tmp2 = ::Std_obj::is(Graphic,hx::ClassOf< ::hx::Class >());
HXDLIN( 193)			if (_hx_tmp2) {
HXLINE( 195)				return ::Type_obj::getClassName(Graphic);
            			}
            			else {
HXLINE( 197)				Bool _hx_tmp3 = ::Std_obj::is(Graphic,hx::ClassOf< ::String >());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAssets_obj,resolveKey,return )
 ...
 ::openfl::_legacy::media::Sound FlxAssets_obj::getSound(::String id){
            	HX_STACK_FRAME("flixel.system.FlxAssets","getSound",0x306e52ff,"flixel.system.FlxAssets.getSound","flixel/system/FlxAssets.hx",213,0xd3ac1356)
            	HX_STACK_ARG(id,"id")
...
HXLINE( 219)		::String _hx_tmp = ::Std_obj::string( ::flixel::_hx_system::VirtualInputData_obj::__new(null()));
HXDLIN( 219)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(graphic,_hx_tmp);
            	}
...
{
{
            	HX_STACK_FRAME("flixel.system.FlxAssets","boot",0x48106fd8,"flixel.system.FlxAssets.boot","flixel/system/FlxAssets.hx",65,0xd3ac1356)
HXLINE(  65)		FONT_DEFAULT = HX_("Nokia Cellphone FC Small",d6,2f,44,ca);
            	}
{
            	HX_STACK_FRAME("flixel.system.FlxAssets","boot",0x48106fd8,"flixel.system.FlxAssets.boot","flixel/system/FlxAssets.hx",66,0xd3ac1356)
