...
void FlxBasic_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  58)		this->flixelType = (int)0;
...
void FlxBasic_obj::destroy(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  70)		this->set_exists(false);
HXLINE(  71)		this->_cameras = null();
            	}
...
void FlxBasic_obj::kill(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  80)		this->set_alive(false);
HXLINE(  81)		this->set_exists(false);
            	}
...
void FlxBasic_obj::revive(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  90)		this->set_alive(true);
HXLINE(  91)		this->set_exists(true);
            	}
...
::String FlxBasic_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 119)		 ::Dynamic value = this->active;
HXDLIN( 119)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 119)		_this->label = HX_("active",c6,41,46,16);
HXDLIN( 119)		_this->value = value;
HXLINE( 120)		 ::Dynamic value1 = this->visible;
HXDLIN( 120)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 120)		_this1->label = HX_("visible",72,78,24,a3);
HXDLIN( 120)		_this1->value = value1;
HXLINE( 121)		 ::Dynamic value2 = this->alive;
HXDLIN( 121)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 121)		_this2->label = HX_("alive",cd,63,91,21);
HXDLIN( 121)		_this2->value = value2;
HXLINE( 122)		 ::Dynamic value3 = this->exists;
HXDLIN( 122)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 122)		_this3->label = HX_("exists",dc,1d,e0,bf);
HXDLIN( 122)		_this3->value = value3;
HXLINE( 118)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_this)->init(1,_this1)->init(2,_this2)->init(3,_this3));
            	}
...
HXLINE( 127)		return (this->visible = Value);
            	}
...
Bool FlxBasic_obj::set_active(Bool Value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 132)		return (this->active = Value);
            	}
...
Bool FlxBasic_obj::set_exists(Bool Value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 137)		return (this->exists = Value);
            	}
...
Bool FlxBasic_obj::set_alive(Bool Value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 142)		return (this->alive = Value);
            	}
...
HXDLIN( 147)		Bool _hx_tmp1 = hx::IsNotNull( this->_cameras );
HXDLIN( 147)		if (_hx_tmp1) {
HXLINE( 147)			_hx_tmp = (this->_cameras->length == (int)0);
            		}
            		else {
HXLINE( 147)			_hx_tmp = true;
            		}
HXDLIN( 147)		if (_hx_tmp) {
HXLINE( 147)			return ::flixel::FlxCamera_obj::defaultCameras->__get((int)0).StaticCast<  ::flixel::FlxCamera >();
            		}
            		else {
HXLINE( 147)			return this->_cameras->__get((int)0).StaticCast<  ::flixel::FlxCamera >();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxBasic_obj,get_camera,return )
 ...
 ::flixel::FlxCamera FlxBasic_obj::set_camera( ::flixel::FlxCamera Value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 152)		Bool _hx_tmp = hx::IsNull( this->_cameras );
HXDLIN( 152)		if (_hx_tmp) {
HXLINE( 153)			this->_cameras = ::Array_obj< ::Dynamic>::__new(1)->init(0,Value);
            		}
            		else {
HXLINE( 155)			this->_cameras[(int)0] = Value;
            		}
...
::Array< ::Dynamic> FlxBasic_obj::get_cameras(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 161)		Bool _hx_tmp = hx::IsNull( this->_cameras );
HXDLIN( 161)		if (_hx_tmp) {
HXLINE( 161)			return ::flixel::FlxCamera_obj::defaultCameras;
            		}
            		else {
HXLINE( 161)			return this->_cameras;
            		}
...
::Array< ::Dynamic> FlxBasic_obj::set_cameras(::Array< ::Dynamic> Value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 166)		return (this->_cameras = Value);
            	}
