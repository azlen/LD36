...
void FlxMouseButton_obj::__construct(Int ID){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouseButton","new",0xa21f5d96,"flixel.input.mouse.FlxMouseButton.new","flixel/input/mouse/FlxMouseButton.hx",9,0x7fcdf6f7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ID,"ID")
...
void FlxMouseButton_obj::update(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouseButton","update",0x2ce19e93,"flixel.input.mouse.FlxMouseButton.update","flixel/input/mouse/FlxMouseButton.hx",32,0x7fcdf6f7)
            	HX_STACK_THIS(this)
HXLINE(  33)		this->super::update();
HXLINE(  35)		Bool _hx_tmp = (this->current == (int)2);
...
HXLINE(  41)			Bool _hx_tmp1 = (this->current == (int)-1);
HXDLIN(  41)			if (_hx_tmp1) {
HXLINE(  43)				Int _hx_tmp2 = ( (Int)(this->ID) );
HXDLIN(  43)				 ::flixel::math::FlxPoint _hx_tmp3 = ::flixel::FlxG_obj::mouse->getScreenPosition(null(),null());
HXDLIN(  43)				::flixel::FlxG_obj::swipes->push( ::flixel::input::FlxSwipe_obj::__new(_hx_tmp2,this->justPressedPosition,_hx_tmp3,this->justPressedTimeInTicks));
            			}
            		}
            	}
...
void FlxMouseButton_obj::destroy(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouseButton","destroy",0x9f3f8d30,"flixel.input.mouse.FlxMouseButton.destroy","flixel/input/mouse/FlxMouseButton.hx",50,0x7fcdf6f7)
            	HX_STACK_THIS(this)
...
void FlxMouseButton_obj::onDown( ::Dynamic _){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouseButton","onDown",0x8ad419ab,"flixel.input.mouse.FlxMouseButton.onDown","flixel/input/mouse/FlxMouseButton.hx",70,0x7fcdf6f7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE(  70)		Bool _hx_tmp = ::flixel::FlxG_obj::mouse->enabled;
...
void FlxMouseButton_obj::onUp( ::Dynamic _){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouseButton","onUp",0x3a027364,"flixel.input.mouse.FlxMouseButton.onUp","flixel/input/mouse/FlxMouseButton.hx",76,0x7fcdf6f7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
HXLINE(  76)		Bool _hx_tmp = ::flixel::FlxG_obj::mouse->enabled;
