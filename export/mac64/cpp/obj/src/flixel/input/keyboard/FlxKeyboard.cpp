...
void FlxKeyboard_obj::__construct(){
            	HX_STACK_FRAME("flixel.input.keyboard.FlxKeyboard","new",0xa12d657a,"flixel.input.keyboard.FlxKeyboard.new","flixel/input/keyboard/FlxKeyboard.hx",24,0x41882875)
            	HX_STACK_THIS(this)
HXLINE(  25)		super::__construct(hx::ClassOf< ::flixel::input::keyboard::FlxKeyList >());
HXLINE(  27)		{
HXLINE(  27)			HX_VARI(  ::Dynamic,tmp) = ::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->iterator();
HXDLIN(  27)			while(true){
HXLINE(  27)				Bool _hx_tmp = !(( (Bool)( ::Dynamic(tmp->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(  27)				if (_hx_tmp) {
HXLINE(  27)					goto _hx_goto_0;
            				}
HXDLIN(  27)				HX_VARI( Int,code) = ( (Int)( ::Dynamic(tmp->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(  29)				Bool _hx_tmp1;
HXDLIN(  29)				if ((code != (int)-2)) {
HXLINE(  29)					_hx_tmp1 = (code != (int)-1);
            				}
            				else {
HXLINE(  29)					_hx_tmp1 = false;
            				}
HXDLIN(  29)				if (_hx_tmp1) {
HXLINE(  31)					HX_VARI(  ::flixel::input::FlxInput,input) =  ::flixel::input::FlxInput_obj::__new(code);
HXLINE(  32)					this->_keyListArray->push(input);
HXLINE(  33)					this->_keyListMap->set(code,input);
            				}
            			}
            			_hx_goto_0:;
            		}
HXLINE(  38)		this->_nativeCorrection =  ::haxe::ds::StringMap_obj::__new();
...
void FlxKeyboard_obj::onKeyUp( ::openfl::_legacy::events::KeyboardEvent event){
            	HX_STACK_FRAME("flixel.input.keyboard.FlxKeyboard","onKeyUp",0xa36f8255,"flixel.input.keyboard.FlxKeyboard.onKeyUp","flixel/input/keyboard/FlxKeyboard.hx",94,0x41882875)
            	HX_STACK_THIS(this)
...
::Array< ::Dynamic> FlxKeyboard_obj::record(){
            	HX_STACK_FRAME("flixel.input.keyboard.FlxKeyboard","record",0x38ad8db7,"flixel.input.keyboard.FlxKeyboard.record","flixel/input/keyboard/FlxKeyboard.hx",137,0x41882875)
            	HX_STACK_THIS(this)
...
HXDLIN( 142)				Bool _hx_tmp1 = hx::IsNotNull( key );
...
HXLINE( 147)				Bool _hx_tmp2 = hx::IsNull( data );
HXDLIN( 147)				if (_hx_tmp2) {
HXLINE( 149)					data = ::Array_obj< ::Dynamic>::__new();
            				}
HXLINE( 152)				data->push( ::flixel::_hx_system::replay::CodeValuePair_obj::__new(key->ID,key->current));
            			}
            		}
...
HXLINE( 169)		HX_VAR(  ::flixel::_hx_system::replay::CodeValuePair,o);
HXLINE( 170)		HX_VAR(  ::flixel::input::FlxInput,o2);
HXLINE( 172)		while((i < l)){
HXLINE( 174)			Int _hx_tmp = i++;
HXDLIN( 174)			o = Record->__get(_hx_tmp).StaticCast<  ::flixel::_hx_system::replay::CodeValuePair >();
HXLINE( 175)			Int KeyCode = o->code;
HXDLIN( 175)			o2 = this->_keyListMap->get(KeyCode).StaticCast<  ::flixel::input::FlxInput >();
HXLINE( 176)			o2->current = o->value;
            		}
            	}
