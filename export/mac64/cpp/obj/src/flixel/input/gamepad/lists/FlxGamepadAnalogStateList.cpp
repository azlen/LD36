...
HXDLIN(  17)		Bool _hx_tmp = hx::IsNull( stick );
...
HXDLIN(  18)		Bool _hx_tmp = hx::IsNull( stick );
...
HXDLIN(  20)		Bool _hx_tmp = hx::IsNull( stick );
...
HXDLIN(  21)		Bool _hx_tmp = hx::IsNull( stick );
...
HXLINE(  35)		Bool _hx_tmp = hx::IsNull( stick );
...
HXDLIN(  45)		HX_VARI( Bool,xVal) = this->gamepad->checkStatusRaw(RawID,Status);
...
HXDLIN(  46)		HX_VARI( Bool,yVal) = this->gamepad->checkStatusRaw(RawID1,Status1);
HXLINE(  48)		Bool _hx_tmp1;
HXDLIN(  48)		if (xVal) {
HXLINE(  48)			_hx_tmp1 = yVal;
            		}
            		else {
...
HXDLIN(  55)			HX_VARI( Bool,yReleased) = this->gamepad->checkStatusRaw(RawID2,(int)0);
HXLINE(  56)			HX_VARI_NAME( Int,RawID3,"RawID") = stick->y;
HXDLIN(  56)			RawID3 = this->gamepad->mapping->axisIndexToRawID(RawID3);
HXDLIN(  56)			HX_VARI( Bool,yJustReleased) = this->gamepad->checkStatusRaw(RawID3,(int)-1);
HXLINE(  57)			Bool _hx_tmp2;
HXDLIN(  57)			if (!(yReleased)) {
HXLINE(  57)				_hx_tmp2 = yJustReleased;
            			}
            			else {
...
HXDLIN(  65)			HX_VARI( Bool,xReleased) = this->gamepad->checkStatusRaw(RawID4,(int)0);
HXLINE(  66)			HX_VARI_NAME( Int,RawID5,"RawID") = stick->x;
HXDLIN(  66)			RawID5 = this->gamepad->mapping->axisIndexToRawID(RawID5);
HXDLIN(  66)			HX_VARI( Bool,xJustReleased) = this->gamepad->checkStatusRaw(RawID5,(int)-1);
HXLINE(  67)			Bool _hx_tmp3;
HXDLIN(  67)			if (!(xReleased)) {
HXLINE(  67)				_hx_tmp3 = xJustReleased;
            			}
            			else {
...
Bool FlxGamepadAnalogStateList_obj::checkX(Int id){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadAnalogStateList","checkX",0x15ea7dca,"flixel.input.gamepad.lists.FlxGamepadAnalogStateList.checkX","flixel/input/gamepad/lists/FlxGamepadAnalogStateList.hx",77,0xa4c0584e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  78)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,stick) = this->gamepad->mapping->getAnalogStick(id);
HXLINE(  79)		Bool _hx_tmp = hx::IsNull( stick );
...
Bool FlxGamepadAnalogStateList_obj::checkY(Int id){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadAnalogStateList","checkY",0x15ea7dcb,"flixel.input.gamepad.lists.FlxGamepadAnalogStateList.checkY","flixel/input/gamepad/lists/FlxGamepadAnalogStateList.hx",85,0xa4c0584e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  86)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,stick) = this->gamepad->mapping->getAnalogStick(id);
HXLINE(  87)		Bool _hx_tmp = hx::IsNull( stick );
...
Bool FlxGamepadAnalogStateList_obj::checkRaw(Int RawID,Int Status){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadAnalogStateList","checkRaw",0x43d8cbba,"flixel.input.gamepad.lists.FlxGamepadAnalogStateList.checkRaw","flixel/input/gamepad/lists/FlxGamepadAnalogStateList.hx",93,0xa4c0584e)
            	HX_STACK_THIS(this)
