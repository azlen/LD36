...
{
{
            	HX_STACK_FRAME("Manufacturer_obj","boot",0x8a661ed7,"Manufacturer_obj.boot","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",108,0x5edd1803)
HXLINE( 108)		__mClass->__meta__ =  ::Dynamic(hx::Anon_obj::Create(1)
