...
HXLINE(  39)		this->x = x;
HXLINE(  40)		this->y = y;
HXLINE(  42)		Bool _hx_tmp = hx::IsNull( settings );
HXDLIN(  42)		if (_hx_tmp) {
HXLINE(  43)			return;
            		}
HXLINE(  45)		::hx::EnumBase _hx_tmp1;
HXDLIN(  45)		Bool _hx_tmp2 = hx::IsNotNull( settings->__Field(HX_("mode",63,d3,60,48),hx::paccDynamic) );
HXDLIN(  45)		if (_hx_tmp2) {
HXLINE(  45)			_hx_tmp1 = settings->__Field(HX_("mode",63,d3,60,48),hx::paccDynamic);
            		}
            		else {
HXLINE(  45)			_hx_tmp1 = ::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn();
            		}
HXDLIN(  45)		this->mode = _hx_tmp1;
HXLINE(  46)		Int _hx_tmp3;
HXDLIN(  46)		Bool _hx_tmp4 = hx::IsNotNull( settings->__Field(HX_("up",5b,66,00,00),hx::paccDynamic) );
HXDLIN(  46)		if (_hx_tmp4) {
HXLINE(  46)			_hx_tmp3 = settings->__Field(HX_("up",5b,66,00,00),hx::paccDynamic);
            		}
            		else {
HXLINE(  46)			_hx_tmp3 = (int)-1;
            		}
HXDLIN(  46)		this->rawUp = _hx_tmp3;
HXLINE(  47)		Int _hx_tmp5;
HXDLIN(  47)		Bool _hx_tmp6 = hx::IsNotNull( settings->__Field(HX_("down",62,f8,6d,42),hx::paccDynamic) );
HXDLIN(  47)		if (_hx_tmp6) {
HXLINE(  47)			_hx_tmp5 = settings->__Field(HX_("down",62,f8,6d,42),hx::paccDynamic);
            		}
            		else {
HXLINE(  47)			_hx_tmp5 = (int)-1;
            		}
HXDLIN(  47)		this->rawDown = _hx_tmp5;
HXLINE(  48)		Int _hx_tmp7;
HXDLIN(  48)		Bool _hx_tmp8 = hx::IsNotNull( settings->__Field(HX_("left",07,08,b0,47),hx::paccDynamic) );
HXDLIN(  48)		if (_hx_tmp8) {
HXLINE(  48)			_hx_tmp7 = settings->__Field(HX_("left",07,08,b0,47),hx::paccDynamic);
            		}
            		else {
HXLINE(  48)			_hx_tmp7 = (int)-1;
            		}
HXDLIN(  48)		this->rawLeft = _hx_tmp7;
HXLINE(  49)		Int _hx_tmp9;
HXDLIN(  49)		Bool _hx_tmp10 = hx::IsNotNull( settings->__Field(HX_("right",dc,0b,64,e9),hx::paccDynamic) );
HXDLIN(  49)		if (_hx_tmp10) {
HXLINE(  49)			_hx_tmp9 = settings->__Field(HX_("right",dc,0b,64,e9),hx::paccDynamic);
            		}
            		else {
HXLINE(  49)			_hx_tmp9 = (int)-1;
            		}
HXDLIN(  49)		this->rawRight = _hx_tmp9;
HXLINE(  50)		Float _hx_tmp11;
HXDLIN(  50)		Bool _hx_tmp12 = hx::IsNotNull( settings->__Field(HX_("threshold",ab,c3,a3,34),hx::paccDynamic) );
HXDLIN(  50)		if (_hx_tmp12) {
HXLINE(  50)			_hx_tmp11 = settings->__Field(HX_("threshold",ab,c3,a3,34),hx::paccDynamic);
            		}
            		else {
HXLINE(  50)			_hx_tmp11 = ((Float)0.5);
            		}
HXDLIN(  50)		this->digitalThreshold = _hx_tmp11;
            	}
...
hx::ObjectPtr< FlxGamepadAnalogStick_obj > FlxGamepadAnalogStick_obj::__new(Int x,Int y, ::Dynamic settings)
{
	...
	_hx_result->__construct(x,y,settings);
	return _hx_result;
}
...
::String FlxGamepadAnalogStick_obj::toString(){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadAnalogStick","toString",0x35569e4c,"flixel.input.gamepad.FlxGamepadAnalogStick.toString","flixel/input/gamepad/FlxGamepadAnalogStick.hx",55,0xc7b72a73)
            	HX_STACK_THIS(this)
...
HXLINE(  63)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this7,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  63)		_this7->label = HX_("mode",63,d3,60,48);
HXDLIN(  63)		_this7->value = this->mode;
