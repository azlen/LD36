...
Bool FlxBaseGamepadList_obj::check(Int id){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxBaseGamepadList","check",0x83c2af52,"flixel.input.gamepad.lists.FlxBaseGamepadList.check","flixel/input/gamepad/lists/FlxBaseGamepadList.hx",20,0x249eb6c2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  20)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,_this) = this->gamepad;
HXDLIN(  20)		Int Status = this->status;
HXDLIN(  20)		Int _hx_tmp = _this->mapping->getRawID(id);
...
Bool FlxBaseGamepadList_obj::checkRaw(Int id){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxBaseGamepadList","checkRaw",0xa446bdb6,"flixel.input.gamepad.lists.FlxBaseGamepadList.checkRaw","flixel/input/gamepad/lists/FlxBaseGamepadList.hx",25,0x249eb6c2)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  25)		return this->gamepad->checkStatusRaw(id,this->status);
            	}
...
HXDLIN(  32)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->gamepad->buttons;
HXDLIN(  32)			while((_g < _g1->length)){
HXLINE(  32)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN(  32)				++_g;
HXLINE(  34)				Bool _hx_tmp;
HXDLIN(  34)				Bool _hx_tmp1 = hx::IsNotNull( button );
HXDLIN(  34)				if (_hx_tmp1) {
HXLINE(  34)					Int id = ( (Int)(button->ID) );
HXDLIN(  34)					_hx_tmp = this->gamepad->checkStatusRaw(id,this->status);
            				}
            				else {
