...
{
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",124,0x9958eee3)
HXLINE( 124)		A = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",125,0x9958eee3)
HXLINE( 125)		B = (int)1;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",126,0x9958eee3)
HXLINE( 126)		X = (int)2;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",127,0x9958eee3)
HXLINE( 127)		Y = (int)3;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",129,0x9958eee3)
HXLINE( 129)		LB = (int)4;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",130,0x9958eee3)
HXLINE( 130)		RB = (int)5;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",132,0x9958eee3)
HXLINE( 132)		LEFT_STICK_CLICK = (int)6;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",133,0x9958eee3)
HXLINE( 133)		RIGHT_STICK_CLICK = (int)7;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",135,0x9958eee3)
HXLINE( 135)		BACK = (int)9;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",136,0x9958eee3)
HXLINE( 136)		START = (int)8;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",138,0x9958eee3)
HXLINE( 138)		GUIDE = (int)10;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",140,0x9958eee3)
HXLINE( 140)		DPAD_UP = (int)11;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",141,0x9958eee3)
HXLINE( 141)		DPAD_DOWN = (int)12;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",142,0x9958eee3)
HXLINE( 142)		DPAD_LEFT = (int)13;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",143,0x9958eee3)
HXLINE( 143)		DPAD_RIGHT = (int)14;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",145,0x9958eee3)
HXLINE( 145)		LEFT_TRIGGER = (int)2;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",146,0x9958eee3)
HXLINE( 146)		RIGHT_TRIGGER = (int)5;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",148,0x9958eee3)
HXLINE( 148)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",149,0x9958eee3)
HXLINE( 149)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)3,(int)4, ::Dynamic(hx::Anon_obj::Create(4)
