...
HXDLIN(  14)		 ::flixel::input::gamepad::FlxGamepadAnalogStick _hx_tmp = _this->mapping->getAnalogStick((int)19);
HXDLIN(  14)		return _this->getAnalogXAxisValue(_hx_tmp);
            	}
...
HXDLIN(  15)		 ::flixel::input::gamepad::FlxGamepadAnalogStick _hx_tmp = _this->mapping->getAnalogStick((int)19);
HXDLIN(  15)		return _this->getYAxisRaw(_hx_tmp);
            	}
...
HXDLIN(  16)		 ::flixel::input::gamepad::FlxGamepadAnalogStick _hx_tmp = _this->mapping->getAnalogStick((int)20);
HXDLIN(  16)		return _this->getAnalogXAxisValue(_hx_tmp);
            	}
...
HXDLIN(  17)		 ::flixel::input::gamepad::FlxGamepadAnalogStick _hx_tmp = _this->mapping->getAnalogStick((int)20);
HXDLIN(  17)		return _this->getYAxisRaw(_hx_tmp);
            	}
...
Float FlxGamepadAnalogValueList_obj::get_LEFT_TRIGGER(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  18)		return this->gamepad->getAxis((int)17);
            	}
...
Float FlxGamepadAnalogValueList_obj::get_RIGHT_TRIGGER(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  19)		return this->gamepad->getAxis((int)18);
            	}
...
Float FlxGamepadAnalogValueList_obj::get_POINTER_X(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  21)		return this->gamepad->getAxis((int)28);
            	}
...
Float FlxGamepadAnalogValueList_obj::get_POINTER_Y(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  22)		return this->gamepad->getAxis((int)29);
            	}
...
Float FlxGamepadAnalogValueList_obj::getAxis(Int id){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadAnalogValueList","getAxis",0x00e0513d,"flixel.input.gamepad.lists.FlxGamepadAnalogValueList.getAxis","flixel/input/gamepad/lists/FlxGamepadAnalogValueList.hx",31,0xefa13aee)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  31)		return this->gamepad->getAxis(id);
            	}
...
Float FlxGamepadAnalogValueList_obj::getXAxis(Int id){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadAnalogValueList","getXAxis",0xdd4eb91d,"flixel.input.gamepad.lists.FlxGamepadAnalogValueList.getXAxis","flixel/input/gamepad/lists/FlxGamepadAnalogValueList.hx",36,0xefa13aee)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  36)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,_this) = this->gamepad;
HXDLIN(  36)		 ::flixel::input::gamepad::FlxGamepadAnalogStick _hx_tmp = _this->mapping->getAnalogStick(id);
HXDLIN(  36)		return _this->getAnalogXAxisValue(_hx_tmp);
            	}
...
Float FlxGamepadAnalogValueList_obj::getYAxis(Int id){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadAnalogValueList","getYAxis",0x70b54d9e,"flixel.input.gamepad.lists.FlxGamepadAnalogValueList.getYAxis","flixel/input/gamepad/lists/FlxGamepadAnalogValueList.hx",41,0xefa13aee)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  41)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,_this) = this->gamepad;
HXDLIN(  41)		 ::flixel::input::gamepad::FlxGamepadAnalogStick _hx_tmp = _this->mapping->getAnalogStick(id);
HXDLIN(  41)		return _this->getYAxisRaw(_hx_tmp);
            	}
