...
HXLINE(  31)		this->gamepad = gamepad;
            	}
...
Float FlxGamepadMotionValueList_obj::get_TILT_PITCH(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  23)		Bool _hx_tmp = !(this->gamepad->mapping->supportsMotion);
HXDLIN(  23)		if (_hx_tmp) {
HXLINE(  23)			return (int)0;
            		}
            		else {
HXLINE(  23)			return this->gamepad->getAxis((int)26);
            		}
...
Float FlxGamepadMotionValueList_obj::get_TILT_ROLL(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  27)		Bool _hx_tmp = !(this->gamepad->mapping->supportsMotion);
HXDLIN(  27)		if (_hx_tmp) {
HXLINE(  27)			return (int)0;
            		}
            		else {
HXLINE(  27)			return this->gamepad->getAxis((int)27);
            		}
...
Bool FlxGamepadMotionValueList_obj::get_isSupported(){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadMotionValueList","get_isSupported",0x6991c29b,"flixel.input.gamepad.lists.FlxGamepadMotionValueList.get_isSupported","flixel/input/gamepad/lists/FlxGamepadMotionValueList.hx",43,0x4127dbf4)
            	HX_STACK_THIS(this)
HXLINE(  43)		return this->gamepad->mapping->supportsMotion;
            	}
