...
{
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",13,0xfbedfad2)
HXLINE(  13)		X = (int)6;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",14,0xfbedfad2)
HXLINE(  14)		CIRCLE = (int)7;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",15,0xfbedfad2)
HXLINE(  15)		SQUARE = (int)8;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",16,0xfbedfad2)
HXLINE(  16)		TRIANGLE = (int)9;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",17,0xfbedfad2)
HXLINE(  17)		SELECT = (int)10;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",18,0xfbedfad2)
HXLINE(  18)		START = (int)12;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",19,0xfbedfad2)
HXLINE(  19)		L = (int)15;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",20,0xfbedfad2)
HXLINE(  20)		R = (int)16;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",22,0xfbedfad2)
HXLINE(  22)		DPAD_UP = (int)17;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",23,0xfbedfad2)
HXLINE(  23)		DPAD_DOWN = (int)18;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",24,0xfbedfad2)
HXLINE(  24)		DPAD_LEFT = (int)19;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",25,0xfbedfad2)
HXLINE(  25)		DPAD_RIGHT = (int)20;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",27,0xfbedfad2)
HXLINE(  27)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.PSVitaID","boot",0x589ec652,"flixel.input.gamepad.id.PSVitaID.boot","flixel/input/gamepad/id/PSVitaID.hx",28,0xfbedfad2)
HXLINE(  28)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("right",dc,0b,64,e9),(int)24)
            			->setFixed(1,HX_("up",5b,66,00,00),(int)21)
            			->setFixed(2,HX_("down",62,f8,6d,42),(int)22)
            			->setFixed(3,HX_("left",07,08,b0,47),(int)23)));
