...
{
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",33,0xeed1fefa)
HXLINE(  33)		ONE = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",34,0xeed1fefa)
HXLINE(  34)		TWO = (int)1;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",35,0xeed1fefa)
HXLINE(  35)		THREE = (int)2;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",36,0xeed1fefa)
HXLINE(  36)		FOUR = (int)3;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",37,0xeed1fefa)
HXLINE(  37)		FIVE = (int)4;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",38,0xeed1fefa)
HXLINE(  38)		SIX = (int)5;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",39,0xeed1fefa)
HXLINE(  39)		SEVEN = (int)6;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",40,0xeed1fefa)
HXLINE(  40)		EIGHT = (int)7;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",41,0xeed1fefa)
HXLINE(  41)		NINE = (int)8;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",42,0xeed1fefa)
HXLINE(  42)		TEN = (int)9;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",43,0xeed1fefa)
HXLINE(  43)		LEFT_STICK_CLICK = (int)10;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",44,0xeed1fefa)
HXLINE(  44)		RIGHT_STICK_CLICK = (int)11;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",47,0xeed1fefa)
HXLINE(  47)		DPAD_UP = (int)16;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",48,0xeed1fefa)
HXLINE(  48)		DPAD_DOWN = (int)17;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",49,0xeed1fefa)
HXLINE(  49)		DPAD_LEFT = (int)18;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",50,0xeed1fefa)
HXLINE(  50)		DPAD_RIGHT = (int)19;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",53,0xeed1fefa)
HXLINE(  53)		LOGITECH = (int)-5;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",57,0xeed1fefa)
HXLINE(  57)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.LogitechID","boot",0xd297d7fa,"flixel.input.gamepad.id.LogitechID.boot","flixel/input/gamepad/id/LogitechID.hx",58,0xeed1fefa)
HXLINE(  58)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
