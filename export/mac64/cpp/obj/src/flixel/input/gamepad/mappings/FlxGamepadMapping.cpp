...
void FlxGamepadMapping_obj::__construct(::hx::EnumBase attachment){
            	HX_STACK_FRAME("flixel.input.gamepad.mappings.FlxGamepadMapping","new",0xf72cefab,"flixel.input.gamepad.mappings.FlxGamepadMapping.new","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",11,0x5edd1803)
            	HX_STACK_THIS(this)
...
HXLINE(  26)		Bool _hx_tmp = hx::IsNotNull( attachment );
...
hx::ObjectPtr< FlxGamepadMapping_obj > FlxGamepadMapping_obj::__new(::hx::EnumBase attachment)
{
...
void FlxGamepadMapping_obj::initValues(){
            	HX_STACK_FRAME("flixel.input.gamepad.mappings.FlxGamepadMapping","initValues",0xb7dc8f27,"flixel.input.gamepad.mappings.FlxGamepadMapping.initValues","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",41,0x5edd1803)
            	HX_STACK_THIS(this)
            	}
...
Int FlxGamepadMapping_obj::getID(Int rawID){
            	HX_STACK_FRAME("flixel.input.gamepad.mappings.FlxGamepadMapping","getID",0xc83859fc,"flixel.input.gamepad.mappings.FlxGamepadMapping.getID","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",61,0x5edd1803)
            	HX_STACK_THIS(this)
...
Int FlxGamepadMapping_obj::getRawID(Int ID){
            	HX_STACK_FRAME("flixel.input.gamepad.mappings.FlxGamepadMapping","getRawID",0xe7780022,"flixel.input.gamepad.mappings.FlxGamepadMapping.getRawID","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",69,0x5edd1803)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ID,"ID")
...
Bool FlxGamepadMapping_obj::isAxisForMotion(Int ID){
            	HX_STACK_FRAME("flixel.input.gamepad.mappings.FlxGamepadMapping","isAxisForMotion",0x69ad82bf,"flixel.input.gamepad.mappings.FlxGamepadMapping.isAxisForMotion","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",74,0x5edd1803)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ID,"ID")
...
Bool FlxGamepadMapping_obj::isAxisFlipped(Int axisID){
            	HX_STACK_FRAME("flixel.input.gamepad.mappings.FlxGamepadMapping","isAxisFlipped",0x941958e2,"flixel.input.gamepad.mappings.FlxGamepadMapping.isAxisFlipped","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",82,0x5edd1803)
            	HX_STACK_THIS(this)
...
Int FlxGamepadMapping_obj::axisIndexToRawID(Int axisID){
            	HX_STACK_FRAME("flixel.input.gamepad.mappings.FlxGamepadMapping","axisIndexToRawID",0x3c47e36c,"flixel.input.gamepad.mappings.FlxGamepadMapping.axisIndexToRawID","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",92,0x5edd1803)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(axisID,"axisID")
...
Int FlxGamepadMapping_obj::checkForFakeAxis(Int ID){
            	HX_STACK_FRAME("flixel.input.gamepad.mappings.FlxGamepadMapping","checkForFakeAxis",0xd918b8ec,"flixel.input.gamepad.mappings.FlxGamepadMapping.checkForFakeAxis","flixel/input/gamepad/mappings/FlxGamepadMapping.hx",97,0x5edd1803)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ID,"ID")
...
::hx::EnumBase FlxGamepadMapping_obj::set_attachment(::hx::EnumBase attachment){
...
hx::Val FlxGamepadMapping_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"manufacturer") ) { manufacturer=inValue.Cast< ::hx::EnumBase >(); return inValue; }
		break;
	case 14:
