...
void FlxGamepadAnalogList_obj::__construct( ::flixel::input::gamepad::FlxGamepad gamepad){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadAnalogList","new",0x93642d0b,"flixel.input.gamepad.lists.FlxGamepadAnalogList.new","flixel/input/gamepad/lists/FlxGamepadAnalogList.hx",17,0x4e142041)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(gamepad,"gamepad")
HXLINE(  18)		this->value =  ::flixel::input::gamepad::lists::FlxGamepadAnalogValueList_obj::__new(gamepad);
HXLINE(  19)		this->justMoved =  ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList_obj::__new((int)2,gamepad);
HXLINE(  20)		this->justReleased =  ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList_obj::__new((int)-1,gamepad);
            	}
