...
void FlxInput_obj::__construct( ::Dynamic ID){
            	HX_STACK_FRAME("flixel.input.FlxInput","new",0x726ed100,"flixel.input.FlxInput.new","flixel/input/FlxInput.hx",3,0xe8bdaaee)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ID,"ID")
...
void FlxInput_obj::press(){
            	HX_STACK_FRAME("flixel.input.FlxInput","press",0x37dcbc23,"flixel.input.FlxInput.press","flixel/input/FlxInput.hx",21,0xe8bdaaee)
            	HX_STACK_THIS(this)
...
void FlxInput_obj::release(){
            	HX_STACK_FRAME("flixel.input.FlxInput","release",0x94a55667,"flixel.input.FlxInput.release","flixel/input/FlxInput.hx",27,0xe8bdaaee)
            	HX_STACK_THIS(this)
...
void FlxInput_obj::update(){
            	HX_STACK_FRAME("flixel.input.FlxInput","update",0x818ca969,"flixel.input.FlxInput.update","flixel/input/FlxInput.hx",33,0xe8bdaaee)
            	HX_STACK_THIS(this)
...
void FlxInput_obj::reset(){
            	HX_STACK_FRAME("flixel.input.FlxInput","reset",0x561cb26f,"flixel.input.FlxInput.reset","flixel/input/FlxInput.hx",47,0xe8bdaaee)
            	HX_STACK_THIS(this)
...
Bool FlxInput_obj::hasState(Int state){
            	HX_STACK_FRAME("flixel.input.FlxInput","hasState",0x15827bb7,"flixel.input.FlxInput.hasState","flixel/input/FlxInput.hx",54,0xe8bdaaee)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(state,"state")
HXLINE(  54)		switch((int)(state)){
            			case (int)-1: {
HXLINE(  54)				return (this->current == (int)-1);
            			}
            			break;
            			case (int)0: {
...
HXLINE(  54)					return (this->current == (int)2);
            				}
            				else {
HXLINE(  54)					return true;
            				}
...
Bool FlxInput_obj::get_justReleased(){
            	HX_STACK_FRAME("flixel.input.FlxInput","get_justReleased",0x305322f2,"flixel.input.FlxInput.get_justReleased","flixel/input/FlxInput.hx",65,0xe8bdaaee)
            	HX_STACK_THIS(this)
HXLINE(  65)		return (this->current == (int)-1);
            	}
...
Bool FlxInput_obj::get_released(){
            	HX_STACK_FRAME("flixel.input.FlxInput","get_released",0x4d112826,"flixel.input.FlxInput.get_released","flixel/input/FlxInput.hx",70,0xe8bdaaee)
            	HX_STACK_THIS(this)
HXLINE(  70)		if ((this->current != (int)0)) {
HXLINE(  70)			return (this->current == (int)-1);
            		}
            		else {
...
Bool FlxInput_obj::get_pressed(){
            	HX_STACK_FRAME("flixel.input.FlxInput","get_pressed",0x1bddd359,"flixel.input.FlxInput.get_pressed","flixel/input/FlxInput.hx",75,0xe8bdaaee)
            	HX_STACK_THIS(this)
HXLINE(  75)		if ((this->current != (int)1)) {
HXLINE(  75)			return (this->current == (int)2);
            		}
            		else {
...
Bool FlxInput_obj::get_justPressed(){
            	HX_STACK_FRAME("flixel.input.FlxInput","get_justPressed",0xfa72360d,"flixel.input.FlxInput.get_justPressed","flixel/input/FlxInput.hx",80,0xe8bdaaee)
            	HX_STACK_THIS(this)
HXLINE(  80)		return (this->current == (int)2);
            	}
