...
hx::ObjectPtr< FlxSwipe_obj > FlxSwipe_obj::__new(Int ID, ::flixel::math::FlxPoint StartPosition, ::flixel::math::FlxPoint EndPosition,Float StartTimeInTicks)
{
	...
	_hx_result->__construct(ID,StartPosition,EndPosition,StartTimeInTicks);
	return _hx_result;
}
...
::String FlxSwipe_obj::toString(){
            	HX_STACK_FRAME("flixel.input.FlxSwipe","toString",0xb726199c,"flixel.input.FlxSwipe.toString","flixel/input/FlxSwipe.hx",39,0xe38cac7e)
            	HX_STACK_THIS(this)
...
HXLINE(  41)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  41)		_this1->label = HX_("start",62,74,0b,84);
HXDLIN(  41)		_this1->value = this->startPosition;
HXLINE(  42)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  42)		_this2->label = HX_("end",db,03,4d,00);
HXDLIN(  42)		_this2->value = this->endPosition;
...
HXDLIN(  43)		 ::Dynamic value1 = ::Math_obj::sqrt(((dx * dx) + (dy * dy)));
...
HXDLIN(  43)		_this3->value = value1;
HXLINE(  44)		 ::Dynamic value2 = this->startPosition->angleBetween(this->endPosition);
...
HXDLIN(  44)		_this4->value = value2;
HXLINE(  45)		 ::Dynamic value3 = ((Float)(this->_endTimeInTicks - this->_startTimeInTicks) / (Float)(int)1000);
...
Float FlxSwipe_obj::get_distance(){
            	HX_STACK_FRAME("flixel.input.FlxSwipe","get_distance",0xd139c82e,"flixel.input.FlxSwipe.get_distance","flixel/input/FlxSwipe.hx",50,0xe38cac7e)
            	HX_STACK_THIS(this)
...
Float FlxSwipe_obj::get_angle(){
            	HX_STACK_FRAME("flixel.input.FlxSwipe","get_angle",0xc834293a,"flixel.input.FlxSwipe.get_angle","flixel/input/FlxSwipe.hx",55,0xe38cac7e)
            	HX_STACK_THIS(this)
...
Float FlxSwipe_obj::get_duration(){
            	HX_STACK_FRAME("flixel.input.FlxSwipe","get_duration",0x79ce444d,"flixel.input.FlxSwipe.get_duration","flixel/input/FlxSwipe.hx",60,0xe38cac7e)
            	HX_STACK_THIS(this)
