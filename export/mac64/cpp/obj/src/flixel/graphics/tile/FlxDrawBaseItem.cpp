...
Int FlxDrawBaseItem_obj::blendToInt(::hx::EnumBase blend){
...
HXLINE(  18)		Bool _hx_tmp = hx::IsNull( blend );
HXDLIN(  18)		if (_hx_tmp) {
HXLINE(  19)			return (int)0;
            		}
HXLINE(  21)		Int _hx_tmp1 = ( ( ::hx::EnumBase)(blend) )->_hx_getIndex();
HXDLIN(  21)		switch((int)(_hx_tmp1)){
            			case (int)2: {
