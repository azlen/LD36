...
void FlxDrawTilesItem_obj::__construct(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","new",0x1450ef83,"flixel.graphics.tile.FlxDrawTilesItem.new","flixel/graphics/tile/FlxDrawTilesItem.hx",12,0xdffe6dcc)
            	HX_STACK_THIS(this)
...
void FlxDrawTilesItem_obj::reset(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","reset",0xcba5b7b2,"flixel.graphics.tile.FlxDrawTilesItem.reset","flixel/graphics/tile/FlxDrawTilesItem.hx",26,0xdffe6dcc)
            	HX_STACK_THIS(this)
...
void FlxDrawTilesItem_obj::addQuad( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxMatrix matrix, ::openfl::_legacy::geom::ColorTransform transform){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","addQuad",0x70c6682b,"flixel.graphics.tile.FlxDrawTilesItem.addQuad","flixel/graphics/tile/FlxDrawTilesItem.hx",40,0xdffe6dcc)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(frame,"frame")
            	HX_STACK_ARG(matrix,"matrix")
            	HX_STACK_ARG(transform,"transform")
HXLINE(  41)		{
HXLINE(  41)			Float f = matrix->tx;
HXDLIN(  41)			this->drawData[this->position++] = f;
            		}
HXLINE(  42)		{
HXLINE(  42)			Float f1 = matrix->ty;
HXDLIN(  42)			this->drawData[this->position++] = f1;
            		}
HXLINE(  44)		HX_VARI(  ::flixel::math::FlxRect,rect) = frame->frame;
HXLINE(  46)		{
HXLINE(  46)			Float f2 = rect->x;
HXDLIN(  46)			this->drawData[this->position++] = f2;
            		}
HXLINE(  47)		{
HXLINE(  47)			Float f3 = rect->y;
HXDLIN(  47)			this->drawData[this->position++] = f3;
            		}
HXLINE(  48)		{
HXLINE(  48)			Float f4 = rect->width;
HXDLIN(  48)			this->drawData[this->position++] = f4;
            		}
HXLINE(  49)		{
HXLINE(  49)			Float f5 = rect->height;
HXDLIN(  49)			this->drawData[this->position++] = f5;
            		}
HXLINE(  51)		{
HXLINE(  51)			Float f6 = matrix->a;
HXDLIN(  51)			this->drawData[this->position++] = f6;
            		}
HXLINE(  52)		{
HXLINE(  52)			Float f7 = matrix->b;
HXDLIN(  52)			this->drawData[this->position++] = f7;
            		}
HXLINE(  53)		{
HXLINE(  53)			Float f8 = matrix->c;
HXDLIN(  53)			this->drawData[this->position++] = f8;
            		}
HXLINE(  54)		{
HXLINE(  54)			Float f9 = matrix->d;
HXDLIN(  54)			this->drawData[this->position++] = f9;
            		}
...
HXLINE(  58)			{
HXLINE(  58)				Float f10 = transform->redMultiplier;
HXDLIN(  58)				this->drawData[this->position++] = f10;
            			}
HXLINE(  59)			{
HXLINE(  59)				Float f11 = transform->greenMultiplier;
HXDLIN(  59)				this->drawData[this->position++] = f11;
            			}
HXLINE(  60)			{
HXLINE(  60)				Float f12 = transform->blueMultiplier;
HXDLIN(  60)				this->drawData[this->position++] = f12;
            			}
            		}
HXLINE(  63)		{
HXLINE(  63)			Float f13;
HXDLIN(  63)			Bool _hx_tmp1 = hx::IsNotNull( transform );
HXDLIN(  63)			if (_hx_tmp1) {
HXLINE(  63)				f13 = transform->alphaMultiplier;
            			}
            			else {
HXLINE(  63)				f13 = ((Float)1.0);
            			}
HXDLIN(  63)			this->drawData[this->position++] = f13;
            		}
            	}


void FlxDrawTilesItem_obj::setNext(Float f){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","setNext",0xf805b258,"flixel.graphics.tile.FlxDrawTilesItem.setNext","flixel/graphics/tile/FlxDrawTilesItem.hx",78,0xdffe6dcc)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
...
void FlxDrawTilesItem_obj::render( ::flixel::FlxCamera camera){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","render",0x620c2413,"flixel.graphics.tile.FlxDrawTilesItem.render","flixel/graphics/tile/FlxDrawTilesItem.hx",82,0xdffe6dcc)
            	HX_STACK_THIS(this)
...
HXLINE(  96)		hx::OrEq(flags,this->blending);
HXLINE(  98)		 ::openfl::_legacy::display::Graphics _hx_tmp1 = camera->canvas->get_graphics();
HXDLIN(  98)		 ::openfl::_legacy::display::Tilesheet _hx_tmp2 = this->graphics->get_tilesheet();
HXLINE(  99)		Bool _hx_tmp3;
HXDLIN(  99)		if (!(camera->antialiasing)) {
HXLINE(  99)			_hx_tmp3 = this->antialiasing;
            		}
            		else {
HXLINE(  99)			_hx_tmp3 = true;
            		}
HXLINE(  98)		_hx_tmp1->drawTiles(_hx_tmp2,this->drawData,_hx_tmp3,flags,this->position);
HXLINE( 103)		::flixel::graphics::tile::FlxTilesheet_obj::_DRAWCALLS++;
            	}


Int FlxDrawTilesItem_obj::get_numTiles(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numTiles",0xd57429e5,"flixel.graphics.tile.FlxDrawTilesItem.get_numTiles","flixel/graphics/tile/FlxDrawTilesItem.hx",107,0xdffe6dcc)
            	HX_STACK_THIS(this)
HXLINE( 108)		HX_VARI( Int,elementsPerTile) = (int)8;
HXLINE( 109)		if (this->colored) {
HXLINE( 110)			elementsPerTile = (int)11;
            		}
HXLINE( 116)		Float _hx_tmp = ((Float)this->position / (Float)elementsPerTile);
HXDLIN( 116)		return ::Std_obj::_hx_int(_hx_tmp);
            	}
...
Int FlxDrawTilesItem_obj::get_numVertices(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numVertices",0x8b0e8f99,"flixel.graphics.tile.FlxDrawTilesItem.get_numVertices","flixel/graphics/tile/FlxDrawTilesItem.hx",121,0xdffe6dcc)
            	HX_STACK_THIS(this)
HXLINE( 121)		Int _hx_tmp = this->get_numTiles();
HXDLIN( 121)		return ((int)4 * _hx_tmp);
            	}


Int FlxDrawTilesItem_obj::get_numTriangles(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTilesItem","get_numTriangles",0x37fe0d0b,"flixel.graphics.tile.FlxDrawTilesItem.get_numTriangles","flixel/graphics/tile/FlxDrawTilesItem.hx",126,0xdffe6dcc)
            	HX_STACK_THIS(this)
HXLINE( 126)		Int _hx_tmp = this->get_numTiles();
HXDLIN( 126)		return ((int)2 * _hx_tmp);
            	}
