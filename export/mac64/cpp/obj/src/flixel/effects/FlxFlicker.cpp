...
HXLINE( 138)		 ::flixel::util::FlxTimer _hx_tmp =  ::flixel::util::FlxTimer_obj::__new();
HXDLIN( 138)		Float _hx_tmp1 = this->interval;
HXDLIN( 138)		Float _hx_tmp2 = ((Float)this->duration / (Float)this->interval);
HXDLIN( 138)		Int _hx_tmp3 = ::Std_obj::_hx_int(_hx_tmp2);
HXDLIN( 138)		this->timer = _hx_tmp->start(_hx_tmp1,this->flickerProgress_dyn(),_hx_tmp3);
            	}
...
HXLINE( 167)		Bool _hx_tmp = hx::IsNotNull( this->progressCallback );
...
HXLINE( 172)			_hx_tmp1 = ((Timer->loops - Timer->_loopsCounter) == (int)0);
            		}
            		else {
...
HXLINE( 175)			Bool _hx_tmp2 = hx::IsNotNull( this->completionCallback );
...
Bool ForceRestart = __o_ForceRestart.Default(true);
            	...
            	HX_STACK_ARG(CompletionCallback,"CompletionCallback")
            	HX_STACK_ARG(ProgressCallback,"ProgressCallback")
HXLINE(  36)		Bool _hx_tmp = ::flixel::effects::FlxFlicker_obj::isFlickering(Object);
...
HXLINE(  49)		Bool _hx_tmp1 = (Interval <= (int)0);
...
Bool FlxFlicker_obj::isFlickering( ::flixel::FlxObject Object){
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","isFlickering",0x76c8b45e,"flixel.effects.FlxFlicker.isFlickering","flixel/effects/FlxFlicker.hx",65,0x4fa53f38)
            	HX_STACK_ARG(Object,"Object")
...
HXLINE(  75)		Bool _hx_tmp = hx::IsNotNull( boundFlicker );
...
{
{
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","boot",0xfb72b91c,"flixel.effects.FlxFlicker.boot","flixel/effects/FlxFlicker.hx",15,0x4fa53f38)
HXLINE(  15)		_pool =  ::flixel::util::FlxPool_flixel_effects_FlxFlicker_obj::__new(hx::ClassOf< ::flixel::effects::FlxFlicker >());
            	}
{
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","boot",0xfb72b91c,"flixel.effects.FlxFlicker.boot","flixel/effects/FlxFlicker.hx",20,0x4fa53f38)
HXLINE(  20)		_boundObjects =  ::haxe::ds::ObjectMap_obj::__new();
            	}
}
