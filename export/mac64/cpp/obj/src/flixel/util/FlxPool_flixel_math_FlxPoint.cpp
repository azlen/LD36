...
void FlxPool_flixel_math_FlxPoint_obj::__construct(hx::Class classObj){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","new",0x4abdd86f,"flixel.util.FlxPool_flixel_math_FlxPoint.new","flixel/util/FlxPool.hx",12,0xdd4de86a)
            	HX_STACK_THIS(this)
...
void *FlxPool_flixel_math_FlxPoint_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::math::FlxPoint FlxPool_flixel_math_FlxPoint_obj::get(){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","get",0x4ab888a5,"flixel.util.FlxPool_flixel_math_FlxPoint.get","flixel/util/FlxPool.hx",31,0xdd4de86a)
            	HX_STACK_THIS(this)
...
void FlxPool_flixel_math_FlxPoint_obj::put( ::flixel::math::FlxPoint obj){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","put",0x4abf6ade,"flixel.util.FlxPool_flixel_math_FlxPoint.put","flixel/util/FlxPool.hx",42,0xdd4de86a)
            	HX_STACK_THIS(this)
...
void FlxPool_flixel_math_FlxPoint_obj::putUnsafe( ::flixel::math::FlxPoint obj){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","putUnsafe",0xf57edda4,"flixel.util.FlxPool_flixel_math_FlxPoint.putUnsafe","flixel/util/FlxPool.hx",56,0xdd4de86a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(obj,"obj")
...
void FlxPool_flixel_math_FlxPoint_obj::preAllocate(Int numObjects){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","preAllocate",0x522a790f,"flixel.util.FlxPool_flixel_math_FlxPoint.preAllocate","flixel/util/FlxPool.hx",65,0xdd4de86a)
            	HX_STACK_THIS(this)
...
HXDLIN(  67)			 ::flixel::math::FlxPoint _hx_tmp2 = ( ( ::flixel::math::FlxPoint)(::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0))) );
...
::Array< ::Dynamic> FlxPool_flixel_math_FlxPoint_obj::clear(){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","clear",0x8762db5c,"flixel.util.FlxPool_flixel_math_FlxPoint.clear","flixel/util/FlxPool.hx",72,0xdd4de86a)
            	HX_STACK_THIS(this)
...
Int FlxPool_flixel_math_FlxPoint_obj::get_length(){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","get_length",0xb3eaac80,"flixel.util.FlxPool_flixel_math_FlxPoint.get_length","flixel/util/FlxPool.hx",81,0xdd4de86a)
            	HX_STACK_THIS(this)
