...
void LabelValuePair_obj::__construct(){
            	HX_STACK_FRAME("flixel.util.LabelValuePair","new",0x8e753503,"flixel.util.LabelValuePair.new","flixel/util/FlxStringUtil.hx",630,0x4e012e33)
            	HX_STACK_THIS(this)
            	}
...
void *LabelValuePair_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::create(::String label, ::Dynamic value){
            	HX_STACK_FRAME("flixel.util.LabelValuePair","create",0x3da24a39,"flixel.util.LabelValuePair.create","flixel/util/FlxStringUtil.hx",612,0x4e012e33)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(label,"label")
            	HX_STACK_ARG(value,"value")
HXLINE( 613)		this->label = label;
HXLINE( 614)		this->value = value;
HXLINE( 615)		return hx::ObjectPtr<OBJ_>(this);
            	}
...
void LabelValuePair_obj::put(){
            	HX_STACK_FRAME("flixel.util.LabelValuePair","put",0x8e76c772,"flixel.util.LabelValuePair.put","flixel/util/FlxStringUtil.hx",620,0x4e012e33)
            	HX_STACK_THIS(this)
HXLINE( 620)		::flixel::util::LabelValuePair_obj::_pool->put(hx::ObjectPtr<OBJ_>(this));
            	}
...
void LabelValuePair_obj::destroy(){
            	HX_STACK_FRAME("flixel.util.LabelValuePair","destroy",0xc37a1f1d,"flixel.util.LabelValuePair.destroy","flixel/util/FlxStringUtil.hx",624,0x4e012e33)
            	HX_STACK_THIS(this)
HXLINE( 625)		this->label = null();
HXLINE( 626)		this->value = null();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(LabelValuePair_obj,destroy,(void))
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::weak(::String label, ::Dynamic value){
            	HX_STACK_FRAME("flixel.util.LabelValuePair","weak",0x1e0c0675,"flixel.util.LabelValuePair.weak","flixel/util/FlxStringUtil.hx",605,0x4e012e33)
            	HX_STACK_ARG(label,"label")
            	HX_STACK_ARG(value,"value")
HXLINE( 605)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 605)		_this->label = label;
HXDLIN( 605)		_this->value = value;
HXDLIN( 605)		return _this;
            	}
...
{
{
            	HX_STACK_FRAME("flixel.util.LabelValuePair","boot",0x10322e2f,"flixel.util.LabelValuePair.boot","flixel/util/FlxStringUtil.hx",601,0x4e012e33)
HXLINE( 601)		_pool =  ::flixel::util::FlxPool_flixel_util_LabelValuePair_obj::__new(hx::ClassOf< ::flixel::util::LabelValuePair >());
            	}
}
