...
HXLINE(  46)			Bool _hx_tmp = !(hx::IsNotNull( node ));
...
HXDLIN(  49)			Bool _hx_tmp4 = bmd->get_transparent();
HXDLIN(  49)			if ((_hx_tmp4 == transparent)) {
HXLINE(  49)				Int _hx_tmp5 = bmd->get_width();
HXDLIN(  49)				_hx_tmp3 = (_hx_tmp5 >= w);
            			}
            			else {
HXLINE(  49)				_hx_tmp3 = false;
            			}
HXDLIN(  49)			if (_hx_tmp3) {
HXLINE(  49)				Int _hx_tmp6 = bmd->get_height();
HXDLIN(  49)				_hx_tmp2 = (_hx_tmp6 >= h);
            			}
            			else {
...
HXLINE(  50)						Int _hx_tmp8 = bmd->get_width();
HXDLIN(  50)						_hx_tmp7 = (_hx_tmp8 == w);
            					}
            					else {
HXLINE(  50)						_hx_tmp7 = false;
            					}
HXDLIN(  50)					if (_hx_tmp7) {
HXLINE(  50)						Int _hx_tmp9 = bmd->get_height();
HXLINE(  49)						_hx_tmp1 = (_hx_tmp9 == h);
            					}
            					else {
...
HXLINE(  52)				res = bmd;
HXLINE(  55)				Bool _hx_tmp10 = hx::IsNotNull( node->prev );
HXDLIN(  55)				if (_hx_tmp10) {
HXLINE(  55)					node->prev->next = node->next;
            				}
HXLINE(  56)				Bool _hx_tmp11 = hx::IsNotNull( node->next );
HXDLIN(  56)				if (_hx_tmp11) {
...
HXLINE(  63)			node = node->next;
            		...
            		_hx_goto_0:;
HXLINE(  66)		Bool _hx_tmp12 = hx::IsNotNull( res );
HXDLIN(  66)		if (_hx_tmp12) {
HXLINE(  68)			Bool _hx_tmp13 = hx::IsNotNull( fillColor );
...
HXLINE(  79)			Int _hx_tmp14;
HXDLIN(  79)			Bool _hx_tmp15 = hx::IsNotNull( fillColor );
HXDLIN(  79)			if (_hx_tmp15) {
HXLINE(  79)				_hx_tmp14 = fillColor;
            			}
            			else {
HXLINE(  79)				_hx_tmp14 = (int)-1;
            			}
HXDLIN(  79)			res =  ::openfl::_legacy::display::BitmapData_obj::__new(w,h,transparent,_hx_tmp14,null());
            		}
...
HXLINE(  90)		Bool _hx_tmp = (::flixel::util::FlxBitmapDataPool_obj::length >= ::flixel::util::FlxBitmapDataPool_obj::maxLength);
...
HXLINE(  94)			Bool _hx_tmp1 = hx::IsNotNull( last->prev );
...
HXLINE( 103)		HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,node) =  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode_obj::__new(bmd,null(),null());
HXLINE( 104)		node->next = ::flixel::util::FlxBitmapDataPool_obj::_head;
HXLINE( 105)		Bool _hx_tmp2 = hx::IsNull( ::flixel::util::FlxBitmapDataPool_obj::_head );
...
HXLINE( 123)			Bool _hx_tmp = !(hx::IsNotNull( node ));
...
HXLINE( 136)		Bool _hx_tmp = (::flixel::util::FlxBitmapDataPool_obj::maxLength != value);
...
HXDLIN( 139)				Bool _hx_tmp2 = hx::IsNotNull( node );
HXDLIN( 139)				if (_hx_tmp2) {
HXLINE( 139)					_hx_tmp1 = (::flixel::util::FlxBitmapDataPool_obj::length > value);
            				}
            				else {
...
{
{
            	HX_STACK_FRAME("flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",21,0x992b0db1)
HXLINE(  21)		maxLength = (int)8;
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",26,0x992b0db1)
HXLINE(  26)		length = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",28,0x992b0db1)
HXLINE(  28)		_head = null();
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",29,0x992b0db1)
HXLINE(  29)		_tail = null();
            	}
{
            	HX_STACK_FRAME("flixel.util.FlxBitmapDataPool","boot",0xea853cb3,"flixel.util.FlxBitmapDataPool.boot","flixel/util/FlxBitmapDataPool.hx",31,0x992b0db1)
HXLINE(  31)		_rect =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
            	}
}
