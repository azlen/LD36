...
void FlxPool_obj::put( ::Dynamic obj){
            	HX_STACK_FRAME("flixel.util.FlxPool","put",0x02304495,"flixel.util.FlxPool.put","flixel/util/FlxPool.hx",42,0xdd4de86a)
            	HX_STACK_THIS(this)
...
void FlxPool_obj::putUnsafe( ::Dynamic obj){
            	HX_STACK_FRAME("flixel.util.FlxPool","putUnsafe",0x4c705a9b,"flixel.util.FlxPool.putUnsafe","flixel/util/FlxPool.hx",56,0xdd4de86a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(obj,"obj")
...
HXDLIN(  67)			 ::Dynamic _hx_tmp2 = ::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0));
HXDLIN(  67)			this->_pool->set(_hx_tmp1,_hx_tmp2);
            		}
            		_hx_goto_0:;
            	}
...
Int FlxPool_obj::get_length(){
            	HX_STACK_FRAME("flixel.util.FlxPool","get_length",0x704687a9,"flixel.util.FlxPool.get_length","flixel/util/FlxPool.hx",81,0xdd4de86a)
            	HX_STACK_THIS(this)
...
static void FlxPool_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(FlxPool_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void FlxPool_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
void FlxPool_obj::__register()
{
	...
	__mClass->mMarkFunc = FlxPool_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = FlxPool_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
