...
hx::ObjectPtr< FlxSignalHandler_obj > FlxSignalHandler_obj::__new( ::Dynamic listener,Bool dispatchOnce)
{
	...
	_hx_result->__construct(listener,dispatchOnce);
	return _hx_result;
}
...
static void FlxSignalHandler_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(FlxSignalHandler_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void FlxSignalHandler_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
void FlxSignalHandler_obj::__register()
{
	...
	__mClass->mMarkFunc = FlxSignalHandler_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = FlxSignalHandler_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
