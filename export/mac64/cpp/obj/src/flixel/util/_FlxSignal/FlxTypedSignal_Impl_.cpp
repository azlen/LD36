...
void FlxTypedSignal_Impl__obj::add(::Dynamic this1, ::Dynamic listener){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","add",0x0a4ba52c,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.add","flixel/util/FlxSignal.hx",19,0x3c758c5e)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(listener,"listener")
HXLINE(  19)		::flixel::util::IFlxSignal_obj::add(this1,listener);
            	}
...
void FlxTypedSignal_Impl__obj::addOnce(::Dynamic this1, ::Dynamic listener){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","addOnce",0x33af54cd,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.addOnce","flixel/util/FlxSignal.hx",24,0x3c758c5e)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(listener,"listener")
HXLINE(  24)		::flixel::util::IFlxSignal_obj::addOnce(this1,listener);
            	}
...
void FlxTypedSignal_Impl__obj::remove(::Dynamic this1, ::Dynamic listener){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","remove",0xc99e2219,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.remove","flixel/util/FlxSignal.hx",29,0x3c758c5e)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(listener,"listener")
HXLINE(  29)		::flixel::util::IFlxSignal_obj::remove(this1,listener);
            	}
...
Bool FlxTypedSignal_Impl__obj::has(::Dynamic this1, ::Dynamic listener){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","has",0x0a50f265,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.has","flixel/util/FlxSignal.hx",34,0x3c758c5e)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(listener,"listener")
HXLINE(  34)		return ::flixel::util::IFlxSignal_obj::has(this1,listener);
            	}
...
void FlxTypedSignal_Impl__obj::removeAll(::Dynamic this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE(  39)		::flixel::util::IFlxSignal_obj::removeAll(this1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSignal_Impl__obj,removeAll,(void))
 ...
 ::Dynamic FlxTypedSignal_Impl__obj::get_dispatch(::Dynamic this1){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","get_dispatch",0x56609658,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.get_dispatch","flixel/util/FlxSignal.hx",44,0x3c758c5e)
            	HX_STACK_ARG(this1,"this1")
HXLINE(  44)		return  ::Dynamic(this1->__Field(HX_("dispatch",ba,ce,63,1e),hx::paccDynamic));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSignal_Impl__obj,get_dispatch,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal0 FlxTypedSignal_Impl__obj::toSignal0(::Dynamic signal){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal0",0xbcacb1d8,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal0","flixel/util/FlxSignal.hx",50,0x3c758c5e)
            	HX_STACK_ARG(signal,"signal")
HXLINE(  50)		return  ::flixel::util::_FlxSignal::FlxSignal0_obj::__new();
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSignal_Impl__obj,toSignal0,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal1 FlxTypedSignal_Impl__obj::toSignal1(::Dynamic signal){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal1",0xbcacb1d9,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal1","flixel/util/FlxSignal.hx",56,0x3c758c5e)
            	HX_STACK_ARG(signal,"signal")
HXLINE(  56)		return  ::flixel::util::_FlxSignal::FlxSignal1_obj::__new();
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSignal_Impl__obj,toSignal1,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal2 FlxTypedSignal_Impl__obj::toSignal2(::Dynamic signal){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal2",0xbcacb1da,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal2","flixel/util/FlxSignal.hx",62,0x3c758c5e)
            	HX_STACK_ARG(signal,"signal")
HXLINE(  62)		return  ::flixel::util::_FlxSignal::FlxSignal2_obj::__new();
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSignal_Impl__obj,toSignal2,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal3 FlxTypedSignal_Impl__obj::toSignal3(::Dynamic signal){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal3",0xbcacb1db,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal3","flixel/util/FlxSignal.hx",68,0x3c758c5e)
            	HX_STACK_ARG(signal,"signal")
HXLINE(  68)		return  ::flixel::util::_FlxSignal::FlxSignal3_obj::__new();
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSignal_Impl__obj,toSignal3,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal4 FlxTypedSignal_Impl__obj::toSignal4(::Dynamic signal){
            	HX_STACK_FRAME("flixel.util._FlxSignal.FlxTypedSignal_Impl_","toSignal4",0xbcacb1dc,"flixel.util._FlxSignal.FlxTypedSignal_Impl_.toSignal4","flixel/util/FlxSignal.hx",74,0x3c758c5e)
            	HX_STACK_ARG(signal,"signal")
HXLINE(  74)		return  ::flixel::util::_FlxSignal::FlxSignal4_obj::__new();
            	}
