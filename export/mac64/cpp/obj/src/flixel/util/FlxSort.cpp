...
HXLINE(  18)		HX_VARI( Float,Value1) = Obj1->y;
HXDLIN(  18)		HX_VARI( Float,Value2) = Obj2->y;
HXDLIN(  18)		HX_VARI( Int,result) = (int)0;
HXDLIN(  18)		if ((Value1 < Value2)) {
HXLINE(  18)			result = Order;
            		}
            		else {
HXLINE(  18)			if ((Value1 > Value2)) {
HXLINE(  18)				result = -(Order);
            			}
            		}
