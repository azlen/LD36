...
Bool FlxColorTransformUtil_obj::hasRGBMultipliers( ::openfl::_legacy::geom::ColorTransform transform){
            	HX_STACK_FRAME("flixel.util.FlxColorTransformUtil","hasRGBMultipliers",0xd2859e14,"flixel.util.FlxColorTransformUtil.hasRGBMultipliers","flixel/util/FlxColorTransformUtil.hx",34,0xf5538e7b)
            	HX_STACK_ARG(transform,"transform")
...
Bool FlxColorTransformUtil_obj::hasRGBAMultipliers( ::openfl::_legacy::geom::ColorTransform transform){
            	HX_STACK_FRAME("flixel.util.FlxColorTransformUtil","hasRGBAMultipliers",0xfe0e906f,"flixel.util.FlxColorTransformUtil.hasRGBAMultipliers","flixel/util/FlxColorTransformUtil.hx",42,0xf5538e7b)
            	HX_STACK_ARG(transform,"transform")
...
Bool FlxColorTransformUtil_obj::hasRGBOffsets( ::openfl::_legacy::geom::ColorTransform transform){
            	HX_STACK_FRAME("flixel.util.FlxColorTransformUtil","hasRGBOffsets",0x81d534c2,"flixel.util.FlxColorTransformUtil.hasRGBOffsets","flixel/util/FlxColorTransformUtil.hx",50,0xf5538e7b)
            	HX_STACK_ARG(transform,"transform")
...
Bool FlxColorTransformUtil_obj::hasRGBAOffsets( ::openfl::_legacy::geom::ColorTransform transform){
            	HX_STACK_FRAME("flixel.util.FlxColorTransformUtil","hasRGBAOffsets",0xc8891d9d,"flixel.util.FlxColorTransformUtil.hasRGBAOffsets","flixel/util/FlxColorTransformUtil.hx",58,0xf5538e7b)
            	HX_STACK_ARG(transform,"transform")
