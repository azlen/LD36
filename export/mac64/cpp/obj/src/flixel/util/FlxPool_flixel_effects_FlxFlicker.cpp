...
void FlxPool_flixel_effects_FlxFlicker_obj::put( ::flixel::effects::FlxFlicker obj){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_effects_FlxFlicker","put",0xff20be7c,"flixel.util.FlxPool_flixel_effects_FlxFlicker.put","flixel/util/FlxPool.hx",42,0xdd4de86a)
            	HX_STACK_THIS(this)
...
void FlxPool_flixel_effects_FlxFlicker_obj::putUnsafe( ::flixel::effects::FlxFlicker obj){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_effects_FlxFlicker","putUnsafe",0xc85fbbc2,"flixel.util.FlxPool_flixel_effects_FlxFlicker.putUnsafe","flixel/util/FlxPool.hx",56,0xdd4de86a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(obj,"obj")
...
HXDLIN(  67)			 ::flixel::effects::FlxFlicker _hx_tmp2 = ( ( ::flixel::effects::FlxFlicker)(::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0))) );
...
Int FlxPool_flixel_effects_FlxFlicker_obj::get_length(){
            	HX_STACK_FRAME("flixel.util.FlxPool_flixel_effects_FlxFlicker","get_length",0x65cc28a2,"flixel.util.FlxPool_flixel_effects_FlxFlicker.get_length","flixel/util/FlxPool.hx",81,0xdd4de86a)
            	HX_STACK_THIS(this)
