...
hx::ObjectPtr< FlxBaseAnimation_obj > FlxBaseAnimation_obj::__new( ::flixel::animation::FlxAnimationController Parent,::String Name)
{
	...
	_hx_result->__construct(Parent,Name);
	return _hx_result;
}
...
HXDLIN(  31)		Bool _hx_tmp1 = hx::IsNotNull( this->parent );
...
hx::Val FlxBaseAnimation_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"curIndex") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_curIndex(inValue) );curIndex=inValue.Cast< Int >(); return inValue; }
	}
