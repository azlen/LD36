...
void __ASSET__flixel_fonts_nokiafc22_ttf_obj::__construct(::String __o_filename,::hx::EnumBase style,::hx::EnumBase type){
::String filename = __o_filename.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACK_FRAME("__ASSET__flixel_fonts_nokiafc22_ttf","new",0x22f03f2a,"__ASSET__flixel_fonts_nokiafc22_ttf.new","DefaultAssetLibrary.hx",579,0x0fc48912)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(filename,"filename")
            	HX_STACK_ARG(style,"style")
            	HX_STACK_ARG(type,"type")
HXLINE( 579)		super::__construct(filename,style,type);
            	}

Dynamic __ASSET__flixel_fonts_nokiafc22_ttf_obj::__CreateEmpty() { return new __ASSET__flixel_fonts_nokiafc22_ttf_obj; }

hx::ObjectPtr< __ASSET__flixel_fonts_nokiafc22_ttf_obj > __ASSET__flixel_fonts_nokiafc22_ttf_obj::__new(::String __o_filename,::hx::EnumBase style,::hx::EnumBase type)
{
