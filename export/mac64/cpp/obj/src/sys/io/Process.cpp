...
void Process_obj::__construct(::String cmd,::Array< ::String > args){
            	HX_STACK_FRAME("sys.io.Process","new",0x849b4c7a,"sys.io.Process.new","/usr/local/lib/haxe/std/cpp/_std/sys/io/Process.hx",96,0x8244a714)
            	HX_STACK_THIS(this)
...
void Process_obj::close(){
            	HX_STACK_FRAME("sys.io.Process","close",0x0a954e52,"sys.io.Process.close","/usr/local/lib/haxe/std/cpp/_std/sys/io/Process.hx",112,0x8244a714)
            	HX_STACK_THIS(this)
