...
void __ASSET__flixel_sounds_beep_ogg_obj::__construct( ::openfl::_legacy::net::URLRequest stream, ::openfl::media::SoundLoaderContext context, ::Dynamic __o_forcePlayAsMusic){
 ::Dynamic forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
            	HX_STACK_FRAME("__ASSET__flixel_sounds_beep_ogg","new",0x0aaf31f8,"__ASSET__flixel_sounds_beep_ogg.new","openfl/_legacy/Assets.hx",2283,0x9276b055)
            	HX_STACK_THIS(this)
...
HXLINE(2287)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_sounds_beep_ogg_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("__ASSET__flixel_sounds_beep_ogg","boot",0x46b5879a,"__ASSET__flixel_sounds_beep_ogg.boot","openfl/_legacy/media/Sound.hx",25,0xdb1efaa0)
HXLINE(  25)		resourceName = HX_("__ASSET__:sound___ASSET__flixel_sounds_beep_ogg",ac,ee,6e,4e);
            	}
}
