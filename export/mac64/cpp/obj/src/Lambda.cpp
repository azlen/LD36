...
::cpp::VirtualArray Lambda_obj::array( ::Dynamic it){
            	HX_STACK_FRAME("Lambda","array",0x9c8b0512,"Lambda.array","/usr/local/lib/haxe/std/Lambda.hx",44,0xf61dfe9a)
            	HX_STACK_ARG(it,"it")
...
Bool Lambda_obj::has( ::Dynamic it, ::Dynamic elt){
            	HX_STACK_FRAME("Lambda","has",0x3d8bd693,"Lambda.has","/usr/local/lib/haxe/std/Lambda.hx",124,0xf61dfe9a)
            	HX_STACK_ARG(it,"it")
