...
void Font_obj::__construct(::String __o_filename,::hx::EnumBase style,::hx::EnumBase type){
...
HXLINE(  40)			Bool _hx_tmp = ::Reflect_obj::hasField(fontClass,HX_("resourceName",39,7a,62,90));
HXDLIN(  40)			if (_hx_tmp) {
HXLINE(  42)				 ::Dynamic _hx_tmp1 = ::Reflect_obj::field(fontClass,HX_("resourceName",39,7a,62,90));
HXDLIN(  42)				 ::haxe::io::Bytes _hx_tmp2 = ::haxe::Resource_obj::getBytes(_hx_tmp1);
HXDLIN(  42)				 ::openfl::_legacy::utils::ByteArray _hx_tmp3 = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(_hx_tmp2);
HXDLIN(  42)				this->_hx___fromBytes(_hx_tmp3);
            			}
            		}
            		else {
HXLINE(  55)			this->_hx___fontPath = filename;
HXLINE(  56)			this->fontName = filename;
HXLINE(  57)			::hx::EnumBase _hx_tmp4;
HXDLIN(  57)			Bool _hx_tmp5 = hx::IsNull( style );
HXDLIN(  57)			if (_hx_tmp5) {
HXLINE(  57)				_hx_tmp4 = ::openfl::_legacy::text::FontStyle_obj::REGULAR_dyn();
            			}
            			else {
HXLINE(  57)				_hx_tmp4 = style;
            			}
HXDLIN(  57)			this->fontStyle = _hx_tmp4;
HXLINE(  58)			::hx::EnumBase _hx_tmp6;
HXDLIN(  58)			Bool _hx_tmp7 = hx::IsNull( type );
HXDLIN(  58)			if (_hx_tmp7) {
HXLINE(  58)				_hx_tmp6 = ::openfl::_legacy::text::FontType_obj::EMBEDDED_dyn();
            			}
            			else {
HXLINE(  58)				_hx_tmp6 = type;
            			}
HXDLIN(  58)			this->fontType = _hx_tmp6;
            		}
            	}

Dynamic Font_obj::__CreateEmpty() { return new Font_obj; }

hx::ObjectPtr< Font_obj > Font_obj::__new(::String __o_filename,::hx::EnumBase style,::hx::EnumBase type)
{
...
::String Font_obj::toString(){
            	HX_STACK_FRAME("openfl._legacy.text.Font","toString",0x25d1dc6e,"openfl._legacy.text.Font.toString","openfl/_legacy/text/Font.hx",143,0x48d29f73)
            	HX_STACK_THIS(this)
HXLINE( 143)		::String _hx_tmp = ((HX_("{ name=",2d,2a,c0,5c) + this->fontName) + HX_(", style=",60,5b,2d,1d));
HXDLIN( 143)		::String _hx_tmp1 = ::Std_obj::string(this->fontStyle);
HXDLIN( 143)		::String _hx_tmp2 = ((_hx_tmp + _hx_tmp1) + HX_(", type=",4f,65,e7,0b));
HXDLIN( 143)		::String _hx_tmp3 = ::Std_obj::string(this->fontType);
HXDLIN( 143)		return ((_hx_tmp2 + _hx_tmp3) + HX_(" }",5d,1c,00,00));
            	}
...
HXLINE( 157)			Bool _hx_tmp1 = ( (Bool)(details->__Field(HX_("is_bold",3a,d1,84,fd),hx::paccDynamic)) );
HXDLIN( 157)			if (_hx_tmp1) {
HXLINE( 159)				this->fontStyle = ::openfl::_legacy::text::FontStyle_obj::BOLD_dyn();
            			}
            			else {
HXLINE( 161)				Bool _hx_tmp2 = ( (Bool)(details->__Field(HX_("is_italic",e5,95,88,ab),hx::paccDynamic)) );
...
HXLINE( 180)		Bool _hx_tmp = hx::IsNotNull( this->_hx___fontPath );
...
HXLINE( 185)				_hx_tmp1 = ( (Bool)(details->__Field(HX_("is_italic",e5,95,88,ab),hx::paccDynamic)) );
            			}
            			else {
...
HXLINE( 189)				Bool _hx_tmp2 = ( (Bool)(details->__Field(HX_("is_bold",3a,d1,84,fd),hx::paccDynamic)) );
HXDLIN( 189)				if (_hx_tmp2) {
HXLINE( 191)					this->fontStyle = ::openfl::_legacy::text::FontStyle_obj::BOLD_dyn();
            				}
            				else {
HXLINE( 193)					Bool _hx_tmp3 = ( (Bool)(details->__Field(HX_("is_italic",e5,95,88,ab),hx::paccDynamic)) );
...
HXLINE(  71)			Bool _hx_tmp = hx::IsNull( ::openfl::_legacy::text::Font_obj::_hx___deviceFonts );
HXDLIN(  71)			if (_hx_tmp) {
            				...
            				void _hx_run(::String name,Int style){
            					HX_STACK_FRAME("openfl._legacy.text.Font","enumerateFonts",0x85cd9342,"openfl._legacy.text.Font.enumerateFonts","openfl/_legacy/text/Font.hx",75,0x48d29f73)
            					HX_STACK_ARG(name,"name")
            					HX_STACK_ARG(style,"style")
HXLINE(  75)					::hx::EnumBase _hx_tmp1 = styles->__get(style).StaticCast< ::hx::EnumBase >();
HXDLIN(  75)					::openfl::_legacy::text::Font_obj::_hx___deviceFonts->push( ::openfl::_legacy::text::Font_obj::__new(name,_hx_tmp1,::openfl::_legacy::text::FontType_obj::DEVICE_dyn()));
            				}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,enumerateFonts,return )
 ...
 ::openfl::_legacy::text::Font Font_obj::fromBytes( ::openfl::_legacy::utils::ByteArray bytes){
            	...
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  90)		HX_VARI(  ::openfl::_legacy::text::Font,font) =  ::openfl::_legacy::text::Font_obj::__new(null(),null(),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromBytes,return )
 ...
 ::openfl::_legacy::text::Font Font_obj::fromFile(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE(  99)		HX_VARI(  ::openfl::_legacy::text::Font,font) =  ::openfl::_legacy::text::Font_obj::__new(null(),null(),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromFile,return )
 ...
 ::Dynamic Font_obj::load(::String filename){
            	...
            	HX_STACK_ARG(filename,"filename")
HXLINE( 108)		HX_VARI(  ::Dynamic,result) = ::openfl::_legacy::text::Font_obj::freetype_import_font(filename,null(),(int)20480,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,load,return )
 ...
 ::Dynamic Font_obj::loadBytes( ::openfl::_legacy::utils::ByteArray bytes){
            	...
            	HX_STACK_ARG(bytes,"bytes")
HXLINE( 116)		HX_VARI(  ::Dynamic,result) = ::openfl::_legacy::text::Font_obj::freetype_import_font(HX_("",00,00,00,00),null(),(int)20480,bytes);
...
HXLINE( 126)		Bool _hx_tmp = hx::IsNotNull( instance );
HXDLIN( 126)		if (_hx_tmp) {
HXLINE( 128)			Bool _hx_tmp1 = ::Reflect_obj::hasField(font,HX_("resourceName",39,7a,62,90));
HXDLIN( 128)			if (_hx_tmp1) {
HXLINE( 130)				 ::Dynamic _hx_tmp2 = ::Reflect_obj::field(font,HX_("resourceName",39,7a,62,90));
HXDLIN( 130)				 ::haxe::io::Bytes _hx_tmp3 = ::haxe::Resource_obj::getBytes(_hx_tmp2);
HXDLIN( 130)				 ::openfl::_legacy::utils::ByteArray _hx_tmp4 = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(_hx_tmp3);
HXDLIN( 130)				::openfl::_legacy::text::Font_obj::lime_font_register_font(instance->fontName,_hx_tmp4);
            			}
...
hx::Val Font_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"fontType") ) { fontType=inValue.Cast< ::hx::EnumBase >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"fontStyle") ) { fontStyle=inValue.Cast< ::hx::EnumBase >(); return inValue; }
		break;
	case 10:
...
{
{
            	HX_STACK_FRAME("openfl._legacy.text.Font","boot",0x40d906f4,"openfl._legacy.text.Font.boot","openfl/_legacy/text/Font.hx",30,0x48d29f73)
HXLINE(  30)		_hx___registeredFonts = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_STACK_FRAME("openfl._legacy.text.Font","boot",0x40d906f4,"openfl._legacy.text.Font.boot","openfl/_legacy/text/Font.hx",234,0x48d29f73)
...
{
            	HX_STACK_FRAME("openfl._legacy.text.Font","boot",0x40d906f4,"openfl._legacy.text.Font.boot","openfl/_legacy/text/Font.hx",235,0x48d29f73)
...
{
            	HX_STACK_FRAME("openfl._legacy.text.Font","boot",0x40d906f4,"openfl._legacy.text.Font.boot","openfl/_legacy/text/Font.hx",236,0x48d29f73)
