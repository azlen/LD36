...
{
{
            	HX_STACK_FRAME("openfl._legacy.text.TextFormatAlign","boot",0x2978647c,"openfl._legacy.text.TextFormatAlign.boot","openfl/_legacy/text/TextFormatAlign.hx",6,0x501e4059)
HXLINE(   6)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.text.TextFormatAlign","boot",0x2978647c,"openfl._legacy.text.TextFormatAlign.boot","openfl/_legacy/text/TextFormatAlign.hx",7,0x501e4059)
HXLINE(   7)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.text.TextFormatAlign","boot",0x2978647c,"openfl._legacy.text.TextFormatAlign.boot","openfl/_legacy/text/TextFormatAlign.hx",8,0x501e4059)
HXLINE(   8)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.text.TextFormatAlign","boot",0x2978647c,"openfl._legacy.text.TextFormatAlign.boot","openfl/_legacy/text/TextFormatAlign.hx",9,0x501e4059)
HXLINE(   9)		JUSTIFY = HX_("justify",50,df,b5,83);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.text.TextFormatAlign","boot",0x2978647c,"openfl._legacy.text.TextFormatAlign.boot","openfl/_legacy/text/TextFormatAlign.hx",12,0x501e4059)
HXLINE(  12)		START = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.text.TextFormatAlign","boot",0x2978647c,"openfl._legacy.text.TextFormatAlign.boot","openfl/_legacy/text/TextFormatAlign.hx",13,0x501e4059)
