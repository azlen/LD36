...
HXLINE(  57)		Bool _hx_tmp = hx::IsNull( centerPoint );
HXDLIN(  57)		if (_hx_tmp) {
HXLINE(  57)			this->_tilePoints->push(::openfl::_legacy::display::Tilesheet_obj::defaultRatio);
            		}
            		else {
HXLINE(  58)			Float _hx_tmp1 = ((Float)centerPoint->x / (Float)rectangle->width);
HXDLIN(  58)			Float _hx_tmp2 = ((Float)centerPoint->y / (Float)rectangle->height);
HXDLIN(  58)			this->_tilePoints->push( ::openfl::_legacy::geom::Point_obj::__new(_hx_tmp1,_hx_tmp2));
            		}
HXLINE(  59)		Float _hx_tmp3 = rectangle->get_left();
...
HXDLIN(  59)		Float _hx_tmp10 = ((Float)_hx_tmp9 / (Float)this->_bitmapHeight);
HXDLIN(  59)		this->_tileUVs->push( ::openfl::_legacy::geom::Rectangle_obj::__new(_hx_tmp4,_hx_tmp6,_hx_tmp8,_hx_tmp10));
...
Int count = __o_count.Default(-1);
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","drawTiles",0x43ceeb34,"openfl._legacy.display.Tilesheet.drawTiles","openfl/_legacy/display/Tilesheet.hx",67,0x425689e0)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC5(Tilesheet_obj,drawTiles,(void))
 ...
 ::openfl::_legacy::geom::Point Tilesheet_obj::getTileCenter(Int index){
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","getTileCenter",0x967135ac,"openfl._legacy.display.Tilesheet.getTileCenter","openfl/_legacy/display/Tilesheet.hx",73,0x425689e0)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Tilesheet_obj,getTileCenter,return )
 ...
 ::openfl::_legacy::geom::Rectangle Tilesheet_obj::getTileRect(Int index){
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","getTileRect",0x228ce93b,"openfl._legacy.display.Tilesheet.getTileRect","openfl/_legacy/display/Tilesheet.hx",77,0x425689e0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
HX_DEFINE_DYNAMIC_FUNC1(Tilesheet_obj,getTileRect,return )
 ...
 ::openfl::_legacy::geom::Rectangle Tilesheet_obj::getTileUVs(Int index){
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","getTileUVs",0x4630c6db,"openfl._legacy.display.Tilesheet.getTileUVs","openfl/_legacy/display/Tilesheet.hx",81,0x425689e0)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
{
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",15,0x425689e0)
HXLINE(  15)		TILE_SCALE = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",16,0x425689e0)
HXLINE(  16)		TILE_ROTATION = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",17,0x425689e0)
HXLINE(  17)		TILE_RGB = (int)4;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",18,0x425689e0)
HXLINE(  18)		TILE_ALPHA = (int)8;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",19,0x425689e0)
HXLINE(  19)		TILE_TRANS_2x2 = (int)16;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",20,0x425689e0)
HXLINE(  20)		TILE_RECT = (int)32;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",21,0x425689e0)
HXLINE(  21)		TILE_ORIGIN = (int)64;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",22,0x425689e0)
HXLINE(  22)		TILE_BLEND_NORMAL = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",23,0x425689e0)
HXLINE(  23)		TILE_BLEND_ADD = (int)65536;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",24,0x425689e0)
HXLINE(  24)		TILE_BLEND_MULTIPLY = (int)131072;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",25,0x425689e0)
HXLINE(  25)		TILE_BLEND_SCREEN = (int)262144;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",26,0x425689e0)
HXLINE(  26)		TILE_BLEND_SUBTRACT = (int)524288;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",32,0x425689e0)
HXLINE(  32)		defaultRatio =  ::openfl::_legacy::geom::Point_obj::__new((int)0,(int)0);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",90,0x425689e0)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Tilesheet","boot",0xaf0dacbf,"openfl._legacy.display.Tilesheet.boot","openfl/_legacy/display/Tilesheet.hx",91,0x425689e0)
