...
void Graphics_obj::beginGradientFill(::hx::EnumBase type,::cpp::VirtualArray colors,::cpp::VirtualArray alphas,::cpp::VirtualArray ratios, ::openfl::_legacy::geom::Matrix matrix,::hx::EnumBase spreadMethod,::hx::EnumBase interpolationMethod,hx::Null< Float >  __o_focalPointRatio){
...
HXLINE(  59)		Bool _hx_tmp = hx::IsNull( matrix );
HXDLIN(  59)		if (_hx_tmp) {
HXLINE(  61)			matrix =  ::openfl::_legacy::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
HXLINE(  62)			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
            		}
HXLINE(  66)		 ::Dynamic _hx_tmp1 = this->_hx___handle;
HXDLIN(  66)		Int _hx_tmp2 = ( ( ::hx::EnumBase)(type) )->_hx_getIndex();
HXDLIN(  66)		Int _hx_tmp3;
HXDLIN(  66)		Bool _hx_tmp4 = hx::IsNull( spreadMethod );
HXDLIN(  66)		if (_hx_tmp4) {
HXLINE(  66)			_hx_tmp3 = (int)0;
            		}
            		else {
HXLINE(  66)			_hx_tmp3 = ( ( ::hx::EnumBase)(spreadMethod) )->_hx_getIndex();
            		}
HXDLIN(  66)		Int _hx_tmp5;
HXDLIN(  66)		Bool _hx_tmp6 = hx::IsNull( interpolationMethod );
HXDLIN(  66)		if (_hx_tmp6) {
HXLINE(  66)			_hx_tmp5 = (int)0;
            		}
            		else {
HXLINE(  66)			_hx_tmp5 = ( ( ::hx::EnumBase)(interpolationMethod) )->_hx_getIndex();
            		}
HXDLIN(  66)		::openfl::_legacy::display::Graphics_obj::lime_gfx_begin_gradient_fill(_hx_tmp1,_hx_tmp2,colors,alphas,ratios,matrix,_hx_tmp3,_hx_tmp5,focalPointRatio);
            	}
...
HXLINE( 101)		 ::Dynamic _hx_tmp = this->_hx___handle;
HXDLIN( 101)		::openfl::_legacy::display::Graphics_obj::lime_gfx_draw_ellipse(_hx_tmp,(x - radius),(y - radius),(radius * (int)2),(radius * (int)2));
            	}
...
HXDLIN( 151)		Bool _hx_tmp1 = hx::IsNull( radiusY );
...
HXLINE( 165)		 ::Dynamic _hx_tmp = this->_hx___handle;
HXDLIN( 165)		::openfl::_legacy::display::Graphics_obj::lime_gfx_draw_path(_hx_tmp,commands,data,(winding == HX_("evenOdd",b5,c6,7e,06)));
            	}
...
HXLINE( 176)			hx::OrEq(flags,(int)4096);
            		}
...
void Graphics_obj::drawTriangles(::Array< Float > vertices,::Array< Int > indices,::Array< Float > uvtData,::hx::EnumBase culling,::Array< Int > colors,hx::Null< Int >  __o_blendMode){
...
HXDLIN( 186)		Bool _hx_tmp = hx::IsNull( culling );
HXDLIN( 186)		if (_hx_tmp) {
HXLINE( 186)			cull = (int)0;
            		}
            		else {
HXLINE( 186)			Int _hx_tmp1 = ( ( ::hx::EnumBase)(culling) )->_hx_getIndex();
HXDLIN( 186)			cull = (_hx_tmp1 - (int)1);
            		}
...
void Graphics_obj::lineGradientStyle(::hx::EnumBase type,::cpp::VirtualArray colors,::cpp::VirtualArray alphas,::cpp::VirtualArray ratios, ::openfl::_legacy::geom::Matrix matrix,::hx::EnumBase spreadMethod,::hx::EnumBase interpolationMethod,hx::Null< Float >  __o_focalPointRatio){
Float focalPointRatio = __o_focalPointRatio.Default(((Float)0.0));
            	...
            	HX_STACK_ARG(interpolationMethod,"interpolationMethod")
            	HX_STACK_ARG(focalPointRatio,"focalPointRatio")
HXLINE( 208)		Bool _hx_tmp = hx::IsNull( matrix );
HXDLIN( 208)		if (_hx_tmp) {
HXLINE( 210)			matrix =  ::openfl::_legacy::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
HXLINE( 211)			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
            		}
HXLINE( 215)		 ::Dynamic _hx_tmp1 = this->_hx___handle;
HXDLIN( 215)		Int _hx_tmp2 = ( ( ::hx::EnumBase)(type) )->_hx_getIndex();
HXDLIN( 215)		Int _hx_tmp3;
HXDLIN( 215)		Bool _hx_tmp4 = hx::IsNull( spreadMethod );
HXDLIN( 215)		if (_hx_tmp4) {
HXLINE( 215)			_hx_tmp3 = (int)0;
            		}
            		else {
HXLINE( 215)			_hx_tmp3 = ( ( ::hx::EnumBase)(spreadMethod) )->_hx_getIndex();
            		}
HXDLIN( 215)		Int _hx_tmp5;
HXDLIN( 215)		Bool _hx_tmp6 = hx::IsNull( interpolationMethod );
HXDLIN( 215)		if (_hx_tmp6) {
HXLINE( 215)			_hx_tmp5 = (int)0;
            		}
            		else {
HXLINE( 215)			_hx_tmp5 = ( ( ::hx::EnumBase)(interpolationMethod) )->_hx_getIndex();
            		}
HXDLIN( 215)		::openfl::_legacy::display::Graphics_obj::lime_gfx_line_gradient_fill(_hx_tmp1,_hx_tmp2,colors,alphas,ratios,matrix,_hx_tmp3,_hx_tmp5,focalPointRatio);
            	}


HX_DEFINE_DYNAMIC_FUNC8(Graphics_obj,lineGradientStyle,(void))

void Graphics_obj::lineStyle( ::Dynamic thickness,hx::Null< Int >  __o_color,hx::Null< Float >  __o_alpha,hx::Null< Bool >  __o_pixelHinting,::hx::EnumBase scaleMode,::hx::EnumBase caps,::hx::EnumBase joints,hx::Null< Float >  __o_miterLimit){
Int color = __o_color.Default(0);
Float alpha = __o_alpha.Default(((Float)1.0));
Bool pixelHinting = __o_pixelHinting.Default(false);
Float miterLimit = __o_miterLimit.Default(3);
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","lineStyle",0xc9373aea,"openfl._legacy.display.Graphics.lineStyle","openfl/_legacy/display/Graphics.hx",222,0x485def00)
            	HX_STACK_THIS(this)
...
HXDLIN( 222)		Bool _hx_tmp2 = hx::IsNull( scaleMode );
HXDLIN( 222)		if (_hx_tmp2) {
HXLINE( 222)			_hx_tmp1 = (int)0;
            		}
            		else {
HXLINE( 222)			_hx_tmp1 = ( ( ::hx::EnumBase)(scaleMode) )->_hx_getIndex();
            		}
HXDLIN( 222)		Int _hx_tmp3;
HXDLIN( 222)		Bool _hx_tmp4 = hx::IsNull( caps );
HXDLIN( 222)		if (_hx_tmp4) {
HXLINE( 222)			_hx_tmp3 = (int)0;
            		}
            		else {
HXLINE( 222)			_hx_tmp3 = ( ( ::hx::EnumBase)(caps) )->_hx_getIndex();
            		}
HXDLIN( 222)		Int _hx_tmp5;
HXDLIN( 222)		Bool _hx_tmp6 = hx::IsNull( joints );
HXDLIN( 222)		if (_hx_tmp6) {
HXLINE( 222)			_hx_tmp5 = (int)0;
            		}
            		else {
HXLINE( 222)			_hx_tmp5 = ( ( ::hx::EnumBase)(joints) )->_hx_getIndex();
            		}
HXDLIN( 222)		::openfl::_legacy::display::Graphics_obj::lime_gfx_line_style(_hx_tmp,thickness,color,alpha,pixelHinting,_hx_tmp1,_hx_tmp3,_hx_tmp5,miterLimit);
            	}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",15,0x485def00)
HXLINE(  15)		TILE_SCALE = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",16,0x485def00)
HXLINE(  16)		TILE_ROTATION = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",17,0x485def00)
HXLINE(  17)		TILE_RGB = (int)4;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",18,0x485def00)
HXLINE(  18)		TILE_ALPHA = (int)8;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",19,0x485def00)
HXLINE(  19)		TILE_TRANS_2x2 = (int)16;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",20,0x485def00)
HXLINE(  20)		TILE_RECT = (int)32;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",21,0x485def00)
HXLINE(  21)		TILE_ORIGIN = (int)64;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",22,0x485def00)
HXLINE(  22)		TILE_SMOOTH = (int)4096;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",23,0x485def00)
HXLINE(  23)		TILE_BLEND_NORMAL = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",24,0x485def00)
HXLINE(  24)		TILE_BLEND_ADD = (int)65536;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",255,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",256,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",257,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",258,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",259,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",260,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",261,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",262,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",263,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",264,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",265,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",266,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",267,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",268,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",269,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",270,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",271,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",272,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",273,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",274,0x485def00)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.Graphics","boot",0x31c01505,"openfl._legacy.display.Graphics.boot","openfl/_legacy/display/Graphics.hx",275,0x485def00)
