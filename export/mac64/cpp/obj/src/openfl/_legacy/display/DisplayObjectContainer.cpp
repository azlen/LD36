...
HXLINE(  31)				Int _hx_tmp = (this->_hx___children->length - (int)1);
HXDLIN(  31)				this->setChildIndex(child,_hx_tmp);
            			}
            			else {
...
HXLINE(  39)				Int _hx_tmp = (this->_hx___children->length - (int)1);
HXDLIN(  39)				this->setChildIndex(child,_hx_tmp);
            			}
            			else {
...
HXLINE(  40)				::String _hx_tmp1 = child->toString();
HXDLIN(  40)				HX_VARI( ::String,msg) = ((HX_("setChildIndex : object ",93,4a,81,b4) + _hx_tmp1) + HX_(" not found.",39,f7,8e,4f));
...
HXLINE(  40)						::String _hx_tmp2 = ::Std_obj::string(actualIndex);
HXDLIN(  40)						hx::AddEq(msg,(HX_("Internal error: Real child index was ",00,bf,50,8a) + _hx_tmp2));
            					}
            					else {
HXLINE(  40)						hx::AddEq(msg,HX_("Internal error: Child was not in __children array!",a1,b9,1b,be));
            					}
            				}
...
HXLINE(  40)					 ::openfl::_legacy::display::DisplayObject _hx_tmp3 = this->_hx___children->__get((i1 - (int)1)).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
HXDLIN(  40)					this->_hx___children[i1] = _hx_tmp3;
HXDLIN(  40)					--i1;
            				}
...
HXLINE(  40)						 ::openfl::_legacy::display::DisplayObject _hx_tmp4 = this->_hx___children->__get((i2 + (int)1)).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
HXDLIN(  40)						this->_hx___children[i2] = _hx_tmp4;
HXDLIN(  40)						++i2;
            					}
HXDLIN(  40)					this->_hx___children[index] = child;
            				}
...
HXLINE(  68)		::String _hx_tmp1 = (((HX_("getChildAt : index out of bounds ",cf,fc,a7,dc) + index) + HX_("/",2f,00,00,00)) + this->_hx___children->length);
HXDLIN(  68)		HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__new(_hx_tmp1));
...
HXDLIN(  76)				++_g;
HXLINE(  78)				::String _hx_tmp = child->get_name();
HXDLIN(  78)				if ((name == _hx_tmp)) {
...
::Array< ::Dynamic> DisplayObjectContainer_obj::getObjectsUnderPoint( ::openfl::_legacy::geom::Point point){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE( 101)		 ::openfl::_legacy::display::Stage _hx_tmp = this->get_stage();
HXDLIN( 101)		HX_VARI( Bool,onStage) = hx::IsNotNull( _hx_tmp );
...
HX_DEFINE_DYNAMIC_FUNC1(DisplayObjectContainer_obj,getObjectsUnderPoint,return )
 ...
 ::openfl::_legacy::display::DisplayObject DisplayObjectContainer_obj::removeChild( ::openfl::_legacy::display::DisplayObject child){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(child,"child")
HXLINE( 128)		HX_VARI( Int,index) = this->_hx___getChildIndex(child);
...
HXLINE( 152)		HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__new(HX_("The supplied DisplayObject must be a child of the caller.",e6,f4,27,a5)));
...
HXLINE( 159)		Bool _hx_tmp = (endIndex == (int)2147483647);
...
HXLINE( 171)		Bool _hx_tmp1 = (beginIndex > (this->_hx___children->length - (int)1));
...
HXLINE( 175)				_hx_tmp3 = (beginIndex < (int)0);
            			}
            			else {
HXLINE( 175)				_hx_tmp3 = true;
            			}
HXDLIN( 175)			if (!(_hx_tmp3)) {
HXLINE( 175)				_hx_tmp2 = (endIndex > this->_hx___children->length);
            			}
            			else {
HXLINE( 175)				_hx_tmp2 = true;
            			}
HXDLIN( 175)			if (_hx_tmp2) {
HXLINE( 177)				HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__new(HX_("The supplied index is out of bounds.",17,96,1b,51)));
            			}
            		}
...
HXLINE( 194)			::String _hx_tmp = child->toString();
HXDLIN( 194)			HX_VARI( ::String,msg) = ((HX_("setChildIndex : object ",93,4a,81,b4) + _hx_tmp) + HX_(" not found.",39,f7,8e,4f));
...
HXLINE( 194)					::String _hx_tmp1 = ::Std_obj::string(actualIndex);
HXDLIN( 194)					hx::AddEq(msg,(HX_("Internal error: Real child index was ",00,bf,50,8a) + _hx_tmp1));
            				}
            				else {
HXLINE( 194)					hx::AddEq(msg,HX_("Internal error: Child was not in __children array!",a1,b9,1b,be));
            				}
            			}
...
HXLINE( 194)				 ::openfl::_legacy::display::DisplayObject _hx_tmp2 = this->_hx___children->__get((i1 - (int)1)).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
HXDLIN( 194)				this->_hx___children[i1] = _hx_tmp2;
HXDLIN( 194)				--i1;
            			}
...
HXLINE( 194)					 ::openfl::_legacy::display::DisplayObject _hx_tmp3 = this->_hx___children->__get((i2 + (int)1)).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
HXDLIN( 194)					this->_hx___children[i2] = _hx_tmp3;
HXDLIN( 194)					++i2;
            				}
HXDLIN( 194)				this->_hx___children[index] = child;
            			}
...
HXLINE( 210)				HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__new(HX_("swapChildrenAt : index out of bounds",fd,03,a9,7f)));
            			}
...
HXDLIN( 210)				 ::openfl::_legacy::display::DisplayObject _hx_tmp4 = this->_hx___children->__get(index2).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
HXDLIN( 210)				this->_hx___children[index1] = _hx_tmp4;
...
HXLINE( 217)			HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__new(HX_("swapChildrenAt : index out of bounds",fd,03,a9,7f)));
            		}
...
HXDLIN( 217)			 ::openfl::_legacy::display::DisplayObject _hx_tmp3 = this->_hx___children->__get(index2).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
HXDLIN( 217)			this->_hx___children[index1] = _hx_tmp3;
...
HXLINE( 232)			Int _hx_tmp = (this->_hx___children->length - (int)1);
HXDLIN( 232)			this->setChildIndex(child,_hx_tmp);
            		}
            		else {
...
HXLINE( 250)		Bool _hx_tmp = (this->_hx___children->length > (int)0);
...
HXLINE( 258)				Bool _hx_tmp1 = hx::IsNotNull( child );
HXDLIN( 258)				if (_hx_tmp1) {
HXLINE( 260)					child->_hx___broadcast(event);
            				}
HXLINE( 264)				if ((i >= this->_hx___children->length)) {
HXLINE( 266)					goto _hx_goto_8;
            				}
HXLINE( 270)				Bool _hx_tmp2 = hx::IsEq( this->_hx___children->__get(i).StaticCast<  ::openfl::_legacy::display::DisplayObject >(),child );
...
Bool DisplayObjectContainer_obj::_hx___contains( ::openfl::_legacy::display::DisplayObject child){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(child,"child")
HXLINE( 293)		Bool _hx_tmp = hx::IsNull( child );
...
HXLINE( 307)					_hx_tmp1 = c->_hx___contains(child);
            				}
            				else {
...
HXLINE( 334)				Bool _hx_tmp = hx::IsNotNull( found );
...
HXLINE( 429)			::String _hx_tmp = child->toString();
HXDLIN( 429)			HX_VARI( ::String,msg) = ((HX_("setChildIndex : object ",93,4a,81,b4) + _hx_tmp) + HX_(" not found.",39,f7,8e,4f));
...
HXLINE( 440)							goto _hx_goto_15;
            						}
            					}
            					_hx_goto_15:;
            				}
HXLINE( 446)				if ((actualIndex != (int)-1)) {
HXLINE( 448)					::String _hx_tmp1 = ::Std_obj::string(actualIndex);
HXDLIN( 448)					hx::AddEq(msg,(HX_("Internal error: Real child index was ",00,bf,50,8a) + _hx_tmp1));
            				}
            				else {
HXLINE( 452)					hx::AddEq(msg,HX_("Internal error: Child was not in __children array!",a1,b9,1b,be));
            				}
            			}
...
HXLINE( 470)				 ::openfl::_legacy::display::DisplayObject _hx_tmp2 = this->_hx___children->__get((i1 - (int)1)).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
HXDLIN( 470)				this->_hx___children[i1] = _hx_tmp2;
HXLINE( 471)				--i1;
            			}
...
HXLINE( 483)					 ::openfl::_legacy::display::DisplayObject _hx_tmp3 = this->_hx___children->__get((i2 + (int)1)).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
HXDLIN( 483)					this->_hx___children[i2] = _hx_tmp3;
HXLINE( 484)					++i2;
            				}
...
HXLINE( 499)			HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__new(HX_("swapChildrenAt : index out of bounds",fd,03,a9,7f)));
            		}
...
HXLINE( 506)			 ::openfl::_legacy::display::DisplayObject _hx_tmp3 = this->_hx___children->__get(index2).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
HXDLIN( 506)			this->_hx___children[index1] = _hx_tmp3;
...
Bool DisplayObjectContainer_obj::get_mouseChildren(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 522)		return ( (Bool)(::openfl::_legacy::display::DisplayObjectContainer_obj::lime_doc_get_mouse_children(this->_hx___handle)) );
            	}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObjectContainer","boot",0x41d3df50,"openfl._legacy.display.DisplayObjectContainer.boot","openfl/_legacy/display/DisplayObjectContainer.hx",543,0xf33fa94b)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObjectContainer","boot",0x41d3df50,"openfl._legacy.display.DisplayObjectContainer.boot","openfl/_legacy/display/DisplayObjectContainer.hx",544,0xf33fa94b)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObjectContainer","boot",0x41d3df50,"openfl._legacy.display.DisplayObjectContainer.boot","openfl/_legacy/display/DisplayObjectContainer.hx",545,0xf33fa94b)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObjectContainer","boot",0x41d3df50,"openfl._legacy.display.DisplayObjectContainer.boot","openfl/_legacy/display/DisplayObjectContainer.hx",546,0xf33fa94b)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObjectContainer","boot",0x41d3df50,"openfl._legacy.display.DisplayObjectContainer.boot","openfl/_legacy/display/DisplayObjectContainer.hx",547,0xf33fa94b)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObjectContainer","boot",0x41d3df50,"openfl._legacy.display.DisplayObjectContainer.boot","openfl/_legacy/display/DisplayObjectContainer.hx",548,0xf33fa94b)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObjectContainer","boot",0x41d3df50,"openfl._legacy.display.DisplayObjectContainer.boot","openfl/_legacy/display/DisplayObjectContainer.hx",549,0xf33fa94b)
