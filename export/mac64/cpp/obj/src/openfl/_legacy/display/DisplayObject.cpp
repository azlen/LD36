...
HXLINE(  63)		::String _hx_tmp = ((type + HX_(" ",20,00,00,00)) + this->_hx___id);
HXDLIN(  63)		this->set_name(_hx_tmp);
            	}
...
hx::ObjectPtr< DisplayObject_obj > DisplayObject_obj::__new( ::Dynamic handle,::String type)
{
	...
	_hx_result->__construct(handle,type);
	return _hx_result;
}
...
HXLINE(  72)		Bool _hx_tmp = event->_hx___getIsCancelled();
HXDLIN(  72)		if (_hx_tmp) {
HXLINE(  73)			return true;
            		}
HXLINE(  75)		Bool _hx_tmp1;
HXDLIN(  75)		Bool _hx_tmp2;
HXDLIN(  75)		Bool _hx_tmp3 = event->get_bubbles();
HXDLIN(  75)		if (_hx_tmp3) {
HXLINE(  75)			 ::openfl::_legacy::display::DisplayObjectContainer _hx_tmp4 = this->get_parent();
HXDLIN(  75)			_hx_tmp2 = hx::IsNotNull( _hx_tmp4 );
            		}
            		else {
HXLINE(  75)			_hx_tmp2 = false;
            		}
HXDLIN(  75)		if (_hx_tmp2) {
HXLINE(  75)			 ::openfl::_legacy::display::DisplayObjectContainer _hx_tmp5 = this->get_parent();
HXDLIN(  75)			_hx_tmp1 = hx::IsNotEq( _hx_tmp5,hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXLINE(  88)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,result) =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
HXLINE(  89)		 ::Dynamic _hx_tmp;
HXDLIN(  89)		Bool _hx_tmp1 = hx::IsNotNull( targetCoordinateSpace );
...
HX_DEFINE_DYNAMIC_FUNC1(DisplayObject_obj,getBounds,return )
 ...
 ::openfl::_legacy::geom::Rectangle DisplayObject_obj::getRect( ::openfl::_legacy::display::DisplayObject targetCoordinateSpace){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(targetCoordinateSpace,"targetCoordinateSpace")
HXLINE(  97)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,result) =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
...
HXDLIN( 115)		Bool _hx_tmp2 = hx::IsNotNull( obj );
HXDLIN( 115)		if (_hx_tmp2) {
HXLINE( 115)			 ::openfl::_legacy::display::DisplayObjectContainer _hx_tmp3 = obj->get_parent();
HXDLIN( 115)			_hx_tmp1 = hx::IsNotNull( _hx_tmp3 );
            		}
            		else {
HXLINE( 115)			_hx_tmp1 = false;
            		}
HXDLIN( 115)		if (_hx_tmp1) {
HXLINE( 115)			 ::openfl::_legacy::display::DisplayObjectContainer _hx_tmp4 = this->get_parent();
HXDLIN( 115)			_hx_tmp = hx::IsNotNull( _hx_tmp4 );
            		}
            		else {
...
HXLINE( 118)			HX_VARI(  ::openfl::_legacy::geom::Rectangle,targetBounds) = obj->getBounds(hx::ObjectPtr<OBJ_>(this));
...
Bool shapeFlag = __o_shapeFlag.Default(false);
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","hitTestPoint",0x063e5f68,"openfl._legacy.display.DisplayObject.hitTestPoint","openfl/_legacy/display/DisplayObject.hx",131,0x32220b70)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(shapeFlag,"shapeFlag")
HXLINE( 131)		return ( (Bool)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_hit_test_point(this->_hx___handle,x,y,shapeFlag,true)) );
            	}
...
::String DisplayObject_obj::toString(){
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","toString",0xb47f33c9,"openfl._legacy.display.DisplayObject.toString","openfl/_legacy/display/DisplayObject.hx",147,0x32220b70)
            	HX_STACK_THIS(this)
...
void DisplayObject_obj::_hx___broadcast( ::openfl::_legacy::events::Event event){
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","__broadcast",0xfe8098e4,"openfl._legacy.display.DisplayObject.__broadcast","openfl/_legacy/display/DisplayObject.hx",161,0x32220b70)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
...
Bool DisplayObject_obj::_hx___dispatchEvent( ::openfl::_legacy::events::Event event){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE( 175)		 ::Dynamic _hx_tmp = event->get_target();
HXDLIN( 175)		Bool _hx_tmp1 = hx::IsNull( _hx_tmp );
...
void DisplayObject_obj::_hx___drawToSurface( ::Dynamic surface, ::openfl::_legacy::geom::Matrix matrix, ::openfl::_legacy::geom::ColorTransform colorTransform,::String blendMode, ::openfl::_legacy::geom::Rectangle clipRect,Bool smoothing){
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","__drawToSurface",0x967fd4b1,"openfl._legacy.display.DisplayObject.__drawToSurface","openfl/_legacy/display/DisplayObject.hx",189,0x32220b70)
            	HX_STACK_THIS(this)
...
HXLINE( 213)		Bool _hx_tmp = hx::IsNotNull( this->_hx___parent );
...
HXLINE( 221)		Bool _hx_tmp1 = (stack->length > (int)0);
...
HXLINE( 231)				Bool _hx_tmp2 = event->_hx___getIsCancelled();
...
HX_DEFINE_DYNAMIC_FUNC1(DisplayObject_obj,_hx___fireEvent,(void))
 ...
 ::openfl::_legacy::geom::ColorTransform DisplayObject_obj::_hx___getColorTransform(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 275)		HX_VARI(  ::openfl::_legacy::geom::ColorTransform,colorTransform) =  ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,_hx___getColorTransform,return )
 ...
 ::openfl::_legacy::geom::ColorTransform DisplayObject_obj::_hx___getConcatenatedColorTransform(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 284)		HX_VARI(  ::openfl::_legacy::geom::ColorTransform,colorTransform) =  ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,_hx___getConcatenatedColorTransform,return )
 ...
 ::openfl::_legacy::geom::Matrix DisplayObject_obj::_hx___getConcatenatedMatrix(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 293)		HX_VARI(  ::openfl::_legacy::geom::Matrix,matrix) =  ::openfl::_legacy::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
...
HXLINE( 304)		Bool _hx_tmp = hx::IsNotNull( interactive );
HXDLIN( 304)		if (_hx_tmp) {
HXLINE( 306)			stack->push(interactive);
            		}
HXLINE( 310)		Bool _hx_tmp1 = hx::IsNotNull( this->_hx___parent );
...
HX_DEFINE_DYNAMIC_FUNC1(DisplayObject_obj,_hx___getInteractiveObjectStack,(void))
 ...
 ::openfl::_legacy::geom::Matrix DisplayObject_obj::_hx___getMatrix(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 321)		HX_VARI(  ::openfl::_legacy::geom::Matrix,matrix) =  ::openfl::_legacy::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
...
void DisplayObject_obj::_hx___getObjectsUnderPoint( ::openfl::_legacy::geom::Point point,::Array< ::Dynamic> result){
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","__getObjectsUnderPoint",0xefd66f93,"openfl._legacy.display.DisplayObject.__getObjectsUnderPoint","openfl/_legacy/display/DisplayObject.hx",330,0x32220b70)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
            	HX_STACK_ARG(result,"result")
HXLINE( 330)		Bool _hx_tmp = ( (Bool)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_hit_test_point(this->_hx___handle,point->x,point->y,true,false)) );
...
HX_DEFINE_DYNAMIC_FUNC2(DisplayObject_obj,_hx___getObjectsUnderPoint,(void))
 ...
 ::openfl::_legacy::geom::Rectangle DisplayObject_obj::_hx___getPixelBounds(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 341)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,bounds) =  ::openfl::_legacy::geom::Rectangle_obj::__new(null(),null(),null(),null());
...
HXLINE( 352)			HX_VARI(  ::openfl::_legacy::events::Event,event) =  ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::ADDED,true,false);
HXLINE( 353)			event->set_target(hx::ObjectPtr<OBJ_>(this));
HXLINE( 354)			this->dispatchEvent(event);
            		}
HXLINE( 358)		if (isOnStage) {
HXLINE( 360)			HX_VARI_NAME(  ::openfl::_legacy::events::Event,event1,"event") =  ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::ADDED_TO_STAGE,false,false);
...
HXLINE( 373)			HX_VARI(  ::openfl::_legacy::events::Event,event) =  ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::REMOVED,true,false);
HXLINE( 374)			event->set_target(hx::ObjectPtr<OBJ_>(this));
HXLINE( 375)			this->dispatchEvent(event);
            		}
HXLINE( 379)		if (wasOnStage) {
HXLINE( 381)			HX_VARI_NAME(  ::openfl::_legacy::events::Event,event1,"event") =  ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::REMOVED_FROM_STAGE,false,false);
...
void DisplayObject_obj::_hx___setColorTransform( ::openfl::_legacy::geom::ColorTransform colorTransform){
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","__setColorTransform",0x4e156fae,"openfl._legacy.display.DisplayObject.__setColorTransform","openfl/_legacy/display/DisplayObject.hx",392,0x32220b70)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(colorTransform,"colorTransform")
...
void DisplayObject_obj::_hx___setMatrix( ::openfl::_legacy::geom::Matrix matrix){
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","__setMatrix",0x3ad6a166,"openfl._legacy.display.DisplayObject.__setMatrix","openfl/_legacy/display/DisplayObject.hx",399,0x32220b70)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(matrix,"matrix")
...
HXLINE( 412)		Bool _hx_tmp = hx::IsNotNull( this->_hx___parent );
HXDLIN( 412)		if (_hx_tmp) {
HXLINE( 414)			this->_hx___parent->_hx___removeChildFromArray(hx::ObjectPtr<OBJ_>(this));
HXLINE( 415)			 ::openfl::_legacy::display::Stage _hx_tmp1 = this->get_stage();
HXDLIN( 415)			Bool _hx_tmp2 = hx::IsNotNull( _hx_tmp1 );
HXDLIN( 415)			this->_hx___onRemoved(hx::ObjectPtr<OBJ_>(this),_hx_tmp2);
            		}
HXLINE( 419)		this->_hx___parent = parent;
HXLINE( 421)		Bool _hx_tmp3 = hx::IsNotNull( parent );
HXDLIN( 421)		if (_hx_tmp3) {
HXLINE( 423)			 ::openfl::_legacy::display::Stage _hx_tmp4 = this->get_stage();
HXDLIN( 423)			Bool _hx_tmp5 = hx::IsNotNull( _hx_tmp4 );
HXDLIN( 423)			this->_hx___onAdded(hx::ObjectPtr<OBJ_>(this),_hx_tmp5);
            		}
...
Float DisplayObject_obj::get_alpha(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 439)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_alpha(this->_hx___handle)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,get_opaqueBackground,return )
 ...
 ::Dynamic DisplayObject_obj::set_opaqueBackground( ::Dynamic value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 465)		Bool _hx_tmp = hx::IsNull( value );
...
::hx::EnumBase DisplayObject_obj::get_blendMode(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 482)		HX_VARI( Int,i) = ( (Int)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_blend_mode(this->_hx___handle)) );
...
::hx::EnumBase DisplayObject_obj::set_blendMode(::hx::EnumBase value){
...
HXDLIN( 490)		Int _hx_tmp1 = ( ( ::hx::EnumBase)(value) )->_hx_getIndex();
...
Bool DisplayObject_obj::get_cacheAsBitmap(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 496)		return ( (Bool)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_cache_as_bitmap(this->_hx___handle)) );
            	}
...
Bool DisplayObject_obj::get_pedanticBitmapCaching(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 505)		return ( (Bool)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_pedantic_bitmap_caching(this->_hx___handle)) );
            	}
...
::Array< ::Dynamic> DisplayObject_obj::get_filters(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 516)		Bool _hx_tmp = hx::IsNull( this->_hx___filters );
...
HXDLIN( 519)				++_g;
HXLINE( 521)				 ::Dynamic _hx_tmp1 =  ::Dynamic(filter->__Field(HX_("clone",5d,13,63,48),hx::paccDynamic))();
HXDLIN( 521)				result->push(_hx_tmp1);
            			}
            		}
...
HXDLIN( 532)		::Array< ::Dynamic> _hx_tmp1 = this->get_filters();
HXDLIN( 532)		Bool _hx_tmp2 = hx::IsNotNull( _hx_tmp1 );
...
HXDLIN( 540)					++_g;
HXLINE( 542)					Bool _hx_tmp3 = hx::IsNotNull( filter );
HXDLIN( 542)					if (_hx_tmp3) {
HXLINE( 544)						 ::openfl::_legacy::filters::BitmapFilter _hx_tmp4 = ( ( ::openfl::_legacy::filters::BitmapFilter)(filter) )->clone();
HXDLIN( 544)						this->_hx___filters->push(_hx_tmp4);
            					}
            				}
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(DisplayObject_obj,set_filters,return )
 ...
 ::openfl::_legacy::display::Graphics DisplayObject_obj::get_graphics(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 560)		Bool _hx_tmp = hx::IsNull( this->_hx___graphicsCache );
HXDLIN( 560)		if (_hx_tmp) {
HXLINE( 562)			 ::Dynamic _hx_tmp1 = ::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_graphics(this->_hx___handle);
HXDLIN( 562)			this->_hx___graphicsCache =  ::openfl::_legacy::display::Graphics_obj::__new(_hx_tmp1);
            		}
...
Float DisplayObject_obj::get_height(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 571)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_height(this->_hx___handle)) );
            	}
...
HXDLIN( 583)		Bool _hx_tmp1 = hx::IsNull( value );
...
Float DisplayObject_obj::get_mouseX(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 589)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_mouse_x(this->_hx___handle)) );
            	}
...
Float DisplayObject_obj::get_mouseY(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 590)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_mouse_y(this->_hx___handle)) );
            	}
...
::String DisplayObject_obj::get_name(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 593)		return ( (::String)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_name(this->_hx___handle)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,get_parent,return )
 ...
 ::openfl::_legacy::display::DisplayObject DisplayObject_obj::get_root(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 607)		 ::openfl::_legacy::display::Stage _hx_tmp = this->get_stage();
HXDLIN( 607)		Bool _hx_tmp1 = hx::IsNotNull( _hx_tmp );
...
Float DisplayObject_obj::get_rotation(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 618)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_rotation(this->_hx___handle)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(DisplayObject_obj,set_rotation,return )
 ...
 ::openfl::_legacy::geom::Rectangle DisplayObject_obj::get_scale9Grid(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 627)		Bool _hx_tmp = hx::IsNull( this->_hx___scale9Grid );
...
HXDLIN( 630)		Bool _hx_tmp1 = hx::IsNull( value );
...
Float DisplayObject_obj::get_scaleX(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 637)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_scale_x(this->_hx___handle)) );
            	}
...
Float DisplayObject_obj::get_scaleY(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 646)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_scale_y(this->_hx___handle)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(DisplayObject_obj,set_scaleY,return )
 ...
 ::openfl::_legacy::geom::Rectangle DisplayObject_obj::get_scrollRect(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 655)		Bool _hx_tmp = hx::IsNull( this->_hx___scrollRect );
...
HXDLIN( 658)		Bool _hx_tmp1 = hx::IsNull( value );
...
HX_DEFINE_DYNAMIC_FUNC1(DisplayObject_obj,set_scrollRect,return )
 ...
 ::openfl::_legacy::display::Stage DisplayObject_obj::get_stage(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 667)		Bool _hx_tmp = hx::IsNotNull( this->_hx___parent );
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,get_stage,return )
 ...
 ::openfl::_legacy::geom::Transform DisplayObject_obj::get_transform(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 678)		return  ::openfl::_legacy::geom::Transform_obj::__new(hx::ObjectPtr<OBJ_>(this));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,get_transform,return )
 ...
 ::openfl::_legacy::geom::Transform DisplayObject_obj::set_transform( ::openfl::_legacy::geom::Transform value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 681)		 ::openfl::_legacy::geom::Matrix _hx_tmp = value->get_matrix();
HXDLIN( 681)		this->_hx___setMatrix(_hx_tmp);
HXLINE( 682)		 ::openfl::_legacy::geom::ColorTransform _hx_tmp1 = value->get_colorTransform();
HXDLIN( 682)		this->_hx___setColorTransform(_hx_tmp1);
...
Bool DisplayObject_obj::get_visible(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 688)		return ( (Bool)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_visible(this->_hx___handle)) );
            	}
...
Float DisplayObject_obj::get_width(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 697)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_width(this->_hx___handle)) );
            	}
...
Float DisplayObject_obj::get_x(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 706)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_x(this->_hx___handle)) );
            	}
...
Float DisplayObject_obj::get_y(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 715)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_y(this->_hx___handle)) );
            	}
...
Float DisplayObject_obj::get_z(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 724)		return ( (Float)(::openfl::_legacy::display::DisplayObject_obj::lime_display_object_get_z(this->_hx___handle)) );
            	}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",740,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",741,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",742,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",743,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",744,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",745,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",746,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",747,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",748,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",749,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",750,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",751,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",752,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",753,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",754,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",755,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",756,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",757,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",758,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",759,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",760,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",761,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",762,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",763,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",764,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",765,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",766,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",767,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",768,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",769,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",770,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",771,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",772,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",773,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",774,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",775,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",776,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",777,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",778,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",779,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",780,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",781,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",782,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",783,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",784,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",785,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",786,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",787,0x32220b70)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DisplayObject","boot",0xbd5ad4cf,"openfl._legacy.display.DisplayObject.boot","openfl/_legacy/display/DisplayObject.hx",788,0x32220b70)
