...
HXLINE(  15)		 ::Dynamic _hx_tmp = ::openfl::_legacy::display::DirectRenderer_obj::lime_direct_renderer_create();
HXDLIN(  15)		super::__construct(_hx_tmp,type);
...
hx::ObjectPtr< DirectRenderer_obj > DirectRenderer_obj::__new(::String __o_type)
{
	...
	_hx_result->__construct(__o_type);
	return _hx_result;
}
...
void _hx_run( ::openfl::_legacy::geom::Rectangle rect){
            	HX_STACK_FRAME("openfl._legacy.display.DirectRenderer","__default_render",0xd1b3c8e6,"openfl._legacy.display.DirectRenderer.__default_render","openfl/_legacy/display/DirectRenderer.hx",31,0x206ed89f)
            	HX_STACK_THIS(this)
...
void DirectRenderer_obj::_hx___onRender( ::Dynamic rect){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(rect,"rect")
HXLINE(  40)		Bool _hx_tmp = hx::IsNotNull( this->render );
HXDLIN(  40)		if (_hx_tmp) {
HXLINE(  40)			this->render( ::openfl::_legacy::geom::Rectangle_obj::__new( ::Dynamic(rect->__Field(HX_("x",78,00,00,00),hx::paccDynamic)), ::Dynamic(rect->__Field(HX_("y",79,00,00,00),hx::paccDynamic)), ::Dynamic(rect->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(rect->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic))));
            		}
            	}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.display.DirectRenderer","boot",0xc5f630a4,"openfl._legacy.display.DirectRenderer.boot","openfl/_legacy/display/DirectRenderer.hx",73,0x206ed89f)
...
{
            	HX_STACK_FRAME("openfl._legacy.display.DirectRenderer","boot",0xc5f630a4,"openfl._legacy.display.DirectRenderer.boot","openfl/_legacy/display/DirectRenderer.hx",74,0x206ed89f)
