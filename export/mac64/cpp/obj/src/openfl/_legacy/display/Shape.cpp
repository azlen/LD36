...
void Shape_obj::__construct(){
            	HX_STACK_FRAME("openfl._legacy.display.Shape","new",0x7a3e5ae3,"openfl._legacy.display.Shape.new","openfl/_legacy/display/Shape.hx",9,0xc6ca47f0)
            	HX_STACK_THIS(this)
HXLINE(   9)		 ::Dynamic _hx_tmp = ::openfl::_legacy::display::DisplayObject_obj::lime_create_display_object();
HXDLIN(   9)		super::__construct(_hx_tmp,HX_("Shape",01,53,4a,0f));
            	}
