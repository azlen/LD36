...
HXLINE(  74)		Int _hx_tmp = extension.indexOf(HX_("?",3f,00,00,00),null());
HXDLIN(  74)		if ((_hx_tmp != (int)-1)) {
HXLINE(  75)			::Array< ::String > _hx_tmp1 = extension.split(HX_("?",3f,00,00,00));
HXDLIN(  75)			extension = _hx_tmp1->__get((int)0);
            		}
HXLINE(  77)		::String _hx_tmp2;
HXDLIN(  77)		::String _hx_switch_0 = extension;
            		if (  (_hx_switch_0==HX_("gif",04,84,4e,00)) ){
HXLINE(  77)			_hx_tmp2 = HX_("image/gif",10,f4,ba,16);
HXDLIN(  77)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("jpeg",a8,f2,65,46)) ||  (_hx_switch_0==HX_("jpg",e1,d0,50,00)) ){
HXLINE(  77)			_hx_tmp2 = HX_("image/jpeg",1c,8d,db,ce);
HXDLIN(  77)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("png",a9,5c,55,00)) ){
HXLINE(  77)			_hx_tmp2 = HX_("image/png",b5,cc,c1,16);
HXDLIN(  77)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("swf",42,ab,57,00)) ){
HXLINE(  77)			_hx_tmp2 = HX_("application/x-shockwave-flash",ea,f3,47,4a);
HXDLIN(  77)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE(  77)			_hx_tmp2 = HX_("application/octet-stream",5d,f8,82,30);
            		}
            		_hx_goto_0:;
HXDLIN(  77)		this->contentType = _hx_tmp2;
...
HX_DEFINE_DYNAMIC_FUNC1(LoaderInfo_obj,this_onComplete,(void))
 ...
 ::openfl::_legacy::utils::ByteArray LoaderInfo_obj::get_bytes(){
            	HX_STACK_FRAME("openfl._legacy.display.LoaderInfo","get_bytes",0x13e243e5,"openfl._legacy.display.LoaderInfo.get_bytes","openfl/_legacy/display/LoaderInfo.hx",118,0xb6d254aa)
            	HX_STACK_THIS(this)
...
HXLINE(  52)		HX_VARI(  ::openfl::_legacy::display::LoaderInfo,loaderInfo) =  ::openfl::_legacy::display::LoaderInfo_obj::__new();
HXLINE(  53)		loaderInfo->loader = loader;
HXLINE(  54)		loaderInfo->uncaughtErrorEvents =  ::openfl::events::UncaughtErrorEvents_obj::__new();
...
HXLINE(  57)		Bool _hx_tmp = hx::IsNull( loader );
