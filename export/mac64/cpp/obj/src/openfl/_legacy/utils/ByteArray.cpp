...
void ByteArray_obj::__init__(){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::openfl::_legacy::utils::ByteArray _hx_run(Int length){
            			HX_STACK_FRAME("::openfl::_legacy::utils::ByteArray_obj","__init__",0xc123b6ee,"::openfl::_legacy::utils::ByteArray_obj.__init__","openfl/_legacy/utils/ByteArray.hx",744,0x6d362251)
            			HX_STACK_ARG(length,"length")
HXLINE( 744)			return  ::openfl::_legacy::utils::ByteArray_obj::__new(length);
            		}
            		...
            		void _hx_run( ::openfl::_legacy::utils::ByteArray bytes,Int length1){
            			HX_STACK_FRAME("::openfl::_legacy::utils::ByteArray_obj","__init__",0xc123b6ee,"::openfl::_legacy::utils::ByteArray_obj.__init__","openfl/_legacy/utils/ByteArray.hx",745,0x6d362251)
...
HXLINE( 753)			bytes->length = length1;
            		...
            		::Array< unsigned char > _hx_run( ::openfl::_legacy::utils::ByteArray bytes2){
            			HX_STACK_FRAME("::openfl::_legacy::utils::ByteArray_obj","__init__",0xc123b6ee,"::openfl::_legacy::utils::ByteArray_obj.__init__","openfl/_legacy/utils/ByteArray.hx",757,0x6d362251)
            			HX_STACK_ARG(bytes2,"bytes2")
HXLINE( 757)			Bool _hx_tmp = hx::IsNull( bytes2 );
...
HXDLIN( 757)			return null();
            		...
            		Int _hx_run( ::openfl::_legacy::utils::ByteArray bytes3){
            			HX_STACK_FRAME("::openfl::_legacy::utils::ByteArray_obj","__init__",0xc123b6ee,"::openfl::_legacy::utils::ByteArray_obj.__init__","openfl/_legacy/utils/ByteArray.hx",758,0x6d362251)
            			HX_STACK_ARG(bytes3,"bytes3")
HXLINE( 758)			Bool _hx_tmp1 = hx::IsNull( bytes3 );
...
HXDLIN( 758)			return (int)0;
            	...
            	HX_STACK_FRAME("::openfl::_legacy::utils::ByteArray_obj","__init__",0xc123b6ee,"::openfl::_legacy::utils::ByteArray_obj.__init__","openfl/_legacy/utils/ByteArray.hx",742,0x6d362251)
...
::String ByteArray_obj::asString(){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","asString",0xb4fe6e21,"openfl._legacy.utils.ByteArray.asString","openfl/_legacy/utils/ByteArray.hx",81,0x6d362251)
            	HX_STACK_THIS(this)
...
void ByteArray_obj::checkData(Int length){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","checkData",0xda7e4a94,"openfl._legacy.utils.ByteArray.checkData","openfl/_legacy/utils/ByteArray.hx",88,0x6d362251)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
HXLINE(  88)		Bool _hx_tmp = ((length + this->position) > this->length);
...
void ByteArray_obj::compress(::hx::EnumBase algorithm){
...
HXLINE( 113)		Bool _hx_tmp = hx::IsNull( algorithm );
...
HXLINE( 123)			::Array< unsigned char > _hx_tmp1 = ( (::Array< unsigned char >)(::openfl::_legacy::utils::ByteArray_obj::lime_lzma_encode(src->b)) );
HXDLIN( 123)			result = ::haxe::io::Bytes_obj::ofData(_hx_tmp1);
            		}
            		else {
HXLINE( 127)			Bool _hx_tmp2 = hx::IsNull( algorithm );
HXDLIN( 127)			if (!(_hx_tmp2)) {
HXLINE( 127)				Int _hx_tmp3 = ( ( ::hx::EnumBase)(algorithm) )->_hx_getIndex();
HXDLIN( 127)				switch((int)(_hx_tmp3)){
            					case (int)0: {
            					}
            					break;
            					case (int)3: {
...
Int ByteArray_obj::getLength(){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","getLength",0x5f99499e,"openfl._legacy.utils.ByteArray.getLength","openfl/_legacy/utils/ByteArray.hx",207,0x6d362251)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(ByteArray_obj,getLength,return )
 ...
 ::Dynamic ByteArray_obj::getNativePointer(){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","getNativePointer",0x8841622e,"openfl._legacy.utils.ByteArray.getNativePointer","openfl/_legacy/utils/ByteArray.hx",214,0x6d362251)
            	HX_STACK_THIS(this)
...
Bool ByteArray_obj::readBoolean(){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","readBoolean",0xfae90df4,"openfl._legacy.utils.ByteArray.readBoolean","openfl/_legacy/utils/ByteArray.hx",235,0x6d362251)
            	HX_STACK_THIS(this)
HXLINE( 235)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 235)		if (_hx_tmp) {
HXLINE( 235)			Int pos = this->position++;
HXDLIN( 235)			return (this->b->__get(pos) != (int)0);
            		}
            		else {
HXLINE( 235)			Int _hx_tmp1 = this->_hx___throwEOFi();
HXDLIN( 235)			return (_hx_tmp1 != (int)0);
            		}
...
HXDLIN( 242)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 242)		if (_hx_tmp) {
HXLINE( 242)			Int pos = this->position++;
HXDLIN( 242)			value = this->b->__get(pos);
            		}
            		else {
...
Int length = __o_length.Default(0);
            	...
            	HX_STACK_ARG(length,"length")
HXLINE( 250)		Bool _hx_tmp = (length == (int)0);
HXDLIN( 250)		if (_hx_tmp) {
HXLINE( 252)			length = (this->length - this->position);
            		}
HXLINE( 256)		Bool _hx_tmp1 = ((this->position + length) > this->length);
HXDLIN( 256)		if (_hx_tmp1) {
HXLINE( 258)			this->_hx___throwEOFi();
            		}
HXLINE( 262)		Bool _hx_tmp2 = (data->length < (offset + length));
...
HXLINE( 276)				Int _hx_tmp3 = (offset + i);
HXDLIN( 276)				unsigned char _hx_tmp4 = b1->__get((p + i));
HXDLIN( 276)				b2[_hx_tmp3] = _hx_tmp4;
            			}
            		}
HXLINE( 281)		hx::AddEq(this->position,length);
            	}
...
Float ByteArray_obj::readDouble(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 288)		Bool _hx_tmp = ((this->position + (int)8) > this->length);
HXDLIN( 288)		if (_hx_tmp) {
HXLINE( 290)			this->_hx___throwEOFi();
            		}
HXLINE( 297)		Int _hx_tmp1 = this->position;
HXDLIN( 297)		Int _hx_tmp2 = (this->position + (int)8);
HXDLIN( 297)		::Array< unsigned char > _hx_tmp3 = this->b->slice(_hx_tmp1,_hx_tmp2);
HXDLIN( 297)		HX_VARI(  ::haxe::io::Bytes,bytes) =  ::haxe::io::Bytes_obj::__new((int)8,_hx_tmp3);
HXLINE( 306)		hx::AddEq(this->position,(int)8);
HXLINE( 307)		return ( (Float)(::openfl::_legacy::utils::ByteArray_obj::_double_of_bytes(bytes->b,this->bigEndian)) );
            	}
...
Float ByteArray_obj::readFloat(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 325)		Bool _hx_tmp = ((this->position + (int)4) > this->length);
HXDLIN( 325)		if (_hx_tmp) {
HXLINE( 327)			this->_hx___throwEOFi();
            		}
HXLINE( 334)		Int _hx_tmp1 = this->position;
HXDLIN( 334)		Int _hx_tmp2 = (this->position + (int)4);
HXDLIN( 334)		::Array< unsigned char > _hx_tmp3 = this->b->slice(_hx_tmp1,_hx_tmp2);
HXDLIN( 334)		HX_VARI(  ::haxe::io::Bytes,bytes) =  ::haxe::io::Bytes_obj::__new((int)4,_hx_tmp3);
HXLINE( 343)		hx::AddEq(this->position,(int)4);
HXLINE( 344)		return ( (Float)(::openfl::_legacy::utils::ByteArray_obj::_float_of_bytes(bytes->b,this->bigEndian)) );
            	}
...
HXDLIN( 351)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 351)		if (_hx_tmp) {
HXLINE( 351)			Int pos = this->position++;
HXDLIN( 351)			ch1 = this->b->__get(pos);
            		}
            		else {
HXLINE( 351)			ch1 = this->_hx___throwEOFi();
            		}
HXLINE( 352)		HX_VAR( Int,ch2);
HXDLIN( 352)		Bool _hx_tmp1 = (this->position < this->length);
HXDLIN( 352)		if (_hx_tmp1) {
HXLINE( 352)			Int pos1 = this->position++;
HXDLIN( 352)			ch2 = this->b->__get(pos1);
            		}
            		else {
HXLINE( 352)			ch2 = this->_hx___throwEOFi();
            		}
HXLINE( 353)		HX_VAR( Int,ch3);
HXDLIN( 353)		Bool _hx_tmp2 = (this->position < this->length);
HXDLIN( 353)		if (_hx_tmp2) {
HXLINE( 353)			Int pos2 = this->position++;
HXDLIN( 353)			ch3 = this->b->__get(pos2);
            		}
            		else {
HXLINE( 353)			ch3 = this->_hx___throwEOFi();
            		}
HXLINE( 354)		HX_VAR( Int,ch4);
HXDLIN( 354)		Bool _hx_tmp3 = (this->position < this->length);
HXDLIN( 354)		if (_hx_tmp3) {
HXLINE( 354)			Int pos3 = this->position++;
HXDLIN( 354)			ch4 = this->b->__get(pos3);
            		}
            		else {
...
::String ByteArray_obj::readMultiByte(Int length,::String charSet){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","readMultiByte",0xa88d946d,"openfl._legacy.utils.ByteArray.readMultiByte","openfl/_legacy/utils/ByteArray.hx",363,0x6d362251)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
...
void ByteArray_obj::writeMultiByte(::String value,::String charSet){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","writeMultiByte",0xc4f34280,"openfl._legacy.utils.ByteArray.writeMultiByte","openfl/_legacy/utils/ByteArray.hx",368,0x6d362251)
            	HX_STACK_THIS(this)
...
HXDLIN( 373)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 373)		if (_hx_tmp) {
HXLINE( 373)			Int pos = this->position++;
HXDLIN( 373)			ch1 = this->b->__get(pos);
            		}
            		else {
HXLINE( 373)			ch1 = this->_hx___throwEOFi();
            		}
HXLINE( 374)		HX_VAR( Int,ch2);
HXDLIN( 374)		Bool _hx_tmp1 = (this->position < this->length);
HXDLIN( 374)		if (_hx_tmp1) {
HXLINE( 374)			Int pos1 = this->position++;
HXDLIN( 374)			ch2 = this->b->__get(pos1);
            		}
            		else {
...
Int ByteArray_obj::readUnsignedByte(){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","readUnsignedByte",0xa9bc33d1,"openfl._legacy.utils.ByteArray.readUnsignedByte","openfl/_legacy/utils/ByteArray.hx",385,0x6d362251)
            	HX_STACK_THIS(this)
HXLINE( 385)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 385)		if (_hx_tmp) {
HXLINE( 385)			Int pos = this->position++;
HXDLIN( 385)			return this->b->__get(pos);
            		}
            		else {
...
HXDLIN( 392)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 392)		if (_hx_tmp) {
HXLINE( 392)			Int pos = this->position++;
HXDLIN( 392)			ch1 = this->b->__get(pos);
            		}
            		else {
HXLINE( 392)			ch1 = this->_hx___throwEOFi();
            		}
HXLINE( 393)		HX_VAR( Int,ch2);
HXDLIN( 393)		Bool _hx_tmp1 = (this->position < this->length);
HXDLIN( 393)		if (_hx_tmp1) {
HXLINE( 393)			Int pos1 = this->position++;
HXDLIN( 393)			ch2 = this->b->__get(pos1);
            		}
            		else {
HXLINE( 393)			ch2 = this->_hx___throwEOFi();
            		}
HXLINE( 394)		HX_VAR( Int,ch3);
HXDLIN( 394)		Bool _hx_tmp2 = (this->position < this->length);
HXDLIN( 394)		if (_hx_tmp2) {
HXLINE( 394)			Int pos2 = this->position++;
HXDLIN( 394)			ch3 = this->b->__get(pos2);
            		}
            		else {
HXLINE( 394)			ch3 = this->_hx___throwEOFi();
            		}
HXLINE( 395)		HX_VAR( Int,ch4);
HXDLIN( 395)		Bool _hx_tmp3 = (this->position < this->length);
HXDLIN( 395)		if (_hx_tmp3) {
HXLINE( 395)			Int pos3 = this->position++;
HXDLIN( 395)			ch4 = this->b->__get(pos3);
            		}
            		else {
...
HXDLIN( 404)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 404)		if (_hx_tmp) {
HXLINE( 404)			Int pos = this->position++;
HXDLIN( 404)			ch1 = this->b->__get(pos);
            		}
            		else {
HXLINE( 404)			ch1 = this->_hx___throwEOFi();
            		}
HXLINE( 405)		HX_VAR( Int,ch2);
HXDLIN( 405)		Bool _hx_tmp1 = (this->position < this->length);
HXDLIN( 405)		if (_hx_tmp1) {
HXLINE( 405)			Int pos1 = this->position++;
HXDLIN( 405)			ch2 = this->b->__get(pos1);
            		}
            		else {
...
::String ByteArray_obj::readUTF(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 414)		HX_VARI( Int,len) = this->readUnsignedShort();
...
::String ByteArray_obj::readUTFBytes(Int length){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
HXLINE( 422)		Bool _hx_tmp = ((this->position + length) > this->length);
HXDLIN( 422)		if (_hx_tmp) {
HXLINE( 424)			this->_hx___throwEOFi();
            		}
HXLINE( 428)		HX_VARI( Int,p) = this->position;
HXLINE( 429)		hx::AddEq(this->position,length);
...
HXLINE( 465)		Bool _hx_tmp = (begin < (int)0);
HXDLIN( 465)		if (_hx_tmp) {
HXLINE( 467)			hx::AddEq(begin,this->length);
HXLINE( 469)			Bool _hx_tmp1 = (begin < (int)0);
HXDLIN( 469)			if (_hx_tmp1) {
HXLINE( 471)				begin = (int)0;
            			}
            		}
HXLINE( 477)		Bool _hx_tmp2 = hx::IsNull( end );
HXDLIN( 477)		if (_hx_tmp2) {
HXLINE( 479)			end = this->length;
            		}
HXLINE( 483)		Bool _hx_tmp3 = hx::IsLess( end,(int)0 );
HXDLIN( 483)		if (_hx_tmp3) {
HXLINE( 485)			hx::AddEq(end,this->length);
HXLINE( 487)			Bool _hx_tmp4 = hx::IsLess( end,(int)0 );
HXDLIN( 487)			if (_hx_tmp4) {
HXLINE( 489)				end = (int)0;
            			}
            		}
HXLINE( 495)		if (hx::IsGreaterEq( begin,end )) {
HXLINE( 497)			return  ::openfl::_legacy::utils::ByteArray_obj::__new(null());
            		}
HXLINE( 501)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,result) =  ::openfl::_legacy::utils::ByteArray_obj::__new((end - begin));
...
void ByteArray_obj::uncompress(::hx::EnumBase algorithm){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(algorithm,"algorithm")
HXLINE( 513)		Bool _hx_tmp = hx::IsNull( algorithm );
...
HXLINE( 525)			::Array< unsigned char > _hx_tmp1 = ( (::Array< unsigned char >)(::openfl::_legacy::utils::ByteArray_obj::lime_lzma_decode(src->b)) );
HXDLIN( 525)			result = ::haxe::io::Bytes_obj::ofData(_hx_tmp1);
            		}
            		else {
HXLINE( 529)			Bool _hx_tmp2 = hx::IsNull( algorithm );
HXDLIN( 529)			if (!(_hx_tmp2)) {
HXLINE( 529)				Int _hx_tmp3 = ( ( ::hx::EnumBase)(algorithm) )->_hx_getIndex();
HXDLIN( 529)				switch((int)(_hx_tmp3)){
            					case (int)0: {
            					}
            					break;
            					case (int)3: {
...
void ByteArray_obj::write_uncheck(Int byte){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","write_uncheck",0xf8b3e1b1,"openfl._legacy.utils.ByteArray.write_uncheck","openfl/_legacy/utils/ByteArray.hx",558,0x6d362251)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(byte,"byte")
HXLINE( 558)		this->b->__unsafe_set(this->position++,byte);
            	}
...
HXLINE( 585)		this->b[this->position++] = value;
            	}
...
Int length = __o_length.Default(0);
            	...
            	HX_STACK_ARG(offset,"offset")
            	HX_STACK_ARG(length,"length")
HXLINE( 595)		Bool _hx_tmp = (length == (int)0);
HXDLIN( 595)		if (_hx_tmp) {
HXLINE( 595)			length = (bytes->length - offset);
            		}
HXLINE( 596)		Int _hx_tmp1 = ((this->position + length) - (int)1);
HXDLIN( 596)		this->ensureElem(_hx_tmp1,true);
HXLINE( 597)		HX_VARI( Int,opos) = this->position;
HXLINE( 598)		hx::AddEq(this->position,length);
...
void ByteArray_obj::writeDouble(Float x){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 609)		::Array< unsigned char > _hx_tmp = ( (::Array< unsigned char >)(::openfl::_legacy::utils::ByteArray_obj::_double_bytes(x,this->bigEndian)) );
HXLINE( 612)		this->writeBytes(::haxe::io::Bytes_obj::ofData(_hx_tmp),(int)0,(int)0);
            	}
...
void ByteArray_obj::writeFile(::String path){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","writeFile",0x90aaee7d,"openfl._legacy.utils.ByteArray.writeFile","openfl/_legacy/utils/ByteArray.hx",621,0x6d362251)
            	HX_STACK_THIS(this)
...
void ByteArray_obj::writeFloat(Float x){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE( 631)		::Array< unsigned char > _hx_tmp = ( (::Array< unsigned char >)(::openfl::_legacy::utils::ByteArray_obj::_float_bytes(x,this->bigEndian)) );
HXLINE( 636)		this->writeBytes(::haxe::io::Bytes_obj::ofData(_hx_tmp),(int)0,(int)0);
            	}
...
void ByteArray_obj::writeInt(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 643)		Int _hx_tmp = (this->position + (int)3);
HXDLIN( 643)		this->ensureElem(_hx_tmp,true);
HXLINE( 645)		Bool _hx_tmp1 = this->bigEndian;
HXDLIN( 645)		if (_hx_tmp1) {
HXLINE( 647)			Int _hx_tmp2 = this->position++;
HXDLIN( 647)			this->b->__unsafe_set(_hx_tmp2,((int)value >> (int)(int)24));
HXLINE( 648)			Int _hx_tmp3 = this->position++;
HXDLIN( 648)			this->b->__unsafe_set(_hx_tmp3,((int)value >> (int)(int)16));
HXLINE( 649)			Int _hx_tmp4 = this->position++;
HXDLIN( 649)			this->b->__unsafe_set(_hx_tmp4,((int)value >> (int)(int)8));
HXLINE( 650)			this->b->__unsafe_set(this->position++,value);
            		}
            		else {
HXLINE( 654)			this->b->__unsafe_set(this->position++,value);
HXLINE( 655)			Int _hx_tmp5 = this->position++;
HXDLIN( 655)			this->b->__unsafe_set(_hx_tmp5,((int)value >> (int)(int)8));
HXLINE( 656)			Int _hx_tmp6 = this->position++;
HXDLIN( 656)			this->b->__unsafe_set(_hx_tmp6,((int)value >> (int)(int)16));
HXLINE( 657)			Int _hx_tmp7 = this->position++;
HXDLIN( 657)			this->b->__unsafe_set(_hx_tmp7,((int)value >> (int)(int)24));
            		}
            	}
...
void ByteArray_obj::writeShort(Int value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 666)		Int _hx_tmp = (this->position + (int)1);
HXDLIN( 666)		this->ensureElem(_hx_tmp,true);
HXLINE( 668)		Bool _hx_tmp1 = this->bigEndian;
HXDLIN( 668)		if (_hx_tmp1) {
HXLINE( 670)			Int _hx_tmp2 = this->position++;
HXDLIN( 670)			this->b->__unsafe_set(_hx_tmp2,((int)value >> (int)(int)8));
HXLINE( 671)			this->b->__unsafe_set(this->position++,value);
            		}
            		else {
HXLINE( 675)			this->b->__unsafe_set(this->position++,value);
HXLINE( 676)			Int _hx_tmp3 = this->position++;
HXDLIN( 676)			this->b->__unsafe_set(_hx_tmp3,((int)value >> (int)(int)8));
            		}
            	}
...
void ByteArray_obj::writeUnsignedInt(Int value){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","writeUnsignedInt",0x245efd19,"openfl._legacy.utils.ByteArray.writeUnsignedInt","openfl/_legacy/utils/ByteArray.hx",685,0x6d362251)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
...
void ByteArray_obj::writeUTFBytes(::String s){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","writeUTFBytes",0x6d3f8e45,"openfl._legacy.utils.ByteArray.writeUTFBytes","openfl/_legacy/utils/ByteArray.hx",712,0x6d362251)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
Int ByteArray_obj::__get(Int pos){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","__get",0x4ac5a3f8,"openfl._legacy.utils.ByteArray.__get","openfl/_legacy/utils/ByteArray.hx",732,0x6d362251)
            	HX_STACK_THIS(this)
...
void ByteArray_obj::__set(Int pos,Int v){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","__set",0x4acebf04,"openfl._legacy.utils.ByteArray.__set","openfl/_legacy/utils/ByteArray.hx",771,0x6d362251)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pos,"pos")
            	HX_STACK_ARG(v,"v")
...
void ByteArray_obj::_hx___resize(Int length){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","__resize",0xc5a2ffd2,"openfl._legacy.utils.ByteArray.__resize","openfl/_legacy/utils/ByteArray.hx",781,0x6d362251)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
...
Int ByteArray_obj::_hx___throwEOFi(){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","__throwEOFi",0xc2bfa955,"openfl._legacy.utils.ByteArray.__throwEOFi","openfl/_legacy/utils/ByteArray.hx",788,0x6d362251)
            	HX_STACK_THIS(this)
HXLINE( 788)		HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__new());
...
HX_DEFINE_DYNAMIC_FUNC1(ByteArray_obj,set___length,return )
 ...
 ::openfl::_legacy::utils::ByteArray ByteArray_obj::fromBytes( ::haxe::io::Bytes bytes){
            	...
            	HX_STACK_ARG(bytes,"bytes")
HXLINE( 191)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,result) =  ::openfl::_legacy::utils::ByteArray_obj::__new((int)-1);
HXLINE( 192)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArray_obj,fromBytes,return )
 ...
 ::openfl::_legacy::utils::ByteArray ByteArray_obj::readFile(::String path){
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","readFile",0x80abe3b0,"openfl._legacy.utils.ByteArray.readFile","openfl/_legacy/utils/ByteArray.hx",316,0x6d362251)
            	HX_STACK_ARG(path,"path")
HXLINE( 316)		return ( ( ::openfl::_legacy::utils::ByteArray)(::openfl::_legacy::utils::ByteArray_obj::lime_byte_array_read_file(path)) );
            	}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","boot",0x25f407f0,"openfl._legacy.utils.ByteArray.boot","openfl/_legacy/utils/ByteArray.hx",816,0x6d362251)
HXLINE( 816)		_double_bytes = ::openfl::_legacy::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("double_bytes",7d,9d,69,74),(int)2);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","boot",0x25f407f0,"openfl._legacy.utils.ByteArray.boot","openfl/_legacy/utils/ByteArray.hx",817,0x6d362251)
HXLINE( 817)		_double_of_bytes = ::openfl::_legacy::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("double_of_bytes",31,7e,6b,42),(int)2);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","boot",0x25f407f0,"openfl._legacy.utils.ByteArray.boot","openfl/_legacy/utils/ByteArray.hx",818,0x6d362251)
HXLINE( 818)		_float_bytes = ::openfl::_legacy::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("float_bytes",48,32,0c,2c),(int)2);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","boot",0x25f407f0,"openfl._legacy.utils.ByteArray.boot","openfl/_legacy/utils/ByteArray.hx",819,0x6d362251)
HXLINE( 819)		_float_of_bytes = ::openfl::_legacy::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("float_of_bytes",46,ba,cb,d5),(int)2);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","boot",0x25f407f0,"openfl._legacy.utils.ByteArray.boot","openfl/_legacy/utils/ByteArray.hx",821,0x6d362251)
...
{
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","boot",0x25f407f0,"openfl._legacy.utils.ByteArray.boot","openfl/_legacy/utils/ByteArray.hx",822,0x6d362251)
...
{
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","boot",0x25f407f0,"openfl._legacy.utils.ByteArray.boot","openfl/_legacy/utils/ByteArray.hx",824,0x6d362251)
...
{
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","boot",0x25f407f0,"openfl._legacy.utils.ByteArray.boot","openfl/_legacy/utils/ByteArray.hx",825,0x6d362251)
...
{
            	HX_STACK_FRAME("openfl._legacy.utils.ByteArray","boot",0x25f407f0,"openfl._legacy.utils.ByteArray.boot","openfl/_legacy/utils/ByteArray.hx",826,0x6d362251)
