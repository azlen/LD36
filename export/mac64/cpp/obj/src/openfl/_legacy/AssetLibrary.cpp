...
Bool AssetLibrary_obj::exists(::String id,::hx::EnumBase type){
...
HXLINE(1326)		Bool _hx_tmp = hx::IsNull( bytes );
...
Bool AssetLibrary_obj::isLocal(::String id,::hx::EnumBase type){
...
::Array< ::String > AssetLibrary_obj::list(::hx::EnumBase type){
...
void AssetLibrary_obj::loadBitmapData(::String id, ::Dynamic handler){
            	HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadBitmapData",0x8b0b5c1e,"openfl._legacy.AssetLibrary.loadBitmapData","openfl/_legacy/Assets.hx",1368,0x9276b055)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1368)		 ::openfl::_legacy::display::BitmapData _hx_tmp = this->getBitmapData(id);
HXDLIN(1368)		handler(_hx_tmp);
            	}
...
void AssetLibrary_obj::loadBytes(::String id, ::Dynamic handler){
            	HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadBytes",0x2fb8fc26,"openfl._legacy.AssetLibrary.loadBytes","openfl/_legacy/Assets.hx",1375,0x9276b055)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1375)		 ::openfl::_legacy::utils::ByteArray _hx_tmp = this->getBytes(id);
HXDLIN(1375)		handler(_hx_tmp);
            	}
...
void AssetLibrary_obj::loadFont(::String id, ::Dynamic handler){
            	HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadFont",0xeab87a74,"openfl._legacy.AssetLibrary.loadFont","openfl/_legacy/Assets.hx",1382,0x9276b055)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1382)		 ::openfl::_legacy::text::Font _hx_tmp = this->getFont(id);
HXDLIN(1382)		handler(_hx_tmp);
            	}
...
void AssetLibrary_obj::loadMovieClip(::String id, ::Dynamic handler){
            	HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadMovieClip",0x251fefdb,"openfl._legacy.AssetLibrary.loadMovieClip","openfl/_legacy/Assets.hx",1389,0x9276b055)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1389)		 ::openfl::_legacy::display::MovieClip _hx_tmp = this->getMovieClip(id);
HXDLIN(1389)		handler(_hx_tmp);
            	}
...
void AssetLibrary_obj::loadMusic(::String id, ::Dynamic handler){
            	HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadMusic",0x827bc460,"openfl._legacy.AssetLibrary.loadMusic","openfl/_legacy/Assets.hx",1396,0x9276b055)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1396)		 ::openfl::_legacy::media::Sound _hx_tmp = this->getMusic(id);
HXDLIN(1396)		handler(_hx_tmp);
            	}
...
void AssetLibrary_obj::loadSound(::String id, ::Dynamic handler){
            	HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadSound",0xf2ed808a,"openfl._legacy.AssetLibrary.loadSound","openfl/_legacy/Assets.hx",1403,0x9276b055)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1403)		 ::openfl::_legacy::media::Sound _hx_tmp = this->getSound(id);
HXDLIN(1403)		handler(_hx_tmp);
            	}
...
void AssetLibrary_obj::loadText(::String id, ::Dynamic handler){
            		...
            		void _hx_run( ::openfl::_legacy::utils::ByteArray bytes){
            			HX_STACK_FRAME("openfl._legacy.AssetLibrary","loadText",0xf3f1e952,"openfl._legacy.AssetLibrary.loadText","openfl/_legacy/Assets.hx",1414,0x9276b055)
            			HX_STACK_ARG(bytes,"bytes")
HXLINE(1414)			Bool _hx_tmp = hx::IsNull( bytes );
HXDLIN(1414)			if (_hx_tmp) {
HXLINE(1416)				handler(null());
            			}
            			else {
HXLINE(1420)				::String _hx_tmp1 = bytes->readUTFBytes(bytes->length);
HXDLIN(1420)				handler(_hx_tmp1);
            			}
            		}
            	...
            	HX_STACK_ARG(id,"id")
            	HX_STACK_ARG(handler,"handler")
HXLINE(1412)		HX_VARI(  ::Dynamic,callback) =  ::Dynamic(new _hx_Closure_0(handler));
