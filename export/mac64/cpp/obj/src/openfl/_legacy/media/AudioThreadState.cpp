...
void AudioThreadState_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 354)		this->mutex =  ::cpp::vm::Mutex_obj::__new();
...
HXLINE( 362)		Bool _hx_tmp = !(::Lambda_obj::has(this->channelList,channel));
...
HXLINE( 376)		Bool _hx_tmp = ::Lambda_obj::has(this->channelList,channel);
...
HXLINE( 388)			Bool _hx_tmp1 = (this->channelList->length == (int)0);
...
HXDLIN( 405)				++_g;
HXLINE( 407)				Bool _hx_tmp = hx::IsNotNull( channel );
HXDLIN( 407)				if (_hx_tmp) {
HXLINE( 409)					Bool _hx_tmp1 = channel->_hx___runCheckComplete();
