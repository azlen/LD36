...
HXLINE(  64)		Bool _hx_tmp = hx::IsNotNull( soundTransform );
HXDLIN(  64)		if (_hx_tmp) {
HXLINE(  66)			this->_hx___transform = soundTransform->clone();
            		}
HXLINE(  70)		Bool _hx_tmp1 = hx::IsNotNull( handle );
...
HXLINE(  76)		Bool _hx_tmp2 = hx::IsNotNull( this->_hx___handle );
...
hx::ObjectPtr< SoundChannel_obj > SoundChannel_obj::__new( ::Dynamic handle,hx::Null< Float >  __o_startTime,hx::Null< Int >  __o_loops, ::openfl::media::SoundTransform soundTransform)
{
	...
	_hx_result->__construct(handle,__o_startTime,__o_loops,soundTransform);
	return _hx_result;
}
...
HXDLIN( 110)		Bool _hx_tmp1 = hx::IsNotNull( this->_hx___soundInstance );
...
HXLINE( 112)			Bool _hx_tmp2 = hx::IsNotNull( ::openfl::_legacy::media::SoundChannel_obj::_hx___audioState );
...
Bool SoundChannel_obj::_hx___checkComplete(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 128)		Bool _hx_tmp = hx::IsNotNull( this->_hx___handle );
HXDLIN( 128)		if (_hx_tmp) {
HXLINE( 130)			Bool _hx_tmp1;
HXDLIN( 130)			Bool _hx_tmp2 = hx::IsNotNull( this->_hx___dataProvider );
HXDLIN( 130)			if (_hx_tmp2) {
HXLINE( 130)				_hx_tmp1 = ( (Bool)(::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_needs_data(this->_hx___handle)) );
            			}
            			else {
HXLINE( 130)				_hx_tmp1 = false;
            			}
HXDLIN( 130)			if (_hx_tmp1) {
HXLINE( 132)				HX_VARI(  ::openfl::events::SampleDataEvent,request) =  ::openfl::events::SampleDataEvent_obj::__new(HX_("sampleData",74,3f,0b,5e),null(),null());
...
HXLINE( 135)				Bool _hx_tmp3 = (this->_hx___dynamicBytes->length > (int)0);
...
HXLINE( 148)				Bool _hx_tmp5 = hx::IsNotNull( this->_hx___soundInstance );
HXDLIN( 148)				if (_hx_tmp5) {
HXLINE( 148)					_hx_tmp4 = hx::IsEq( this->_hx___soundInstance->_hx___audioType,::openfl::_legacy::media::InternalAudioType_obj::MUSIC_dyn() );
            				}
            				else {
...
HXLINE( 150)				Bool _hx_tmp6 = hx::IsNull( ::openfl::_legacy::media::SoundChannel_obj::_hx___audioState );
HXDLIN( 150)				if (_hx_tmp6) {
HXLINE( 152)					::openfl::_legacy::media::SoundChannel_obj::_hx___audioState =  ::openfl::_legacy::media::AudioThreadState_obj::__new();
...
HXLINE( 162)				Bool _hx_tmp7 = !(this->_hx___addedToThread);
HXDLIN( 162)				if (_hx_tmp7) {
...
HXLINE( 175)				Bool _hx_tmp8 = this->_hx___runCheckComplete();
...
Bool SoundChannel_obj::_hx___runCheckComplete(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 246)		Bool _hx_tmp = ( (Bool)(::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_is_complete(this->_hx___handle)) );
HXDLIN( 246)		if (_hx_tmp) {
HXLINE( 248)			this->_hx___soundInstance = null();
HXLINE( 249)			this->_hx___handle = null();
HXLINE( 251)			Bool _hx_tmp1 = hx::IsNotNull( this->_hx___dataProvider );
HXDLIN( 251)			if (_hx_tmp1) {
HXLINE( 253)				::openfl::_legacy::media::SoundChannel_obj::_hx___dynamicSoundCount--;
            			}
HXLINE( 257)			HX_VARI(  ::openfl::_legacy::events::Event,completeEvent) =  ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::SOUND_COMPLETE,null(),null());
...
Float SoundChannel_obj::get_leftPeak(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 276)		return ( (Float)(::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_get_left(this->_hx___handle)) );
            	}
...
Float SoundChannel_obj::get_rightPeak(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 277)		return ( (Float)(::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_get_right(this->_hx___handle)) );
            	}
...
Float SoundChannel_obj::get_position(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 280)		return ( (Float)(::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_get_position(this->_hx___handle)) );
            	}
...
HXDLIN( 281)		return ( (Float)(::openfl::_legacy::media::SoundChannel_obj::lime_sound_channel_set_position(_hx_tmp,_hx_tmp1)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(SoundChannel_obj,set_position,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 286)		Bool _hx_tmp = hx::IsNull( this->_hx___transform );
HXDLIN( 286)		if (_hx_tmp) {
HXLINE( 288)			this->_hx___transform =  ::openfl::media::SoundTransform_obj::__new(null(),null());
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(SoundChannel_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 298)		Bool _hx_tmp = hx::IsNull( this->_hx___transform );
...
HXLINE(  87)		HX_VARI(  ::openfl::_legacy::media::SoundChannel,result) =  ::openfl::_legacy::media::SoundChannel_obj::__new(null(),(int)0,(int)0,soundTransform);
...
HXLINE(  96)		HX_VARI(  ::openfl::events::SampleDataEvent,request) =  ::openfl::events::SampleDataEvent_obj::__new(HX_("sampleData",74,3f,0b,5e),null(),null());
...
HXLINE( 198)			Bool _hx_tmp = !(::openfl::_legacy::media::SoundChannel_obj::_hx___audioThreadIsIdle);
...
HXLINE( 231)			Int _hx_tmp = --i;
HXDLIN( 231)			if (!((_hx_tmp >= (int)0))) {
HXLINE( 231)				goto _hx_goto_1;
            			}
HXLINE( 233)			Bool _hx_tmp1 = ::openfl::_legacy::media::SoundChannel_obj::_hx___incompleteList->__get(i).StaticCast<  ::openfl::_legacy::media::SoundChannel >()->_hx___checkComplete();
...
{
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",35,0xd2a8ca59)
HXLINE(  35)		_hx___dynamicSoundCount = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",36,0xd2a8ca59)
HXLINE(  36)		_hx___incompleteList = ::Array_obj< ::Dynamic>::__new();
            	}
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",50,0xd2a8ca59)
HXLINE(  50)		_hx___audioThreadIsIdle = true;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",51,0xd2a8ca59)
HXLINE(  51)		_hx___audioThreadRunning = false;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",324,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",325,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",326,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",327,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",328,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",329,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",330,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",331,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",332,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",333,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",334,0xd2a8ca59)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.SoundChannel","boot",0x943bb19e,"openfl._legacy.media.SoundChannel.boot","openfl/_legacy/media/SoundChannel.hx",335,0xd2a8ca59)
