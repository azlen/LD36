...
HXLINE(  56)		Bool _hx_tmp1 = hx::IsNotNull( stream );
...
hx::ObjectPtr< Sound_obj > Sound_obj::__new( ::openfl::_legacy::net::URLRequest stream, ::openfl::media::SoundLoaderContext context,hx::Null< Bool >  __o_forcePlayAsMusic)
{
	...
	_hx_result->__construct(stream,context,__o_forcePlayAsMusic);
	return _hx_result;
}
...
HXLINE(  71)			Bool _hx_tmp = hx::IsNotNull( this->_hx___handle );
...
void Sound_obj::close(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  87)		Bool _hx_tmp = hx::IsNotNull( this->_hx___handle );
...
HXLINE( 117)		Bool _hx_tmp = hx::IsNull( this->_hx___handle );
...
HXLINE( 120)			this->dispatchEvent( ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),null(),null(),null(),null()));
            		}
            		else {
...
HXLINE( 128)			this->dispatchEvent( ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::COMPLETE,null(),null()));
            		}
            	}
...
HXLINE( 143)		Bool _hx_tmp = hx::IsNull( this->_hx___handle );
...
HXLINE( 154)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,wav) =  ::openfl::_legacy::utils::ByteArray_obj::__new(null());
...
HXDLIN( 157)			goto _hx_goto_0;
            		...
            		/* default */{
HXLINE( 161)			HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__new((HX_("Unsupported format ",7e,06,66,fe) + format),null()));
            		}
            		_hx_goto_0:;
...
HXDLIN( 167)			goto _hx_goto_1;
            		...
            		/* default */{
HXLINE( 171)			HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__new((HX_("Unsupported format ",7e,06,66,fe) + format),null()));
            		}
            		_hx_goto_1:;
...
HXLINE( 177)		Float _hx_tmp = ((Float)bytes->length / (Float)blockAlign);
HXDLIN( 177)		::Std_obj::_hx_int(_hx_tmp);
HXLINE( 179)		wav->writeUTFBytes(HX_("RIFF",b7,20,6b,36));
HXLINE( 180)		Int _hx_tmp1 = ((int)36 + bytes->length);
HXDLIN( 180)		wav->writeInt(_hx_tmp1);
...
HXLINE( 204)		Bool _hx_tmp = this->_hx___dynamicSound;
HXDLIN( 204)		if (_hx_tmp) {
HXLINE( 206)			HX_VARI(  ::openfl::events::SampleDataEvent,request) =  ::openfl::events::SampleDataEvent_obj::__new(HX_("sampleData",74,3f,0b,5e),null(),null());
HXLINE( 207)			this->dispatchEvent(request);
HXLINE( 209)			Bool _hx_tmp1 = (request->data->length > (int)0);
...
HXLINE( 215)			Bool _hx_tmp2 = hx::IsNull( this->_hx___handle );
HXDLIN( 215)			if (_hx_tmp2) {
HXLINE( 217)				HX_VARI(  ::openfl::_legacy::media::SoundChannel,channel) =  ::openfl::_legacy::media::SoundChannel_obj::__new(null(),startTime,loops,soundTransform);
...
HXDLIN( 230)			Bool _hx_tmp4 = hx::IsNotNull( this->_hx___handle );
HXDLIN( 230)			if (_hx_tmp4) {
HXLINE( 230)				_hx_tmp3 = this->_hx___loading;
            			}
            			else {
HXLINE( 230)				_hx_tmp3 = true;
            			}
HXDLIN( 230)			if (_hx_tmp3) {
HXLINE( 232)				HX_VARI_NAME(  ::openfl::_legacy::media::SoundChannel,channel1,"channel") =  ::openfl::_legacy::media::SoundChannel_obj::__new(null(),startTime,loops,soundTransform);
HXLINE( 233)				channel1->_hx___soundInstance = hx::ObjectPtr<OBJ_>(this);
HXLINE( 235)				return channel1;
            			}
HXLINE( 239)			HX_VARI_NAME(  ::openfl::_legacy::media::SoundChannel,channel2,"channel") =  ::openfl::_legacy::media::SoundChannel_obj::__new(this->_hx___handle,startTime,loops,soundTransform);
...
void Sound_obj::_hx___checkLoading(){
            	HX_STACK_FRAME("openfl._legacy.media.Sound","__checkLoading",0xfefc3741,"openfl._legacy.media.Sound.__checkLoading","openfl/_legacy/media/Sound.hx",251,0xdb1efaa0)
            	HX_STACK_THIS(this)
...
HXLINE( 255)			Bool _hx_tmp2 = hx::IsNull( status );
HXDLIN( 255)			if (_hx_tmp2) {
HXLINE( 257)				HX_STACK_DO_THROW(HX_("Could not get sound status",79,41,e1,c3));
            			}
HXLINE( 261)			this->bytesLoaded =  ::Dynamic(status->__Field(HX_("bytesLoaded",d0,66,ca,99),hx::paccDynamic));
HXLINE( 262)			this->bytesTotal =  ::Dynamic(status->__Field(HX_("bytesTotal",59,57,da,45),hx::paccDynamic));
HXLINE( 263)			this->_hx___loading = (this->bytesLoaded < this->bytesTotal);
HXLINE( 265)			Bool _hx_tmp3 = hx::IsNotNull(  ::Dynamic(status->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic)) );
...
HXLINE( 278)		this->dispatchEvent( ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),true,false,msg,null()));
...
HXDLIN( 296)		Bool _hx_tmp1 = hx::IsNotNull( this->_hx___handle );
...
HXLINE( 298)			return  ::openfl::media::ID3Info_obj::__new();
            		}
HXLINE( 302)		HX_VARI(  ::openfl::media::ID3Info,id3) =  ::openfl::media::ID3Info_obj::__new();
...
HXDLIN( 319)		Bool _hx_tmp1 = hx::IsNotNull( this->_hx___handle );
...
hx::Val Sound_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"__audioType") ) { _hx___audioType=inValue.Cast< ::hx::EnumBase >(); return inValue; }
		break;
	case 14:
...
{
{
            	HX_STACK_FRAME("openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",337,0xdb1efaa0)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",338,0xdb1efaa0)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",339,0xdb1efaa0)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",340,0xdb1efaa0)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",341,0xdb1efaa0)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",342,0xdb1efaa0)
...
{
            	HX_STACK_FRAME("openfl._legacy.media.Sound","boot",0x0bf3af7f,"openfl._legacy.media.Sound.boot","openfl/_legacy/media/Sound.hx",343,0xdb1efaa0)
