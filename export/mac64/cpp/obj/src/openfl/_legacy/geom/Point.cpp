...
Dynamic Point_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::geom::Point Point_obj::add( ::openfl::_legacy::geom::Point v){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE(  22)		return  ::openfl::_legacy::geom::Point_obj::__new((v->x + this->x),(v->y + this->y));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Point_obj,add,return )
 ...
 ::openfl::_legacy::geom::Point Point_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  29)		return  ::openfl::_legacy::geom::Point_obj::__new(this->x,this->y);
            	}
...
HXLINE(  73)			Float _hx_tmp1 = ((this->x * this->x) + (this->y * this->y));
HXDLIN(  73)			Float _hx_tmp2 = ::Math_obj::sqrt(_hx_tmp1);
HXDLIN(  73)			HX_VARI( Float,norm) = ((Float)thickness / (Float)_hx_tmp2);
HXLINE(  74)			hx::MultEq(this->x,norm);
HXLINE(  75)			hx::MultEq(this->y,norm);
            		}
            	}
...
void Point_obj::offset(Float dx,Float dy){
            	...
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE(  84)		hx::AddEq(this->x,dx);
HXLINE(  85)		hx::AddEq(this->y,dy);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Point_obj,setTo,(void))
 ...
 ::openfl::_legacy::geom::Point Point_obj::subtract( ::openfl::_legacy::geom::Point v){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 107)		return  ::openfl::_legacy::geom::Point_obj::__new((this->x - v->x),(this->y - v->y));
            	}
...
Float Point_obj::get_length(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 128)		Float _hx_tmp = ((this->x * this->x) + (this->y * this->y));
HXDLIN( 128)		return ::Math_obj::sqrt(_hx_tmp);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Point_obj,distance,return )
 ...
 ::openfl::_legacy::geom::Point Point_obj::interpolate( ::openfl::_legacy::geom::Point pt1, ::openfl::_legacy::geom::Point pt2,Float f){
            	...
            	HX_STACK_ARG(pt2,"pt2")
            	HX_STACK_ARG(f,"f")
HXLINE(  60)		return  ::openfl::_legacy::geom::Point_obj::__new((pt2->x + (f * (pt1->x - pt2->x))),(pt2->y + (f * (pt1->y - pt2->y))));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Point_obj,interpolate,return )
 ...
 ::openfl::_legacy::geom::Point Point_obj::polar(Float len,Float angle){
            	HX_STACK_FRAME("openfl._legacy.geom.Point","polar",0xcb0d3c32,"openfl._legacy.geom.Point.polar","openfl/_legacy/geom/Point.hx",92,0x10b884db)
            	HX_STACK_ARG(len,"len")
            	HX_STACK_ARG(angle,"angle")
HXLINE(  92)		Float _hx_tmp = ::Math_obj::cos(angle);
HXDLIN(  92)		Float _hx_tmp1 = (len * _hx_tmp);
HXDLIN(  92)		Float _hx_tmp2 = ::Math_obj::sin(angle);
HXDLIN(  92)		return  ::openfl::_legacy::geom::Point_obj::__new(_hx_tmp1,(len * _hx_tmp2));
            	}
