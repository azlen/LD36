...
Dynamic BitmapFilter_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::filters::BitmapFilter BitmapFilter_obj::clone(){
            	HX_STACK_FRAME("openfl._legacy.filters.BitmapFilter","clone",0x22ab288d,"openfl._legacy.filters.BitmapFilter.clone","openfl/_legacy/filters/BitmapFilter.hx",19,0xbc61c83d)
            	HX_STACK_THIS(this)
HXLINE(  19)		return  ::openfl::_legacy::filters::BitmapFilter_obj::__new(this->type);
            	}
