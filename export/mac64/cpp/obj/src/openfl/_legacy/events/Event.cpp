...
Dynamic Event_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event Event_obj::clone(){
            	HX_STACK_FRAME("openfl._legacy.events.Event","clone",0x58e80ff8,"openfl._legacy.events.Event.clone","openfl/_legacy/events/Event.hx",72,0xcca9b1d4)
            	HX_STACK_THIS(this)
HXLINE(  72)		::String _hx_tmp = this->get_type();
HXDLIN(  72)		Bool _hx_tmp1 = this->get_bubbles();
HXDLIN(  72)		Bool _hx_tmp2 = this->get_cancelable();
HXDLIN(  72)		return  ::openfl::_legacy::events::Event_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2);
            	}
...
void Event_obj::stopImmediatePropagation(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  86)		Bool _hx_tmp = this->get_cancelable();
...
void Event_obj::stopPropagation(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  98)		Bool _hx_tmp = this->get_cancelable();
...
::String Event_obj::toString(){
            	HX_STACK_FRAME("openfl._legacy.events.Event","toString",0x4aa366f1,"openfl._legacy.events.Event.toString","openfl/_legacy/events/Event.hx",109,0xcca9b1d4)
            	HX_STACK_THIS(this)
HXLINE( 109)		::String _hx_tmp = this->get_type();
HXDLIN( 109)		::String _hx_tmp1 = ((HX_("[Event type=",22,63,2e,48) + _hx_tmp) + HX_(" bubbles=",16,5f,ba,28));
HXDLIN( 109)		Bool _hx_tmp2 = this->get_bubbles();
HXDLIN( 109)		::String _hx_tmp3 = ::Std_obj::string(_hx_tmp2);
HXDLIN( 109)		::String _hx_tmp4 = ((_hx_tmp1 + _hx_tmp3) + HX_(" cancelable=",89,25,e0,5d));
HXDLIN( 109)		Bool _hx_tmp5 = this->get_cancelable();
HXDLIN( 109)		::String _hx_tmp6 = ::Std_obj::string(_hx_tmp5);
HXDLIN( 109)		return ((_hx_tmp4 + _hx_tmp6) + HX_("]",5d,00,00,00));
            	}
...
HXLINE( 125)				Bool _hx_tmp = ::Std_obj::is(arg,hx::ClassOf< ::String >());
HXDLIN( 125)				if (_hx_tmp) {
HXLINE( 127)					::String _hx_tmp1 = ((HX_(" ",20,00,00,00) + param) + HX_("=\"",45,35,00,00));
HXDLIN( 127)					::String _hx_tmp2 = ::Std_obj::string(arg);
HXDLIN( 127)					hx::AddEq(output,((_hx_tmp1 + _hx_tmp2) + HX_("\"",22,00,00,00)));
            				}
            				else {
HXLINE( 131)					::String _hx_tmp3 = ((HX_(" ",20,00,00,00) + param) + HX_("=",3d,00,00,00));
HXDLIN( 131)					::String _hx_tmp4 = ::Std_obj::string(arg);
HXDLIN( 131)					hx::AddEq(output,(_hx_tmp3 + _hx_tmp4));
            				}
            			}
            		}
HXLINE( 137)		hx::AddEq(output,HX_("]",5d,00,00,00));
...
Bool Event_obj::_hx___getIsCancelled(){
            	HX_STACK_FRAME("openfl._legacy.events.Event","__getIsCancelled",0x715efeb6,"openfl._legacy.events.Event.__getIsCancelled","openfl/_legacy/events/Event.hx",145,0xcca9b1d4)
            	HX_STACK_THIS(this)
...
Bool Event_obj::_hx___getIsCancelledNow(){
            	HX_STACK_FRAME("openfl._legacy.events.Event","__getIsCancelledNow",0x9a1c2800,"openfl._legacy.events.Event.__getIsCancelledNow","openfl/_legacy/events/Event.hx",152,0xcca9b1d4)
            	HX_STACK_THIS(this)
...
{
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",12,0xcca9b1d4)
HXLINE(  12)		ACTIVATE = HX_("activate",b3,1b,ac,e5);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",13,0xcca9b1d4)
HXLINE(  13)		ADDED = HX_("added",c0,d4,43,1c);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",14,0xcca9b1d4)
HXLINE(  14)		ADDED_TO_STAGE = HX_("addedToStage",63,22,55,0c);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",15,0xcca9b1d4)
HXLINE(  15)		CANCEL = HX_("cancel",7a,ed,33,b8);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",16,0xcca9b1d4)
HXLINE(  16)		CHANGE = HX_("change",70,91,72,b7);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",17,0xcca9b1d4)
HXLINE(  17)		CLOSE = HX_("close",b8,17,63,48);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",18,0xcca9b1d4)
HXLINE(  18)		COMPLETE = HX_("complete",b9,00,c8,7f);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",19,0xcca9b1d4)
HXLINE(  19)		CONNECT = HX_("connect",ea,3b,80,15);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",20,0xcca9b1d4)
HXLINE(  20)		CONTEXT3D_CREATE = HX_("context3DCreate",7c,bf,59,7b);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",21,0xcca9b1d4)
HXLINE(  21)		DEACTIVATE = HX_("deactivate",34,5c,01,3c);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",22,0xcca9b1d4)
HXLINE(  22)		ENTER_FRAME = HX_("enterFrame",f5,03,50,02);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",23,0xcca9b1d4)
HXLINE(  23)		ID3 = HX_("id3",f8,03,50,00);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",24,0xcca9b1d4)
HXLINE(  24)		INIT = HX_("init",10,3b,bb,45);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",25,0xcca9b1d4)
HXLINE(  25)		MOUSE_LEAVE = HX_("mouseLeave",92,28,20,90);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",26,0xcca9b1d4)
HXLINE(  26)		OPEN = HX_("open",ca,03,b4,49);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",27,0xcca9b1d4)
HXLINE(  27)		REMOVED = HX_("removed",a0,1f,00,f3);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",28,0xcca9b1d4)
HXLINE(  28)		REMOVED_FROM_STAGE = HX_("removedFromStage",34,21,76,ba);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",29,0xcca9b1d4)
HXLINE(  29)		RENDER = HX_("render",56,6b,29,05);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",30,0xcca9b1d4)
HXLINE(  30)		RESIZE = HX_("resize",f4,59,7b,08);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",31,0xcca9b1d4)
HXLINE(  31)		SCROLL = HX_("scroll",0d,d8,64,47);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",32,0xcca9b1d4)
HXLINE(  32)		SELECT = HX_("select",fc,1a,33,6a);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",33,0xcca9b1d4)
HXLINE(  33)		SOUND_COMPLETE = HX_("soundComplete",a8,30,e6,1c);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",34,0xcca9b1d4)
HXLINE(  34)		TAB_CHILDREN_CHANGE = HX_("tabChildrenChange",44,91,b5,de);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",35,0xcca9b1d4)
HXLINE(  35)		TAB_ENABLED_CHANGE = HX_("tabEnabledChange",3c,45,98,72);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",36,0xcca9b1d4)
HXLINE(  36)		TAB_INDEX_CHANGE = HX_("tabIndexChange",cd,1d,78,90);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.Event","boot",0x1b4c53f7,"openfl._legacy.events.Event.boot","openfl/_legacy/events/Event.hx",37,0xcca9b1d4)
