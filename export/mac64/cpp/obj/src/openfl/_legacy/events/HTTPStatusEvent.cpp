...
hx::ObjectPtr< HTTPStatusEvent_obj > HTTPStatusEvent_obj::__new(::String type,hx::Null< Bool >  __o_bubbles,hx::Null< Bool >  __o_cancelable,hx::Null< Int >  __o_status)
{
	...
	_hx_result->__construct(type,__o_bubbles,__o_cancelable,__o_status);
	return _hx_result;
}
...
Dynamic HTTPStatusEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event HTTPStatusEvent_obj::clone(){
            	HX_STACK_FRAME("openfl._legacy.events.HTTPStatusEvent","clone",0x2d221e1e,"openfl._legacy.events.HTTPStatusEvent.clone","openfl/_legacy/events/HTTPStatusEvent.hx",25,0xa6d8d4ae)
            	HX_STACK_THIS(this)
HXLINE(  25)		::String _hx_tmp = this->get_type();
HXDLIN(  25)		Bool _hx_tmp1 = this->get_bubbles();
HXDLIN(  25)		Bool _hx_tmp2 = this->get_cancelable();
HXDLIN(  25)		return  ::openfl::_legacy::events::HTTPStatusEvent_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,this->status);
            	}


::String HTTPStatusEvent_obj::toString(){
            	HX_STACK_FRAME("openfl._legacy.events.HTTPStatusEvent","toString",0xb0c4348b,"openfl._legacy.events.HTTPStatusEvent.toString","openfl/_legacy/events/HTTPStatusEvent.hx",32,0xa6d8d4ae)
            	HX_STACK_THIS(this)
HXLINE(  32)		::String _hx_tmp = this->get_type();
HXDLIN(  32)		::String _hx_tmp1 = ((HX_("[HTTPStatusEvent type=",c8,a0,6f,f4) + _hx_tmp) + HX_(" bubbles=",16,5f,ba,28));
HXDLIN(  32)		Bool _hx_tmp2 = this->get_bubbles();
HXDLIN(  32)		::String _hx_tmp3 = ::Std_obj::string(_hx_tmp2);
HXDLIN(  32)		::String _hx_tmp4 = ((_hx_tmp1 + _hx_tmp3) + HX_(" cancelable=",89,25,e0,5d));
HXDLIN(  32)		Bool _hx_tmp5 = this->get_cancelable();
HXDLIN(  32)		::String _hx_tmp6 = ::Std_obj::string(_hx_tmp5);
HXDLIN(  32)		return ((((_hx_tmp4 + _hx_tmp6) + HX_(" status=",ab,a8,bc,5c)) + this->status) + HX_("]",5d,00,00,00));
            	}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.events.HTTPStatusEvent","boot",0x6c9bcc91,"openfl._legacy.events.HTTPStatusEvent.boot","openfl/_legacy/events/HTTPStatusEvent.hx",7,0xa6d8d4ae)
