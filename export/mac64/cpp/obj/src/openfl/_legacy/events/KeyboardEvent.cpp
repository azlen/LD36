...
hx::ObjectPtr< KeyboardEvent_obj > KeyboardEvent_obj::__new(::String type,hx::Null< Bool >  __o_bubbles,hx::Null< Bool >  __o_cancelable,hx::Null< Int >  __o_charCodeValue,hx::Null< Int >  __o_keyCodeValue,hx::Null< Int >  __o_keyLocationValue,hx::Null< Bool >  __o_ctrlKeyValue,hx::Null< Bool >  __o_altKeyValue,hx::Null< Bool >  __o_shiftKeyValue,hx::Null< Bool >  __o_controlKeyValue,hx::Null< Bool >  __o_commandKeyValue)
{
	...
	_hx_result->__construct(type,__o_bubbles,__o_cancelable,__o_charCodeValue,__o_keyCodeValue,__o_keyLocationValue,__o_ctrlKeyValue,__o_altKeyValue,__o_shiftKeyValue,__o_controlKeyValue,__o_commandKeyValue);
	return _hx_result;
}
...
Dynamic KeyboardEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event KeyboardEvent_obj::clone(){
            	HX_STACK_FRAME("openfl._legacy.events.KeyboardEvent","clone",0xa856f591,"openfl._legacy.events.KeyboardEvent.clone","openfl/_legacy/events/KeyboardEvent.hx",38,0x7429199b)
            	HX_STACK_THIS(this)
HXLINE(  38)		::String _hx_tmp = this->get_type();
HXDLIN(  38)		Bool _hx_tmp1 = this->get_bubbles();
HXDLIN(  38)		Bool _hx_tmp2 = this->get_cancelable();
HXDLIN(  38)		return  ::openfl::_legacy::events::KeyboardEvent_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
            	}


::String KeyboardEvent_obj::toString(){
            	HX_STACK_FRAME("openfl._legacy.events.KeyboardEvent","toString",0x96f346f8,"openfl._legacy.events.KeyboardEvent.toString","openfl/_legacy/events/KeyboardEvent.hx",45,0x7429199b)
            	HX_STACK_THIS(this)
HXLINE(  45)		::String _hx_tmp = this->get_type();
HXDLIN(  45)		::String _hx_tmp1 = ((HX_("[KeyboardEvent type=",bb,ae,1e,4c) + _hx_tmp) + HX_(" bubbles=",16,5f,ba,28));
HXDLIN(  45)		Bool _hx_tmp2 = this->get_bubbles();
HXDLIN(  45)		::String _hx_tmp3 = ::Std_obj::string(_hx_tmp2);
HXDLIN(  45)		::String _hx_tmp4 = ((_hx_tmp1 + _hx_tmp3) + HX_(" cancelable=",89,25,e0,5d));
HXDLIN(  45)		Bool _hx_tmp5 = this->get_cancelable();
HXDLIN(  45)		::String _hx_tmp6 = ::Std_obj::string(_hx_tmp5);
HXDLIN(  45)		::String _hx_tmp7 = ((((((((_hx_tmp4 + _hx_tmp6) + HX_(" charCode=",9a,db,fd,0c)) + this->charCode) + HX_(" keyCode=",71,1c,ed,ec)) + this->keyCode) + HX_(" keyLocation=",e9,5a,32,48)) + this->keyLocation) + HX_(" ctrlKey=",29,e8,3e,4a));
HXDLIN(  45)		::String _hx_tmp8 = ::Std_obj::string(this->ctrlKey);
HXDLIN(  45)		::String _hx_tmp9 = ((_hx_tmp7 + _hx_tmp8) + HX_(" altKey=",67,93,d6,12));
HXDLIN(  45)		::String _hx_tmp10 = ::Std_obj::string(this->altKey);
HXDLIN(  45)		::String _hx_tmp11 = ((_hx_tmp9 + _hx_tmp10) + HX_(" shiftKey=",40,5f,4f,db));
HXDLIN(  45)		::String _hx_tmp12 = ::Std_obj::string(this->shiftKey);
HXDLIN(  45)		return ((_hx_tmp11 + _hx_tmp12) + HX_("]",5d,00,00,00));
            	}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.events.KeyboardEvent","boot",0xb57be47e,"openfl._legacy.events.KeyboardEvent.boot","openfl/_legacy/events/KeyboardEvent.hx",7,0x7429199b)
HXLINE(   7)		KEY_DOWN = HX_("keyDown",a1,69,47,9c);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.KeyboardEvent","boot",0xb57be47e,"openfl._legacy.events.KeyboardEvent.boot","openfl/_legacy/events/KeyboardEvent.hx",8,0x7429199b)
