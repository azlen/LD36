...
hx::ObjectPtr< MouseEvent_obj > MouseEvent_obj::__new(::String type,hx::Null< Bool >  __o_bubbles,hx::Null< Bool >  __o_cancelable,hx::Null< Float >  __o_localX,hx::Null< Float >  __o_localY, ::openfl::_legacy::display::InteractiveObject relatedObject,hx::Null< Bool >  __o_ctrlKey,hx::Null< Bool >  __o_altKey,hx::Null< Bool >  __o_shiftKey,hx::Null< Bool >  __o_buttonDown,hx::Null< Int >  __o_delta,hx::Null< Bool >  __o_commandKey,hx::Null< Int >  __o_clickCount)
{
	...
	_hx_result->__construct(type,__o_bubbles,__o_cancelable,__o_localX,__o_localY,relatedObject,__o_ctrlKey,__o_altKey,__o_shiftKey,__o_buttonDown,__o_delta,__o_commandKey,__o_clickCount);
	return _hx_result;
}
...
Dynamic MouseEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event MouseEvent_obj::clone(){
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","clone",0xd4fc6f95,"openfl._legacy.events.MouseEvent.clone","openfl/_legacy/events/MouseEvent.hx",67,0xe60bb539)
            	HX_STACK_THIS(this)
HXLINE(  67)		::String _hx_tmp = this->get_type();
HXDLIN(  67)		Bool _hx_tmp1 = this->get_bubbles();
HXDLIN(  67)		Bool _hx_tmp2 = this->get_cancelable();
HXDLIN(  67)		return  ::openfl::_legacy::events::MouseEvent_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
            	}


::String MouseEvent_obj::toString(){
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","toString",0xc61ae774,"openfl._legacy.events.MouseEvent.toString","openfl/_legacy/events/MouseEvent.hx",74,0xe60bb539)
            	HX_STACK_THIS(this)
HXLINE(  74)		::String _hx_tmp = this->get_type();
HXDLIN(  74)		::String _hx_tmp1 = ((HX_("[MouseEvent type=",13,70,9a,37) + _hx_tmp) + HX_(" bubbles=",16,5f,ba,28));
HXDLIN(  74)		Bool _hx_tmp2 = this->get_bubbles();
HXDLIN(  74)		::String _hx_tmp3 = ::Std_obj::string(_hx_tmp2);
HXDLIN(  74)		::String _hx_tmp4 = ((_hx_tmp1 + _hx_tmp3) + HX_(" cancelable=",89,25,e0,5d));
HXDLIN(  74)		Bool _hx_tmp5 = this->get_cancelable();
HXDLIN(  74)		::String _hx_tmp6 = ::Std_obj::string(_hx_tmp5);
HXDLIN(  74)		::String _hx_tmp7 = ((((((_hx_tmp4 + _hx_tmp6) + HX_(" localX=",f0,ca,14,54)) + this->localX) + HX_(" localY=",cf,cb,14,54)) + this->localY) + HX_(" relatedObject=",13,62,ef,68));
HXDLIN(  74)		::String _hx_tmp8 = ::Std_obj::string(this->relatedObject);
HXDLIN(  74)		::String _hx_tmp9 = ((_hx_tmp7 + _hx_tmp8) + HX_(" ctrlKey=",29,e8,3e,4a));
HXDLIN(  74)		::String _hx_tmp10 = ::Std_obj::string(this->ctrlKey);
HXDLIN(  74)		::String _hx_tmp11 = ((_hx_tmp9 + _hx_tmp10) + HX_(" altKey=",67,93,d6,12));
HXDLIN(  74)		::String _hx_tmp12 = ::Std_obj::string(this->altKey);
HXDLIN(  74)		::String _hx_tmp13 = ((_hx_tmp11 + _hx_tmp12) + HX_(" shiftKey=",40,5f,4f,db));
HXDLIN(  74)		::String _hx_tmp14 = ::Std_obj::string(this->shiftKey);
HXDLIN(  74)		::String _hx_tmp15 = ((_hx_tmp13 + _hx_tmp14) + HX_(" buttonDown=",29,d2,63,63));
HXDLIN(  74)		::String _hx_tmp16 = ::Std_obj::string(this->buttonDown);
HXDLIN(  74)		return ((((_hx_tmp15 + _hx_tmp16) + HX_(" delta=",65,e9,92,9d)) + this->delta) + HX_("]",5d,00,00,00));
            	}
...
HXLINE( 100)		Bool _hx_tmp = this->get_bubbles();
HXDLIN( 100)		Bool _hx_tmp1 = this->get_cancelable();
HXDLIN( 100)		 ::openfl::_legacy::display::InteractiveObject _hx_tmp2;
HXDLIN( 100)		Bool _hx_tmp3 = hx::IsNull( related );
HXDLIN( 100)		if (_hx_tmp3) {
HXLINE( 100)			_hx_tmp2 = this->relatedObject;
            		}
            		else {
HXLINE( 100)			_hx_tmp2 = related;
            		}
HXDLIN( 100)		HX_VARI(  ::openfl::_legacy::events::MouseEvent,mouseEvent) =  ::openfl::_legacy::events::MouseEvent_obj::__new(type,_hx_tmp,_hx_tmp1,this->localX,this->localY,_hx_tmp2,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
HXLINE( 102)		mouseEvent->stageX = this->stageX;
HXLINE( 103)		mouseEvent->stageY = this->stageY;
HXLINE( 105)		Bool _hx_tmp4 = hx::IsNotNull( target );
HXDLIN( 105)		if (_hx_tmp4) {
HXLINE( 107)			mouseEvent->set_target(target);
            		}
HXLINE( 111)		return mouseEvent;
            	}
...
HXLINE(  89)		Float _hx_tmp = local->x;
HXDLIN(  89)		Float _hx_tmp1 = local->y;
HXDLIN(  89)		Bool _hx_tmp2 = (((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efCtrlDown) != (int)0);
HXDLIN(  89)		Bool _hx_tmp3 = (((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efAltDown) != (int)0);
HXDLIN(  89)		Bool _hx_tmp4 = (((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efShiftDown) != (int)0);
HXDLIN(  89)		Bool _hx_tmp5 = (((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efLeftDown) != (int)0);
HXDLIN(  89)		HX_VARI(  ::openfl::_legacy::events::MouseEvent,mouseEvent) =  ::openfl::_legacy::events::MouseEvent_obj::__new(type,true,true,_hx_tmp,_hx_tmp1,null(),_hx_tmp2,_hx_tmp3,_hx_tmp4,_hx_tmp5,(int)0,null(),(int)0);
HXLINE(  90)		mouseEvent->stageX =  ::Dynamic(event->__Field(HX_("x",78,00,00,00),hx::paccDynamic));
HXLINE(  91)		mouseEvent->stageY =  ::Dynamic(event->__Field(HX_("y",79,00,00,00),hx::paccDynamic));
...
{
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",11,0xe60bb539)
HXLINE(  11)		DOUBLE_CLICK = HX_("doubleClick",77,03,76,cd);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",12,0xe60bb539)
HXLINE(  12)		CLICK = HX_("click",48,7c,5e,48);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",13,0xe60bb539)
HXLINE(  13)		MIDDLE_CLICK = HX_("middleClick",b3,e4,e5,43);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",14,0xe60bb539)
HXLINE(  14)		MIDDLE_MOUSE_DOWN = HX_("middleMouseDown",12,2b,fe,01);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",15,0xe60bb539)
HXLINE(  15)		MIDDLE_MOUSE_UP = HX_("middleMouseUp",0b,8d,f5,3a);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",16,0xe60bb539)
HXLINE(  16)		MOUSE_DOWN = HX_("mouseDown",27,b1,c2,ee);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",17,0xe60bb539)
HXLINE(  17)		MOUSE_MOVE = HX_("mouseMove",d6,9b,b5,f4);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",18,0xe60bb539)
HXLINE(  18)		MOUSE_OUT = HX_("mouseOut",69,e7,1d,a4);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",19,0xe60bb539)
HXLINE(  19)		MOUSE_OVER = HX_("mouseOver",19,4a,0d,f6);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",20,0xe60bb539)
HXLINE(  20)		MOUSE_UP = HX_("mouseUp",e0,f3,72,c0);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",21,0xe60bb539)
HXLINE(  21)		MOUSE_WHEEL = HX_("mouseWheel",36,28,87,e7);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",22,0xe60bb539)
HXLINE(  22)		RIGHT_CLICK = HX_("rightClick",cc,62,23,4b);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",23,0xe60bb539)
HXLINE(  23)		RIGHT_MOUSE_DOWN = HX_("rightMouseDown",ab,29,d7,cd);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",24,0xe60bb539)
HXLINE(  24)		RIGHT_MOUSE_UP = HX_("rightMouseUp",64,83,21,ab);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",25,0xe60bb539)
HXLINE(  25)		ROLL_OUT = HX_("rollOut",11,f9,11,5d);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",26,0xe60bb539)
HXLINE(  26)		ROLL_OVER = HX_("rollOver",71,ab,a8,12);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",41,0xe60bb539)
HXLINE(  41)		efLeftDown = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",42,0xe60bb539)
HXLINE(  42)		efShiftDown = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",43,0xe60bb539)
HXLINE(  43)		efCtrlDown = (int)4;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",44,0xe60bb539)
HXLINE(  44)		efAltDown = (int)8;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.MouseEvent","boot",0x58b296fa,"openfl._legacy.events.MouseEvent.boot","openfl/_legacy/events/MouseEvent.hx",45,0xe60bb539)
