...
void EventDispatcher_obj::__construct(::Dynamic target){
            	HX_STACK_FRAME("openfl._legacy.events.EventDispatcher","new",0x6a7bf2c2,"openfl._legacy.events.EventDispatcher.new","openfl/_legacy/events/EventDispatcher.hx",22,0xebfd71ed)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
HXLINE(  22)		Bool _hx_tmp = hx::IsNotNull( target );
...
HXLINE(  33)		Bool _hx_tmp = hx::IsNull( this->_hx___eventMap );
HXDLIN(  33)		if (_hx_tmp) {
HXLINE(  35)			this->_hx___eventMap =  ::haxe::ds::StringMap_obj::__new();
            		}
HXLINE(  39)		Bool _hx_tmp1 = !(this->_hx___eventMap->exists(type));
HXDLIN(  39)		if (_hx_tmp1) {
HXLINE(  41)			HX_VARI( ::Array< ::Dynamic>,list) = ::Array_obj< ::Dynamic>::__new();
HXLINE(  42)			list->push( ::openfl::_legacy::events::_EventDispatcher::Listener_obj::__new(listener,useCapture,priority));
...
HXLINE(  49)					HX_VARI( Int,i) = _g1++;
HXLINE(  51)					Bool _hx_tmp2 = ::Reflect_obj::compareMethods(list1->__get(i).StaticCast<  ::openfl::_legacy::events::_EventDispatcher::Listener >()->callback,listener);
HXDLIN(  51)					if (_hx_tmp2) {
HXLINE(  51)						return;
            					}
            				}
            			}
HXLINE(  55)			list1->push( ::openfl::_legacy::events::_EventDispatcher::Listener_obj::__new(listener,useCapture,priority));
...
HXDLIN(  65)		Bool _hx_tmp1 = hx::IsNotNull( this->_hx___eventMap );
...
HXLINE(  67)		::String key = event->get_type();
HXDLIN(  67)		HX_VARI( ::Array< ::Dynamic>,list) = ( (::Array< ::Dynamic>)(this->_hx___eventMap->get(key)) );
HXLINE(  69)		Bool _hx_tmp2 = hx::IsNull( list );
HXDLIN(  69)		if (_hx_tmp2) {
HXLINE(  69)			return false;
            		}
HXLINE(  71)		 ::Dynamic _hx_tmp3 = event->get_target();
HXDLIN(  71)		Bool _hx_tmp4 = hx::IsNull( _hx_tmp3 );
HXDLIN(  71)		if (_hx_tmp4) {
HXLINE(  73)			Bool _hx_tmp5 = hx::IsNotNull( this->_hx___targetDispatcher );
...
HXLINE(  87)		Int _hx_tmp6 = event->get_eventPhase();
HXDLIN(  87)		HX_VARI( Bool,capture) = (_hx_tmp6 == (int)1);
...
HXLINE(  95)			Bool _hx_tmp7 = (listener->useCapture == capture);
...
HXLINE( 108)			Bool _hx_tmp8 = hx::IsEq( listener,list->__get(index).StaticCast<  ::openfl::_legacy::events::_EventDispatcher::Listener >() );
...
Bool EventDispatcher_obj::hasEventListener(::String type){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
HXLINE( 123)		Bool _hx_tmp = hx::IsNull( this->_hx___eventMap );
...
HXLINE( 137)				HX_VARI( Int,i) = _g1++;
HXLINE( 139)				Bool _hx_tmp2 = list->__get(i).StaticCast<  ::openfl::_legacy::events::_EventDispatcher::Listener >()->match(listener,capture);
...
HXLINE( 148)		Bool _hx_tmp3 = (list->length == (int)0);
HXDLIN( 148)		if (_hx_tmp3) {
HXLINE( 150)			this->_hx___eventMap->remove(type);
            		}
HXLINE( 154)		Bool _hx_tmp4 = !(( (Bool)( ::Dynamic(this->_hx___eventMap->iterator()->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
...
::String EventDispatcher_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 165)		hx::Class _hx_tmp = ::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 165)		HX_VARI( ::String,full) = ::Type_obj::getClassName(_hx_tmp);
...
Bool EventDispatcher_obj::willTrigger(::String type){
            	HX_STACK_FRAME("openfl._legacy.events.EventDispatcher","willTrigger",0x7ac448a8,"openfl._legacy.events.EventDispatcher.willTrigger","openfl/_legacy/events/EventDispatcher.hx",175,0xebfd71ed)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
...
void EventDispatcher_obj::_hx___dispatchCompleteEvent(){
            	HX_STACK_FRAME("openfl._legacy.events.EventDispatcher","__dispatchCompleteEvent",0x002ac5c9,"openfl._legacy.events.EventDispatcher.__dispatchCompleteEvent","openfl/_legacy/events/EventDispatcher.hx",182,0xebfd71ed)
            	HX_STACK_THIS(this)
HXLINE( 182)		this->dispatchEvent( ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::COMPLETE,null(),null()));
            	}
...
void EventDispatcher_obj::_hx___dispatchIOErrorEvent(){
            	HX_STACK_FRAME("openfl._legacy.events.EventDispatcher","__dispatchIOErrorEvent",0x8653da70,"openfl._legacy.events.EventDispatcher.__dispatchIOErrorEvent","openfl/_legacy/events/EventDispatcher.hx",189,0xebfd71ed)
            	HX_STACK_THIS(this)
HXLINE( 189)		this->dispatchEvent( ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),null(),null(),null(),null()));
            	}
...
Int EventDispatcher_obj::_hx___sortByPriority( ::openfl::_legacy::events::_EventDispatcher::Listener l1, ::openfl::_legacy::events::_EventDispatcher::Listener l2){
            	HX_STACK_FRAME("openfl._legacy.events.EventDispatcher","__sortByPriority",0x571c1cd7,"openfl._legacy.events.EventDispatcher.__sortByPriority","openfl/_legacy/events/EventDispatcher.hx",196,0xebfd71ed)
            	HX_STACK_ARG(l1,"l1")
            	HX_STACK_ARG(l2,"l2")
