...
hx::ObjectPtr< SystemEvent_obj > SystemEvent_obj::__new(::String type,hx::Null< Bool >  __o_bubbles,hx::Null< Bool >  __o_cancelable,hx::Null< Int >  __o_data)
{
	...
	_hx_result->__construct(type,__o_bubbles,__o_cancelable,__o_data);
	return _hx_result;
}
...
Dynamic SystemEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event SystemEvent_obj::clone(){
            	HX_STACK_FRAME("openfl._legacy.events.SystemEvent","clone",0x962f4689,"openfl._legacy.events.SystemEvent.clone","openfl/_legacy/events/SystemEvent.hx",25,0x919fdfe3)
            	HX_STACK_THIS(this)
...
HXDLIN(  25)		return  ::openfl::_legacy::events::SystemEvent_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,this->data);
            	}


::String SystemEvent_obj::toString(){
            	HX_STACK_FRAME("openfl._legacy.events.SystemEvent","toString",0x6519e100,"openfl._legacy.events.SystemEvent.toString","openfl/_legacy/events/SystemEvent.hx",32,0x919fdfe3)
            	HX_STACK_THIS(this)
HXLINE(  32)		::String _hx_tmp = this->get_type();
HXDLIN(  32)		::String _hx_tmp1 = ((HX_("[SystemEvent type=",33,96,7e,b4) + _hx_tmp) + HX_(" bubbles=",16,5f,ba,28));
...
HXDLIN(  32)		return ((((_hx_tmp4 + _hx_tmp6) + HX_(" data=",b3,9a,f3,9f)) + this->data) + HX_("]",5d,00,00,00));
            	}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.events.SystemEvent","boot",0xdebada86,"openfl._legacy.events.SystemEvent.boot","openfl/_legacy/events/SystemEvent.hx",10,0x919fdfe3)
