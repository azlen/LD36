...
hx::ObjectPtr< TouchEvent_obj > TouchEvent_obj::__new(::String type,hx::Null< Bool >  __o_bubbles,hx::Null< Bool >  __o_cancelable,hx::Null< Float >  __o_localX,hx::Null< Float >  __o_localY,hx::Null< Float >  __o_sizeX,hx::Null< Float >  __o_sizeY, ::openfl::_legacy::display::InteractiveObject relatedObject,hx::Null< Bool >  __o_ctrlKey,hx::Null< Bool >  __o_altKey,hx::Null< Bool >  __o_shiftKey,hx::Null< Bool >  __o_buttonDown,hx::Null< Int >  __o_delta,hx::Null< Bool >  __o_commandKey,hx::Null< Int >  __o_clickCount)
{
	...
	_hx_result->__construct(type,__o_bubbles,__o_cancelable,__o_localX,__o_localY,__o_sizeX,__o_sizeY,relatedObject,__o_ctrlKey,__o_altKey,__o_shiftKey,__o_buttonDown,__o_delta,__o_commandKey,__o_clickCount);
	return _hx_result;
}
...
HXLINE(  54)		Bool _hx_tmp = this->get_bubbles();
HXDLIN(  54)		Bool _hx_tmp1 = this->get_cancelable();
HXDLIN(  54)		 ::openfl::_legacy::display::InteractiveObject _hx_tmp2;
HXDLIN(  54)		Bool _hx_tmp3 = hx::IsNull( related );
HXDLIN(  54)		if (_hx_tmp3) {
HXLINE(  54)			_hx_tmp2 = this->relatedObject;
            		}
            		else {
HXLINE(  54)			_hx_tmp2 = related;
            		}
HXDLIN(  54)		HX_VARI(  ::openfl::_legacy::events::TouchEvent,touchEvent) =  ::openfl::_legacy::events::TouchEvent_obj::__new(type,_hx_tmp,_hx_tmp1,this->localX,this->localY,this->sizeX,this->sizeY,_hx_tmp2,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
HXLINE(  56)		touchEvent->touchPointID = this->touchPointID;
HXLINE(  57)		touchEvent->isPrimaryTouchPoint = this->isPrimaryTouchPoint;
HXLINE(  59)		Bool _hx_tmp4 = hx::IsNotNull( target );
HXDLIN(  59)		if (_hx_tmp4) {
HXLINE(  61)			touchEvent->set_target(target);
            		}
HXLINE(  65)		return touchEvent;
            	}
...
HXLINE(  43)		Float _hx_tmp = local->x;
HXDLIN(  43)		Float _hx_tmp1 = local->y;
HXDLIN(  43)		Bool _hx_tmp2 = (((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efCtrlDown) != (int)0);
HXDLIN(  43)		Bool _hx_tmp3 = (((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efAltDown) != (int)0);
HXDLIN(  43)		Bool _hx_tmp4 = (((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efShiftDown) != (int)0);
HXDLIN(  43)		Bool _hx_tmp5 = (((int)flags & (int)::openfl::_legacy::events::MouseEvent_obj::efLeftDown) != (int)0);
HXDLIN(  43)		HX_VARI(  ::openfl::_legacy::events::TouchEvent,touchEvent) =  ::openfl::_legacy::events::TouchEvent_obj::__new(type,true,false,_hx_tmp,_hx_tmp1,sizeX,sizeY,null(),_hx_tmp2,_hx_tmp3,_hx_tmp4,_hx_tmp5,(int)0,null(),(int)0);
HXLINE(  44)		touchEvent->stageX =  ::Dynamic(event->__Field(HX_("x",78,00,00,00),hx::paccDynamic));
HXLINE(  45)		touchEvent->stageY =  ::Dynamic(event->__Field(HX_("y",79,00,00,00),hx::paccDynamic));
...
{
{
            	HX_STACK_FRAME("openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",11,0x427be0d3)
HXLINE(  11)		TOUCH_BEGIN = HX_("touchBegin",ea,cd,e6,a9);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",12,0x427be0d3)
HXLINE(  12)		TOUCH_END = HX_("touchEnd",5c,c5,09,00);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",13,0x427be0d3)
HXLINE(  13)		TOUCH_MOVE = HX_("touchMove",70,72,cd,0d);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",14,0x427be0d3)
HXLINE(  14)		TOUCH_OUT = HX_("touchOut",0f,62,11,00);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",15,0x427be0d3)
HXLINE(  15)		TOUCH_OVER = HX_("touchOver",b3,20,25,0f);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",16,0x427be0d3)
HXLINE(  16)		TOUCH_ROLL_OUT = HX_("touchRollOut",12,0f,74,87);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",17,0x427be0d3)
HXLINE(  17)		TOUCH_ROLL_OVER = HX_("touchRollOver",50,d6,19,fe);
            	}
{
            	HX_STACK_FRAME("openfl._legacy.events.TouchEvent","boot",0xd2385d14,"openfl._legacy.events.TouchEvent.boot","openfl/_legacy/events/TouchEvent.hx",18,0x427be0d3)
