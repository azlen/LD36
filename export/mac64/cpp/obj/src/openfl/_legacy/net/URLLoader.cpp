...
HXLINE( 202)		Bool _hx_tmp = hx::IsNotNull( request );
...
HXLINE( 220)		HX_VARI(  ::openfl::_legacy::events::HTTPStatusEvent,event) =  ::openfl::_legacy::events::HTTPStatusEvent_obj::__new(::openfl::_legacy::events::HTTPStatusEvent_obj::HTTP_STATUS,false,false,code);
...
HXLINE( 228)					::String _hx_tmp = header.substr((int)0,index);
HXDLIN( 228)					Int _hx_tmp1 = (index + (int)2);
HXDLIN( 228)					Int _hx_tmp2 = ((header.length - index) - (int)4);
HXDLIN( 228)					::String _hx_tmp3 = header.substr(_hx_tmp1,_hx_tmp2);
HXDLIN( 228)					event->responseHeaders->push( ::openfl::net::URLRequestHeader_obj::__new(_hx_tmp,_hx_tmp3));
            				}
            			}
            		}
...
HXLINE( 276)				Bool _hx_tmp1 = hx::IsNull( bytes );
HXDLIN( 276)				if (_hx_tmp1) {
HXLINE( 278)					HX_STACK_DO_THROW(((HX_("Could not open file \"",48,89,1a,4a) + request->url) + HX_("\"",22,00,00,00)));
            				}
HXLINE( 282)				{
HXLINE( 282)					HX_VARI(  ::Dynamic,_g) = this->dataFormat;
HXDLIN( 282)					 ::Dynamic _hx_switch_0 = _g;
            					if (  (_hx_switch_0==(int)1) ){
HXLINE( 284)						this->data = bytes->asString();
HXDLIN( 284)						goto _hx_goto_1;
            					}
            					if (  (_hx_switch_0==(int)2) ){
HXLINE( 285)						::String _hx_tmp2 = bytes->asString();
HXDLIN( 285)						this->data =  ::openfl::net::URLVariables_obj::__new(_hx_tmp2);
HXDLIN( 285)						goto _hx_goto_1;
            					}
            					/* default */{
...
HXLINE( 305)			Bool _hx_tmp3 = hx::IsNull( this->_hx___handle );
...
HXLINE( 323)		::openfl::_legacy::net::URLLoader_obj::enqueueEvent(hx::ObjectPtr<OBJ_>(this), ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),true,false,msg,null()));
            	}
...
void URLLoader_obj::update(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 330)		Bool _hx_tmp = hx::IsNotNull( this->_hx___handle );
...
HXLINE( 336)				_hx_tmp1 = (this->bytesTotal > (int)0);
            			}
            			else {
HXLINE( 336)				_hx_tmp1 = false;
            			}
HXDLIN( 336)			if (_hx_tmp1) {
HXLINE( 337)				::openfl::_legacy::net::URLLoader_obj::enqueueEvent(hx::ObjectPtr<OBJ_>(this), ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::OPEN,null(),null()));
            			}
HXLINE( 340)			Bool _hx_tmp2;
HXDLIN( 340)			if ((this->bytesTotal > (int)0)) {
HXLINE( 340)				_hx_tmp2 = (this->bytesLoaded != old_loaded);
            			}
            			else {
HXLINE( 340)				_hx_tmp2 = false;
            			}
HXDLIN( 340)			if (_hx_tmp2) {
HXLINE( 341)				HX_VARI(  ::openfl::events::ProgressEvent,evt) =  ::openfl::events::ProgressEvent_obj::__new(HX_("progress",ad,f7,2a,86),false,false,this->bytesLoaded,this->bytesTotal);
...
HXLINE( 347)			Bool _hx_tmp3 = (this->state == (int)3);
...
HXLINE( 351)				{
HXLINE( 351)					HX_VARI(  ::Dynamic,_g) = this->dataFormat;
HXDLIN( 351)					 ::Dynamic _hx_switch_0 = _g;
            					if (  (_hx_switch_0==(int)1) ||  (_hx_switch_0==(int)2) ){
HXLINE( 353)						 ::Dynamic _hx_tmp4;
HXDLIN( 353)						Bool _hx_tmp5 = hx::IsNull( bytes );
HXDLIN( 353)						if (_hx_tmp5) {
HXLINE( 353)							_hx_tmp4 = HX_("",00,00,00,00);
            						}
            						else {
HXLINE( 353)							_hx_tmp4 = bytes->asString();
            						}
HXDLIN( 353)						this->data = _hx_tmp4;
...
HXLINE( 361)					HX_VARI(  ::openfl::events::IOErrorEvent,event) =  ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),true,false,this->data,code);
HXLINE( 362)					this->_hx___handle = null();
HXLINE( 363)					::openfl::_legacy::net::URLLoader_obj::enqueueEvent(hx::ObjectPtr<OBJ_>(this),event);
            				}
            			}
            			else {
HXLINE( 366)				Bool _hx_tmp6 = (this->state == (int)4);
HXDLIN( 366)				if (_hx_tmp6) {
HXLINE( 367)					this->dispatchHTTPStatus(code);
HXLINE( 368)					HX_VARI( ::String,errorMessage) = ::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::getInstance()->getErrorMessage(this->_hx___handle);
HXLINE( 369)					HX_VARI_NAME(  ::openfl::events::IOErrorEvent,event1,"event") =  ::openfl::events::IOErrorEvent_obj::__new(HX_("ioError",02,fe,41,76),true,false,errorMessage,code);
...
HXLINE( 383)		Bool _hx_tmp = hx::IsNotNull( this->_hx___onComplete );
HXDLIN( 383)		if (_hx_tmp) {
HXLINE( 385)			Bool _hx_tmp1 = ( (Bool)(this->_hx___onComplete(this->data)) );
HXDLIN( 385)			if (_hx_tmp1) {
HXLINE( 387)				::openfl::_legacy::net::URLLoader_obj::enqueueEvent(hx::ObjectPtr<OBJ_>(this), ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::COMPLETE,null(),null()));
            			}
            			else {
...
HXLINE( 397)			::openfl::_legacy::net::URLLoader_obj::enqueueEvent(hx::ObjectPtr<OBJ_>(this), ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::COMPLETE,null(),null()));
            		}
            	}
...
HXLINE( 417)		Bool _hx_tmp = hx::IsNotNull( evt );
HXDLIN( 417)		if (_hx_tmp) {
HXLINE( 418)			( ( ::openfl::_legacy::events::EventDispatcher)(evt->__Field(HX_("loader",13,48,6f,58),hx::paccDynamic)) )->dispatchEvent( ::Dynamic(evt->__Field(HX_("event",1a,c8,c4,75),hx::paccDynamic)));
            		}
            	}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",174,0xef414054)
HXLINE( 174)		urlInvalid = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",175,0xef414054)
HXLINE( 175)		urlInit = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",178,0xef414054)
HXLINE( 178)		urlLoading = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",180,0xef414054)
HXLINE( 180)		urlComplete = (int)3;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",181,0xef414054)
HXLINE( 181)		urlError = (int)4;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLLoader","boot",0xcebdd133,"openfl._legacy.net.URLLoader.boot","openfl/_legacy/net/URLLoader.hx",186,0xef414054)
