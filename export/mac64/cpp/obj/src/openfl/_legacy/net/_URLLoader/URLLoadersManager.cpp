...
void URLLoadersManager_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  47)		this->activeLoaders =  ::List_obj::__new();
HXLINE(  48)		this->loadsQueue = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  49)		this->loadsQueueMutex =  ::cpp::vm::Mutex_obj::__new();
...
HXLINE(  60)			Bool _hx_tmp = hx::IsNotNull( loadCall );
HXDLIN(  60)			if (_hx_tmp) {
HXLINE(  61)				( ( ::openfl::_legacy::net::URLLoader)(loadCall->__Field(HX_("loader",13,48,6f,58),hx::paccDynamic)) )->loadInCURLThread( ::Dynamic(loadCall->__Field(HX_("request",4f,df,84,44),hx::paccDynamic)));
            			}
HXLINE(  64)			Bool _hx_tmp1 = !(this->activeLoaders->isEmpty());
...
HXLINE(  67)				this->activeLoaders =  ::List_obj::__new();
HXLINE(  68)				{
HXLINE(  68)					HX_VARI(  ::_List::ListNode,_g_head) = oldLoaders->h;
HXDLIN(  68)					while(true){
HXLINE(  68)						Bool _hx_tmp2 = !(hx::IsNotNull( _g_head ));
HXDLIN(  68)						if (_hx_tmp2) {
HXLINE(  68)							goto _hx_goto_1;
            						}
HXDLIN(  68)						HX_VARI(  ::openfl::_legacy::net::URLLoader,val) = ( ( ::openfl::_legacy::net::URLLoader)(_g_head->item) );
HXLINE(  53)						_g_head = _g_head->next;
HXLINE(  69)						val->update();
HXLINE(  70)						Bool _hx_tmp3 = (val->state == (int)2);
...
HXLINE(  76)			HX_VARI( ::hx::EnumBase,msg) = ::cpp::vm::Thread_obj::readMessage(false);
HXLINE(  77)			Bool _hx_tmp4 = hx::IsNotNull( msg );
HXDLIN(  77)			if (_hx_tmp4) {
HXLINE(  78)				msg = msg;
HXLINE(  79)				Int _hx_tmp5 = ( ( ::hx::EnumBase)(msg) )->_hx_getIndex();
HXDLIN(  79)				switch((int)(_hx_tmp5)){
            					case (int)0: {
HXLINE(  81)						HX_VARI( ::Array< ::String >,cookies) = ( (::Array< ::String >)(::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::lime_curl_get_cookies(msg->_hx_getObject(1))) );
HXLINE(  82)						::hx::EnumBase _hx_tmp6 = ::openfl::_legacy::net::_URLLoader::ManagersThreadMessage_obj::GetCookiesResponse(cookies);
HXDLIN(  82)						msg->_hx_getObject(0).StaticCast<  ::cpp::vm::Thread >()->sendMessage(_hx_tmp6);
            					}
            					break;
            					case (int)2: {
...
Int URLLoadersManager_obj::getCode( ::Dynamic handle){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 120)		return ( (Int)(::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::lime_curl_get_code(handle)) );
            	}
...
::String URLLoadersManager_obj::getErrorMessage( ::Dynamic handle){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 124)		return ( (::String)(::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::lime_curl_get_error_message(handle)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(URLLoadersManager_obj,getErrorMessage,return )
 ...
 ::openfl::_legacy::utils::ByteArray URLLoadersManager_obj::getData( ::Dynamic handle){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 128)		return ( ( ::openfl::_legacy::utils::ByteArray)(::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::lime_curl_get_data(handle)) );
            	}
...
::Array< ::String > URLLoadersManager_obj::getHeaders( ::Dynamic handle){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 132)		return ( (::Array< ::String >)(::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::lime_curl_get_headers(handle)) );
            	}
...
HXLINE( 136)		::hx::EnumBase _hx_tmp = ::openfl::_legacy::net::_URLLoader::ManagersThreadMessage_obj::InitializeCall(caCertFilePath);
HXDLIN( 136)		this->managersThread->sendMessage(_hx_tmp);
HXLINE( 137)		return;
            	}
...
::Array< ::String > URLLoadersManager_obj::getCookies( ::Dynamic handle){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 141)		 ::cpp::vm::Thread _hx_tmp = ::cpp::vm::Thread_obj::current();
HXDLIN( 141)		::hx::EnumBase _hx_tmp1 = ::openfl::_legacy::net::_URLLoader::ManagersThreadMessage_obj::GetCookiesCall(_hx_tmp,handle);
HXDLIN( 141)		this->managersThread->sendMessage(_hx_tmp1);
HXLINE( 142)		HX_VARI( ::hx::EnumBase,msg) = ::cpp::vm::Thread_obj::readMessage(true);
HXLINE( 143)		Int _hx_tmp2 = ( ( ::hx::EnumBase)(msg) )->_hx_getIndex();
HXDLIN( 143)		if ((_hx_tmp2 == (int)1)) {
...
HXLINE(  40)		Bool _hx_tmp = hx::IsNull( ::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::instance );
HXDLIN(  40)		if (_hx_tmp) {
HXLINE(  41)			::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::instance =  ::openfl::_legacy::net::_URLLoader::URLLoadersManager_obj::__new();
            		}
...
{
{
            	HX_STACK_FRAME("openfl._legacy.net._URLLoader.URLLoadersManager","boot",0x968a9aba,"openfl._legacy.net._URLLoader.URLLoadersManager.boot","openfl/_legacy/net/URLLoader.hx",154,0xef414054)
...
{
            	HX_STACK_FRAME("openfl._legacy.net._URLLoader.URLLoadersManager","boot",0x968a9aba,"openfl._legacy.net._URLLoader.URLLoadersManager.boot","openfl/_legacy/net/URLLoader.hx",155,0xef414054)
...
{
            	HX_STACK_FRAME("openfl._legacy.net._URLLoader.URLLoadersManager","boot",0x968a9aba,"openfl._legacy.net._URLLoader.URLLoadersManager.boot","openfl/_legacy/net/URLLoader.hx",156,0xef414054)
...
{
            	HX_STACK_FRAME("openfl._legacy.net._URLLoader.URLLoadersManager","boot",0x968a9aba,"openfl._legacy.net._URLLoader.URLLoadersManager.boot","openfl/_legacy/net/URLLoader.hx",157,0xef414054)
...
{
            	HX_STACK_FRAME("openfl._legacy.net._URLLoader.URLLoadersManager","boot",0x968a9aba,"openfl._legacy.net._URLLoader.URLLoadersManager.boot","openfl/_legacy/net/URLLoader.hx",158,0xef414054)
...
{
            	HX_STACK_FRAME("openfl._legacy.net._URLLoader.URLLoadersManager","boot",0x968a9aba,"openfl._legacy.net._URLLoader.URLLoadersManager.boot","openfl/_legacy/net/URLLoader.hx",159,0xef414054)
...
{
            	HX_STACK_FRAME("openfl._legacy.net._URLLoader.URLLoadersManager","boot",0x968a9aba,"openfl._legacy.net._URLLoader.URLLoadersManager.boot","openfl/_legacy/net/URLLoader.hx",160,0xef414054)
...
{
            	HX_STACK_FRAME("openfl._legacy.net._URLLoader.URLLoadersManager","boot",0x968a9aba,"openfl._legacy.net._URLLoader.URLLoadersManager.boot","openfl/_legacy/net/URLLoader.hx",161,0xef414054)
...
{
            	HX_STACK_FRAME("openfl._legacy.net._URLLoader.URLLoadersManager","boot",0x968a9aba,"openfl._legacy.net._URLLoader.URLLoadersManager.boot","openfl/_legacy/net/URLLoader.hx",162,0xef414054)
