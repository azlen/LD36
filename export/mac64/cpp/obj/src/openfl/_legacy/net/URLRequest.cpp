...
HXLINE(  36)		Bool _hx_tmp = hx::IsNotNull( url );
...
void URLRequest_obj::_hx___prepare(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  73)		Bool _hx_tmp = hx::IsNull( this->userAgent );
HXDLIN(  73)		if (_hx_tmp) {
HXLINE(  75)			this->userAgent = HX_("",00,00,00,00);
            		}
HXLINE(  79)		Bool _hx_tmp1 = hx::IsNull( this->data );
HXDLIN(  79)		if (_hx_tmp1) {
HXLINE(  81)			this->_hx___bytes =  ::openfl::_legacy::utils::ByteArray_obj::__new(null());
            		}
            		else {
HXLINE(  83)			Bool _hx_tmp2 = ::Std_obj::is(this->data,hx::ClassOf< ::openfl::_legacy::utils::ByteArray >());
HXDLIN(  83)			if (_hx_tmp2) {
HXLINE(  85)				this->_hx___bytes = this->data;
            			}
            			else {
HXLINE(  87)				Bool _hx_tmp3 = ::Std_obj::is(this->data,hx::ClassOf< ::openfl::net::URLVariables >());
HXDLIN(  87)				if (_hx_tmp3) {
HXLINE(  89)					HX_VARI(  ::openfl::net::URLVariables,vars) = ( ( ::openfl::net::URLVariables)(this->data) );
HXLINE(  90)					HX_VARI( ::String,str) = vars->toString();
HXLINE(  91)					this->_hx___bytes =  ::openfl::_legacy::utils::ByteArray_obj::__new(null());
HXLINE(  92)					this->_hx___bytes->writeUTFBytes(str);
            				}
            				else {
HXLINE(  94)					Bool _hx_tmp4 = ::Std_obj::is(this->data,hx::ClassOf< ::String >());
HXDLIN(  94)					if (_hx_tmp4) {
HXLINE(  96)						HX_VARI_NAME( ::String,str1,"str") = ( (::String)(this->data) );
HXLINE(  97)						this->_hx___bytes =  ::openfl::_legacy::utils::ByteArray_obj::__new(null());
HXLINE(  98)						this->_hx___bytes->writeUTFBytes(str1);
            					}
            					else {
HXLINE( 100)						Bool _hx_tmp5 = ::Std_obj::is(this->data,hx::ClassOf< ::Dynamic >());
HXDLIN( 100)						if (_hx_tmp5) {
HXLINE( 102)							HX_VARI_NAME(  ::openfl::net::URLVariables,vars1,"vars") =  ::openfl::net::URLVariables_obj::__new(null());
HXLINE( 104)							{
...
HXDLIN( 104)									++_g;
HXLINE( 106)									 ::Dynamic _hx_tmp6 = ::Reflect_obj::field(this->data,i);
HXDLIN( 106)									::Reflect_obj::setField(vars1,i,_hx_tmp6);
            								}
            							}
HXLINE( 110)							HX_VARI_NAME( ::String,str2,"str") = vars1->toString();
HXLINE( 111)							this->_hx___bytes =  ::openfl::_legacy::utils::ByteArray_obj::__new(null());
...
{
{
            	HX_STACK_FRAME("openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",12,0xc5bb36e6)
HXLINE(  12)		AUTH_BASIC = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",13,0xc5bb36e6)
HXLINE(  13)		AUTH_DIGEST = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",14,0xc5bb36e6)
HXLINE(  14)		AUTH_GSSNEGOTIATE = (int)4;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",15,0xc5bb36e6)
HXLINE(  15)		AUTH_NTLM = (int)8;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",16,0xc5bb36e6)
HXLINE(  16)		AUTH_DIGEST_IE = (int)16;
            	}
{
            	HX_STACK_FRAME("openfl._legacy.net.URLRequest","boot",0xccf7d82b,"openfl._legacy.net.URLRequest.boot","openfl/_legacy/net/URLRequest.hx",17,0xc5bb36e6)
