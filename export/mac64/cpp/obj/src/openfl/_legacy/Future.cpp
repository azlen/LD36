...
HXLINE(1694)		Bool _hx_tmp = hx::IsNotNull( work );
HXDLIN(1694)		if (_hx_tmp) {
HXLINE(1696)			HX_VARI(  ::openfl::_legacy::Promise,promise) =  ::openfl::_legacy::Promise_obj::__new();
HXLINE(1697)			promise->future = hx::ObjectPtr<OBJ_>(this);
HXLINE(1699)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(1701)				HX_VARI(  ::Dynamic,result) = work();
...
HXLINE(1717)		Bool _hx_tmp = hx::IsNotNull( listener );
HXDLIN(1717)		if (_hx_tmp) {
HXLINE(1719)			Bool _hx_tmp1 = this->_hx___completed;
HXDLIN(1719)			if (_hx_tmp1) {
HXLINE(1721)				listener(this->value);
            			}
            			else {
HXLINE(1723)				Bool _hx_tmp2 = !(this->_hx___errored);
HXDLIN(1723)				if (_hx_tmp2) {
HXLINE(1725)					Bool _hx_tmp3 = hx::IsNull( this->_hx___completeListeners );
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onComplete,return )
 ...
 ::openfl::_legacy::Future Future_obj::onError( ::Dynamic listener){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE(1744)		Bool _hx_tmp = hx::IsNotNull( listener );
HXDLIN(1744)		if (_hx_tmp) {
HXLINE(1746)			Bool _hx_tmp1 = this->_hx___errored;
HXDLIN(1746)			if (_hx_tmp1) {
HXLINE(1748)				listener(this->_hx___errorMessage);
            			}
            			else {
HXLINE(1750)				Bool _hx_tmp2 = !(this->_hx___completed);
HXDLIN(1750)				if (_hx_tmp2) {
HXLINE(1752)					Bool _hx_tmp3 = hx::IsNull( this->_hx___errorListeners );
HXDLIN(1752)					if (_hx_tmp3) {
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onError,return )
 ...
 ::openfl::_legacy::Future Future_obj::onProgress( ::Dynamic listener){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE(1771)		Bool _hx_tmp = hx::IsNotNull( listener );
HXDLIN(1771)		if (_hx_tmp) {
HXLINE(1773)			Bool _hx_tmp1 = hx::IsNull( this->_hx___progressListeners );
HXDLIN(1773)			if (_hx_tmp1) {
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onProgress,return )
 ...
 ::openfl::_legacy::Future Future_obj::then( ::Dynamic next){
            	HX_STACK_FRAME("openfl._legacy.Future","then",0x005d7964,"openfl._legacy.Future.then","openfl/_legacy/Assets.hx",1790,0x9276b055)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(next,"next")
HXLINE(1790)		Bool _hx_tmp = this->_hx___completed;
HXDLIN(1790)		if (_hx_tmp) {
HXLINE(1792)			return ( ( ::openfl::_legacy::Future)(next(this->value)) );
            		}
            		else {
HXLINE(1794)			Bool _hx_tmp1 = this->_hx___errored;
HXDLIN(1794)			if (_hx_tmp1) {
HXLINE(1796)				HX_VARI(  ::openfl::_legacy::Future,future) =  ::openfl::_legacy::Future_obj::__new(null());
...
HXLINE(1798)				return future;
            				...
            				void _hx_run( ::Dynamic val){
            					HX_STACK_FRAME("openfl._legacy.Future","then",0x005d7964,"openfl._legacy.Future.then","openfl/_legacy/Assets.hx",1807,0x9276b055)
...
HXLINE(1802)				HX_VARI(  ::openfl::_legacy::Promise,promise) =  ::openfl::_legacy::Promise_obj::__new();
