...
{
{
            	HX_STACK_FRAME("openfl.display3D.Context3DClearMask","boot",0x4d1639ae,"openfl.display3D.Context3DClearMask.boot","openfl/display3D/Context3DClearMask.hx",10,0x30405b0a)
HXLINE(  10)		ALL = (int)17664;
            	}
{
            	HX_STACK_FRAME("openfl.display3D.Context3DClearMask","boot",0x4d1639ae,"openfl.display3D.Context3DClearMask.boot","openfl/display3D/Context3DClearMask.hx",11,0x30405b0a)
HXLINE(  11)		COLOR = (int)16384;
            	}
{
            	HX_STACK_FRAME("openfl.display3D.Context3DClearMask","boot",0x4d1639ae,"openfl.display3D.Context3DClearMask.boot","openfl/display3D/Context3DClearMask.hx",12,0x30405b0a)
HXLINE(  12)		DEPTH = (int)256;
            	}
{
            	HX_STACK_FRAME("openfl.display3D.Context3DClearMask","boot",0x4d1639ae,"openfl.display3D.Context3DClearMask.boot","openfl/display3D/Context3DClearMask.hx",13,0x30405b0a)
