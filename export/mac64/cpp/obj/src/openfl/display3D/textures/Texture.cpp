...
HXLINE(  69)		Int _hx_tmp = bitmapData->get_width();
HXDLIN(  69)		Int _hx_tmp1 = bitmapData->get_height();
HXDLIN(  69)		Bool _hx_tmp2 = bitmapData->get_transparent();
HXDLIN(  69)		HX_VARI(  ::openfl::_legacy::display::BitmapData,rgbaData) =  ::openfl::_legacy::display::BitmapData_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,null(),null());
HXDLIN(  69)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,rect) = bitmapData->get_rect();
HXDLIN(  69)		HX_VARI(  ::openfl::_legacy::geom::Point,point) =  ::openfl::_legacy::geom::Point_obj::__new((int)0,(int)0);
HXDLIN(  69)		rgbaData->copyChannel(bitmapData,rect,point,(int)2,(int)1);
HXDLIN(  69)		rgbaData->copyChannel(bitmapData,rect,point,(int)4,(int)2);
HXDLIN(  69)		rgbaData->copyChannel(bitmapData,rect,point,(int)8,(int)4);
HXDLIN(  69)		rgbaData->copyChannel(bitmapData,rect,point,(int)1,(int)8);
HXDLIN(  69)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,pixels) = rgbaData->getPixels(rect);
...
Int miplevel = __o_miplevel.Default(0);
            	...
            	HX_STACK_ARG(byteArrayOffset,"byteArrayOffset")
            	HX_STACK_ARG(miplevel,"miplevel")
HXLINE( 112)		HX_VARI(  ::openfl::_legacy::utils::UInt8Array,source) =  ::openfl::_legacy::utils::UInt8Array_obj::__new(data,null(),null());
...
HXDLIN( 122)			Bool _hx_tmp1 = hx::IsNull( texture );
...
HXLINE( 124)		Bool _hx_tmp2 = this->optimizeForRenderToTexture;
...
HXDLIN( 134)			 ::openfl::_legacy::utils::ByteArray _hx_tmp3;
HXDLIN( 134)			Bool _hx_tmp4 = hx::IsNull( data );
HXDLIN( 134)			if (_hx_tmp4) {
HXLINE( 134)				_hx_tmp3 = null();
            			}
            			else {
HXLINE( 134)				_hx_tmp3 = data->getByteBuffer();
            			}
HXDLIN( 134)			 ::Dynamic _hx_tmp5;
HXDLIN( 134)			Bool _hx_tmp6 = hx::IsNull( data );
HXDLIN( 134)			if (_hx_tmp6) {
HXLINE( 134)				_hx_tmp5 = null();
            			}
            			else {
HXLINE( 134)				_hx_tmp5 = data->getStart();
            			}
HXDLIN( 134)			::openfl::_legacy::gl::GL_obj::lime_gl_tex_image_2d((int)3553,miplevel,internalformat,width,height,(int)0,format,(int)5121,_hx_tmp3,_hx_tmp5);
            		}
