...
hx::ObjectPtr< Program3D_obj > Program3D_obj::__new( ::openfl::display3D::Context3D context, ::openfl::_legacy::gl::GLProgram program)
{
	...
	_hx_result->__construct(context,program);
	return _hx_result;
}
...
void Program3D_obj::dispose(){
            	HX_STACK_FRAME("openfl.display3D.Program3D","dispose",0x556f61ad,"openfl.display3D.Program3D.dispose","openfl/display3D/Program3D.hx",26,0x0a985b04)
            	HX_STACK_THIS(this)
...
HXLINE(  39)		Int _hx_tmp = ( (Int)(::openfl::_legacy::gl::GL_obj::lime_gl_get_program_parameter(this->glProgram->id,(int)35714)) );
