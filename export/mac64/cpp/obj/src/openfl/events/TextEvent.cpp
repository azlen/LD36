...
hx::ObjectPtr< TextEvent_obj > TextEvent_obj::__new(::String type,hx::Null< Bool >  __o_bubbles,hx::Null< Bool >  __o_cancelable,::String __o_text)
{
	...
	_hx_result->__construct(type,__o_bubbles,__o_cancelable,__o_text);
	return _hx_result;
}
...
Dynamic TextEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event TextEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  24)		::String _hx_tmp = this->get_type();
HXDLIN(  24)		Bool _hx_tmp1 = this->get_bubbles();
HXDLIN(  24)		Bool _hx_tmp2 = this->get_cancelable();
HXDLIN(  24)		HX_VARI(  ::openfl::events::TextEvent,event) =  ::openfl::events::TextEvent_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,this->text);
HXLINE(  25)		 ::Dynamic _hx_tmp3 = this->get_target();
HXDLIN(  25)		event->set_target(_hx_tmp3);
HXLINE(  26)		 ::Dynamic _hx_tmp4 = this->get_currentTarget();
HXDLIN(  26)		event->set_currentTarget(_hx_tmp4);
HXLINE(  30)		return event;
            	}


::String TextEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.TextEvent","toString",0x2a253b04,"openfl.events.TextEvent.toString","openfl/events/TextEvent.hx",37,0x23b91588)
            	HX_STACK_THIS(this)
HXLINE(  37)		return this->_hx___formatToString(HX_("TextEvent",0d,38,85,b0),::Array_obj< ::String >::fromData( _hx_array_data_0,4));
            	}
...
{
{
            	HX_STACK_FRAME("openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",7,0x23b91588)
HXLINE(   7)		LINK = HX_("link",fa,17,b3,47);
            	}
{
            	HX_STACK_FRAME("openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",8,0x23b91588)
