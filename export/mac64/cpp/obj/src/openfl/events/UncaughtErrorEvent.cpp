...
hx::ObjectPtr< UncaughtErrorEvent_obj > UncaughtErrorEvent_obj::__new(::String type,hx::Null< Bool >  __o_bubbles,hx::Null< Bool >  __o_cancelable, ::Dynamic error)
{
	...
	_hx_result->__construct(type,__o_bubbles,__o_cancelable,error);
	return _hx_result;
}
...
Dynamic UncaughtErrorEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event UncaughtErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  23)		::String _hx_tmp = this->get_type();
HXDLIN(  23)		Bool _hx_tmp1 = this->get_bubbles();
HXDLIN(  23)		Bool _hx_tmp2 = this->get_cancelable();
HXDLIN(  23)		HX_VARI(  ::openfl::events::UncaughtErrorEvent,event) =  ::openfl::events::UncaughtErrorEvent_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,this->error);
HXLINE(  24)		 ::Dynamic _hx_tmp3 = this->get_target();
HXDLIN(  24)		event->set_target(_hx_tmp3);
HXLINE(  25)		 ::Dynamic _hx_tmp4 = this->get_currentTarget();
HXDLIN(  25)		event->set_currentTarget(_hx_tmp4);
HXLINE(  29)		return event;
            	}


::String UncaughtErrorEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.UncaughtErrorEvent","toString",0x4ef19afc,"openfl.events.UncaughtErrorEvent.toString","openfl/events/UncaughtErrorEvent.hx",36,0x0dad2340)
            	HX_STACK_THIS(this)
HXLINE(  36)		return this->_hx___formatToString(HX_("UncaughtErrorEvent",47,72,9a,e0),::Array_obj< ::String >::fromData( _hx_array_data_0,4));
            	}
...
{
{
            	HX_STACK_FRAME("openfl.events.UncaughtErrorEvent","boot",0x5936e682,"openfl.events.UncaughtErrorEvent.boot","openfl/events/UncaughtErrorEvent.hx",7,0x0dad2340)
