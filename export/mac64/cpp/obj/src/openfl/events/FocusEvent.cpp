...
hx::ObjectPtr< FocusEvent_obj > FocusEvent_obj::__new(::String type,hx::Null< Bool >  __o_bubbles,hx::Null< Bool >  __o_cancelable, ::openfl::_legacy::display::InteractiveObject relatedObject,hx::Null< Bool >  __o_shiftKey,hx::Null< Int >  __o_keyCode)
{
	...
	_hx_result->__construct(type,__o_bubbles,__o_cancelable,relatedObject,__o_shiftKey,__o_keyCode);
	return _hx_result;
}
...
Dynamic FocusEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event FocusEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  33)		::String _hx_tmp = this->get_type();
HXDLIN(  33)		Bool _hx_tmp1 = this->get_bubbles();
HXDLIN(  33)		Bool _hx_tmp2 = this->get_cancelable();
HXDLIN(  33)		HX_VARI(  ::openfl::events::FocusEvent,event) =  ::openfl::events::FocusEvent_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,this->relatedObject,this->shiftKey,this->keyCode);
HXLINE(  34)		 ::Dynamic _hx_tmp3 = this->get_target();
HXDLIN(  34)		event->set_target(_hx_tmp3);
HXLINE(  35)		 ::Dynamic _hx_tmp4 = this->get_currentTarget();
HXDLIN(  35)		event->set_currentTarget(_hx_tmp4);
HXLINE(  39)		return event;
            	}


::String FocusEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.FocusEvent","toString",0x8b53f7a1,"openfl.events.FocusEvent.toString","openfl/events/FocusEvent.hx",46,0xe559e625)
            	HX_STACK_THIS(this)
HXLINE(  46)		return this->_hx___formatToString(HX_("FocusEvent",42,6d,d7,2e),::Array_obj< ::String >::fromData( _hx_array_data_0,6));
            	}
...
{
{
            	HX_STACK_FRAME("openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",10,0xe559e625)
HXLINE(  10)		FOCUS_IN = HX_("focusIn",dd,45,83,41);
            	}
{
            	HX_STACK_FRAME("openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",11,0xe559e625)
HXLINE(  11)		FOCUS_OUT = HX_("focusOut",96,6f,5e,11);
            	}
{
            	HX_STACK_FRAME("openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",12,0xe559e625)
HXLINE(  12)		KEY_FOCUS_CHANGE = HX_("keyFocusChange",09,9c,8e,e5);
            	}
{
            	HX_STACK_FRAME("openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",13,0xe559e625)
