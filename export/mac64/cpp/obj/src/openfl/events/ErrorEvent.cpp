...
Dynamic ErrorEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event ErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  22)		::String _hx_tmp = this->get_type();
HXDLIN(  22)		Bool _hx_tmp1 = this->get_bubbles();
HXDLIN(  22)		Bool _hx_tmp2 = this->get_cancelable();
HXDLIN(  22)		HX_VARI(  ::openfl::events::ErrorEvent,event) =  ::openfl::events::ErrorEvent_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,this->text,this->errorID);
HXLINE(  23)		 ::Dynamic _hx_tmp3 = this->get_target();
HXDLIN(  23)		event->set_target(_hx_tmp3);
HXLINE(  24)		 ::Dynamic _hx_tmp4 = this->get_currentTarget();
HXDLIN(  24)		event->set_currentTarget(_hx_tmp4);
HXLINE(  28)		return event;
            	}


::String ErrorEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.ErrorEvent","toString",0x299f6791,"openfl.events.ErrorEvent.toString","openfl/events/ErrorEvent.hx",35,0x9d2fc215)
            	HX_STACK_THIS(this)
HXLINE(  35)		return this->_hx___formatToString(HX_("ErrorEvent",52,bb,79,e1),::Array_obj< ::String >::fromData( _hx_array_data_0,5));
            	}
