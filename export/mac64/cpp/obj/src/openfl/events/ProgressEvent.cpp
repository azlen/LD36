...
Dynamic ProgressEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::_legacy::events::Event ProgressEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  26)		::String _hx_tmp = this->get_type();
HXDLIN(  26)		Bool _hx_tmp1 = this->get_bubbles();
HXDLIN(  26)		Bool _hx_tmp2 = this->get_cancelable();
HXDLIN(  26)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__new(_hx_tmp,_hx_tmp1,_hx_tmp2,this->bytesLoaded,this->bytesTotal);
HXLINE(  27)		 ::Dynamic _hx_tmp3 = this->get_target();
HXDLIN(  27)		event->set_target(_hx_tmp3);
HXLINE(  28)		 ::Dynamic _hx_tmp4 = this->get_currentTarget();
HXDLIN(  28)		event->set_currentTarget(_hx_tmp4);
HXLINE(  32)		return event;
            	}


::String ProgressEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.ProgressEvent","toString",0x8ba16d84,"openfl.events.ProgressEvent.toString","openfl/events/ProgressEvent.hx",39,0xea3bf808)
            	HX_STACK_THIS(this)
HXLINE(  39)		return this->_hx___formatToString(HX_("ProgressEvent",0d,9d,55,84),::Array_obj< ::String >::fromData( _hx_array_data_0,5));
            	}
