...
void Stage3D_obj::requestContext3D(::String __o_context3DRenderMode){
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",31,0x37141b9b)
HXLINE(  33)			_gthis->context3D =  ::openfl::display3D::Context3D_obj::__new();
HXLINE(  34)			_gthis->dispatchEvent( ::openfl::_legacy::events::Event_obj::__new(::openfl::_legacy::events::Event_obj::CONTEXT3D_CREATE,null(),null()));
            		}
