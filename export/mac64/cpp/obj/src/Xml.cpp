...
void Xml_obj::__construct(Int nodeType){
            	HX_STACK_FRAME("Xml","new",0x2e496e29,"Xml.new","/usr/local/lib/haxe/std/Xml.hx",370,0x5c1024e4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(nodeType,"nodeType")
HXLINE( 371)		this->nodeType = nodeType;
HXLINE( 372)		this->children = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 373)		this->attributeMap =  ::haxe::ds::StringMap_obj::__new();
            	}
...
hx::ObjectPtr< Xml_obj > Xml_obj::__new(Int nodeType)
{
	...
	_hx_result->__construct(nodeType);
	return _hx_result;
}
...
::String Xml_obj::get(::String att){
            	HX_STACK_FRAME("Xml","get",0x2e441e5f,"Xml.get","/usr/local/lib/haxe/std/Xml.hx",220,0x5c1024e4)
            	HX_STACK_THIS(this)
...
void Xml_obj::set(::String att,::String value){
            	HX_STACK_FRAME("Xml","set",0x2e4d396b,"Xml.set","/usr/local/lib/haxe/std/Xml.hx",231,0x5c1024e4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(att,"att")
...
Bool Xml_obj::exists(::String att){
            	HX_STACK_FRAME("Xml","exists",0x446683b3,"Xml.exists","/usr/local/lib/haxe/std/Xml.hx",253,0x5c1024e4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(att,"att")
...
HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,exists,return )
 ...
 ::Dynamic Xml_obj::elements(){
            	HX_STACK_FRAME("Xml","elements",0x0310ffce,"Xml.elements","/usr/local/lib/haxe/std/Xml.hx",283,0x5c1024e4)
            	HX_STACK_THIS(this)
...
HXLINE( 285)		HX_VARI( ::Array< ::Dynamic>,_g) = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 285)		{
HXLINE( 285)			HX_VARI( Int,_g1) = (int)0;
HXDLIN( 285)			HX_VARI( ::Array< ::Dynamic>,_g2) = this->children;
HXDLIN( 285)			while((_g1 < _g2->length)){
HXLINE( 285)				HX_VARI(  ::Xml,child) = _g2->__get(_g1).StaticCast<  ::Xml >();
HXDLIN( 285)				++_g1;
HXDLIN( 285)				Bool _hx_tmp1 = (child->nodeType == ::Xml_obj::Element);
HXDLIN( 285)				if (_hx_tmp1) {
HXLINE( 285)					_g->push(child);
            				}
            			}
            		}
HXLINE( 286)		return _g->iterator();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Xml_obj,elements,return )
 ...
 ::Dynamic Xml_obj::elementsNamed(::String name){
            	HX_STACK_FRAME("Xml","elementsNamed",0x6b28f50b,"Xml.elementsNamed","/usr/local/lib/haxe/std/Xml.hx",293,0x5c1024e4)
            	HX_STACK_THIS(this)
...
HXLINE( 295)		HX_VARI( ::Array< ::Dynamic>,_g) = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 295)		{
HXLINE( 295)			HX_VARI( Int,_g1) = (int)0;
HXDLIN( 295)			HX_VARI( ::Array< ::Dynamic>,_g2) = this->children;
HXDLIN( 295)			while((_g1 < _g2->length)){
HXLINE( 295)				HX_VARI(  ::Xml,child) = _g2->__get(_g1).StaticCast<  ::Xml >();
HXDLIN( 295)				++_g1;
...
HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,elementsNamed,return )
 ...
 ::Xml Xml_obj::firstElement(){
            	HX_STACK_FRAME("Xml","firstElement",0xc103a583,"Xml.firstElement","/usr/local/lib/haxe/std/Xml.hx",310,0x5c1024e4)
            	HX_STACK_THIS(this)
...
HXDLIN( 312)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->children;
HXDLIN( 312)			while((_g < _g1->length)){
HXLINE( 312)				HX_VARI(  ::Xml,child) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN( 312)				++_g;
...
void Xml_obj::addChild( ::Xml x){
            	HX_STACK_FRAME("Xml","addChild",0x3e639952,"Xml.addChild","/usr/local/lib/haxe/std/Xml.hx",326,0x5c1024e4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
HXLINE( 328)		Bool _hx_tmp1 = hx::IsNotNull( x->parent );
...
Bool Xml_obj::removeChild( ::Xml x){
            	HX_STACK_FRAME("Xml","removeChild",0x9bd39581,"Xml.removeChild","/usr/local/lib/haxe/std/Xml.hx",339,0x5c1024e4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
HXLINE( 341)		Bool _hx_tmp1 = this->children->remove(x);
...
Int Xml_obj::Document;
 ...
 ::Xml Xml_obj::parse(::String str){
            	HX_STACK_FRAME("Xml","parse",0x8a44f23c,"Xml.parse","/usr/local/lib/haxe/std/Xml.hx",98,0x5c1024e4)
            	HX_STACK_ARG(str,"str")
HXLINE(  98)		return ::haxe::xml::Parser_obj::parse(str,null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,parse,return )
 ...
 ::Xml Xml_obj::createElement(::String name){
            	HX_STACK_FRAME("Xml","createElement",0x97359a29,"Xml.createElement","/usr/local/lib/haxe/std/Xml.hx",158,0x5c1024e4)
            	HX_STACK_ARG(name,"name")
HXLINE( 159)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__new(::Xml_obj::Element);
HXLINE( 160)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createElement,return )
 ...
 ::Xml Xml_obj::createPCData(::String data){
            	HX_STACK_FRAME("Xml","createPCData",0x3cc9ead0,"Xml.createPCData","/usr/local/lib/haxe/std/Xml.hx",167,0x5c1024e4)
            	HX_STACK_ARG(data,"data")
HXLINE( 168)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__new(::Xml_obj::PCData);
HXLINE( 169)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createPCData,return )
 ...
 ::Xml Xml_obj::createCData(::String data){
            	HX_STACK_FRAME("Xml","createCData",0xaf49365a,"Xml.createCData","/usr/local/lib/haxe/std/Xml.hx",176,0x5c1024e4)
            	HX_STACK_ARG(data,"data")
HXLINE( 177)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__new(::Xml_obj::CData);
HXLINE( 178)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createCData,return )
 ...
 ::Xml Xml_obj::createComment(::String data){
            	HX_STACK_FRAME("Xml","createComment",0x125165cc,"Xml.createComment","/usr/local/lib/haxe/std/Xml.hx",185,0x5c1024e4)
            	HX_STACK_ARG(data,"data")
HXLINE( 186)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__new(::Xml_obj::Comment);
HXLINE( 187)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createComment,return )
 ...
 ::Xml Xml_obj::createDocType(::String data){
            	HX_STACK_FRAME("Xml","createDocType",0x696de8bf,"Xml.createDocType","/usr/local/lib/haxe/std/Xml.hx",194,0x5c1024e4)
            	HX_STACK_ARG(data,"data")
HXLINE( 195)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__new(::Xml_obj::DocType);
HXLINE( 196)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createDocType,return )
 ...
 ::Xml Xml_obj::createProcessingInstruction(::String data){
            	HX_STACK_FRAME("Xml","createProcessingInstruction",0x632a1f28,"Xml.createProcessingInstruction","/usr/local/lib/haxe/std/Xml.hx",203,0x5c1024e4)
            	HX_STACK_ARG(data,"data")
HXLINE( 204)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__new(::Xml_obj::ProcessingInstruction);
HXLINE( 205)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createProcessingInstruction,return )
 ...
 ::Xml Xml_obj::createDocument(){
            	HX_STACK_FRAME("Xml","createDocument",0xcf00030e,"Xml.createDocument","/usr/local/lib/haxe/std/Xml.hx",213,0x5c1024e4)
HXLINE( 213)		return  ::Xml_obj::__new(::Xml_obj::Document);
            	}
...
{
{
            	HX_STACK_FRAME("Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",68,0x5c1024e4)
HXLINE(  68)		Element = (int)0;
            	}
{
            	HX_STACK_FRAME("Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",72,0x5c1024e4)
HXLINE(  72)		PCData = (int)1;
            	}
{
            	HX_STACK_FRAME("Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",76,0x5c1024e4)
HXLINE(  76)		CData = (int)2;
            	}
{
            	HX_STACK_FRAME("Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",80,0x5c1024e4)
HXLINE(  80)		Comment = (int)3;
            	}
{
            	HX_STACK_FRAME("Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",84,0x5c1024e4)
HXLINE(  84)		DocType = (int)4;
            	}
{
            	HX_STACK_FRAME("Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",88,0x5c1024e4)
HXLINE(  88)		ProcessingInstruction = (int)5;
            	}
{
            	HX_STACK_FRAME("Xml","boot",0x4a0ff649,"Xml.boot","/usr/local/lib/haxe/std/Xml.hx",92,0x5c1024e4)
HXLINE(  92)		Document = (int)6;
            	}
}
