...
void ObjectMap_obj::__construct(){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",52,0xa4879efa)
            	HX_STACK_THIS(this)
            	}
...
void ObjectMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","set",0x27b31fda,"haxe.ds.ObjectMap.set","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",55,0xa4879efa)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(ObjectMap_obj,set,(void))
 ...
 ::Dynamic ObjectMap_obj::get( ::Dynamic key){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",59,0xa4879efa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool ObjectMap_obj::exists( ::Dynamic key){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","exists",0xc8930ca4,"haxe.ds.ObjectMap.exists","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",63,0xa4879efa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool ObjectMap_obj::remove( ::Dynamic key){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","remove",0x0d3b8b0c,"haxe.ds.ObjectMap.remove","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",67,0xa4879efa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectMap_obj,remove,return )
 ...
 ::Dynamic ObjectMap_obj::keys(){
            	HX_STACK_FRAME("haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",70,0xa4879efa)
            	HX_STACK_THIS(this)
