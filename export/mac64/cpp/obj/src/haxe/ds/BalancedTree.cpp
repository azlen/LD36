...
void BalancedTree_obj::__construct(){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","new",0xfb50b0cf,"haxe.ds.BalancedTree.new","/usr/local/lib/haxe/std/haxe/ds/BalancedTree.hx",41,0xee0b42c4)
            	HX_STACK_THIS(this)
            	}
...
void BalancedTree_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","set",0xfb547c11,"haxe.ds.BalancedTree.set","/usr/local/lib/haxe/std/haxe/ds/BalancedTree.hx",51,0xee0b42c4)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(BalancedTree_obj,set,(void))
 ...
 ::Dynamic BalancedTree_obj::get( ::Dynamic key){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","get",0xfb4b6105,"haxe.ds.BalancedTree.get","/usr/local/lib/haxe/std/haxe/ds/BalancedTree.hx",61,0xee0b42c4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
HXLINE(  62)		HX_VARI(  ::haxe::ds::TreeNode,node) = this->root;
HXLINE(  63)		while(true){
HXLINE(  63)			Bool _hx_tmp = !(hx::IsNotNull( node ));
...
HX_DEFINE_DYNAMIC_FUNC1(BalancedTree_obj,get,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::setLoop( ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode node){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","setLoop",0xe1a32b15,"haxe.ds.BalancedTree.setLoop","/usr/local/lib/haxe/std/haxe/ds/BalancedTree.hx",132,0xee0b42c4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(k,"k")
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(node,"node")
HXLINE( 133)		Bool _hx_tmp = hx::IsNull( node );
...
HXLINE( 135)			Int _hx_tmp1;
HXDLIN( 135)			Bool _hx_tmp2 = hx::IsNull( node );
HXDLIN( 135)			if (_hx_tmp2) {
HXLINE( 135)				_hx_tmp1 = (int)0;
            			}
            			else {
HXLINE( 135)				_hx_tmp1 = node->_height;
            			}
HXDLIN( 135)			return  ::haxe::ds::TreeNode_obj::__new(node->left,k,v,node->right,_hx_tmp1);
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC3(BalancedTree_obj,setLoop,return )
 ...
 ::haxe::ds::TreeNode BalancedTree_obj::balance( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","balance",0xf7f4e10b,"haxe.ds.BalancedTree.balance","/usr/local/lib/haxe/std/haxe/ds/BalancedTree.hx",187,0xee0b42c4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(l,"l")
            	HX_STACK_ARG(k,"k")
            	HX_STACK_ARG(v,"v")
...
HXDLIN( 188)		Bool _hx_tmp = hx::IsNull( l );
...
HXDLIN( 189)		Bool _hx_tmp1 = hx::IsNull( r );
...
HXDLIN( 191)			Bool _hx_tmp3 = hx::IsNull( _this );
HXDLIN( 191)			if (_hx_tmp3) {
HXLINE( 191)				_hx_tmp2 = (int)0;
            			}
            			else {
HXLINE( 191)				_hx_tmp2 = _this->_height;
            			}
HXDLIN( 191)			HX_VARI_NAME(  ::haxe::ds::TreeNode,_this1,"_this") = l->right;
HXDLIN( 191)			Int _hx_tmp4;
HXDLIN( 191)			Bool _hx_tmp5 = hx::IsNull( _this1 );
HXDLIN( 191)			if (_hx_tmp5) {
HXLINE( 191)				_hx_tmp4 = (int)0;
            			}
            			else {
HXLINE( 191)				_hx_tmp4 = _this1->_height;
            			}
HXDLIN( 191)			if ((_hx_tmp2 >= _hx_tmp4)) {
HXLINE( 190)				return  ::haxe::ds::TreeNode_obj::__new(l->left,l->key,l->value, ::haxe::ds::TreeNode_obj::__new(l->right,k,v,r,null()),null());
            			}
            			else {
HXLINE( 192)				 ::haxe::ds::TreeNode _hx_tmp6 =  ::haxe::ds::TreeNode_obj::__new(l->left,l->key,l->value,l->right->left,null());
HXLINE( 190)				return  ::haxe::ds::TreeNode_obj::__new(_hx_tmp6,l->right->key,l->right->value, ::haxe::ds::TreeNode_obj::__new(l->right->right,k,v,r,null()),null());
            			}
            		}
            		else {
...
HXDLIN( 194)				Bool _hx_tmp8 = hx::IsNull( _this2 );
HXDLIN( 194)				if (_hx_tmp8) {
HXLINE( 194)					_hx_tmp7 = (int)0;
            				}
            				else {
HXLINE( 194)					_hx_tmp7 = _this2->_height;
            				}
HXDLIN( 194)				HX_VARI_NAME(  ::haxe::ds::TreeNode,_this3,"_this") = r->left;
HXDLIN( 194)				Int _hx_tmp9;
HXDLIN( 194)				Bool _hx_tmp10 = hx::IsNull( _this3 );
HXDLIN( 194)				if (_hx_tmp10) {
HXLINE( 194)					_hx_tmp9 = (int)0;
            				}
            				else {
HXLINE( 194)					_hx_tmp9 = _this3->_height;
            				}
HXDLIN( 194)				if ((_hx_tmp7 > _hx_tmp9)) {
HXLINE( 190)					return  ::haxe::ds::TreeNode_obj::__new( ::haxe::ds::TreeNode_obj::__new(l,k,v,r->left,null()),r->key,r->value,r->right,null());
            				}
            				else {
HXLINE( 195)					 ::haxe::ds::TreeNode _hx_tmp11 =  ::haxe::ds::TreeNode_obj::__new(l,k,v,r->left->left,null());
HXLINE( 190)					return  ::haxe::ds::TreeNode_obj::__new(_hx_tmp11,r->left->key,r->left->value, ::haxe::ds::TreeNode_obj::__new(r->left->right,r->key,r->value,r->right,null()),null());
            				}
            			}
            			else {
HXLINE( 197)				Int _hx_tmp12;
HXDLIN( 197)				if ((hl > hr)) {
HXLINE( 197)					_hx_tmp12 = hl;
            				}
            				else {
HXLINE( 197)					_hx_tmp12 = hr;
            				}
HXLINE( 190)				return  ::haxe::ds::TreeNode_obj::__new(l,k,v,r,(_hx_tmp12 + (int)1));
            			}
            		}
...
Int BalancedTree_obj::compare( ::Dynamic k1, ::Dynamic k2){
            	HX_STACK_FRAME("haxe.ds.BalancedTree","compare",0x57d05c94,"haxe.ds.BalancedTree.compare","/usr/local/lib/haxe/std/haxe/ds/BalancedTree.hx",202,0xee0b42c4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(k1,"k1")
            	HX_STACK_ARG(k2,"k2")
