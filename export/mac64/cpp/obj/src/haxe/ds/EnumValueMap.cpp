...
void EnumValueMap_obj::__construct(){
            	HX_STACK_FRAME("haxe.ds.EnumValueMap","new",0x9ce29655,"haxe.ds.EnumValueMap.new","/usr/local/lib/haxe/std/haxe/ds/EnumValueMap.hx",31,0xc570effe)
            	HX_STACK_THIS(this)
...
Int EnumValueMap_obj::compare( ::Dynamic _tmp_k1, ::Dynamic _tmp_k2){
            	HX_STACK_FRAME("haxe.ds.EnumValueMap","compare",0x806a7d1a,"haxe.ds.EnumValueMap.compare","/usr/local/lib/haxe/std/haxe/ds/EnumValueMap.hx",33,0xc570effe)
            	HX_STACK_THIS(this)
...
Int EnumValueMap_obj::compareArgs(::cpp::VirtualArray a1,::cpp::VirtualArray a2){
            	HX_STACK_FRAME("haxe.ds.EnumValueMap","compareArgs",0x37a5cb97,"haxe.ds.EnumValueMap.compareArgs","/usr/local/lib/haxe/std/haxe/ds/EnumValueMap.hx",42,0xc570effe)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a1,"a1")
            	HX_STACK_ARG(a2,"a2")
...
HXLINE(  46)				 ::Dynamic _hx_tmp = a1->__get(i);
HXDLIN(  46)				 ::Dynamic _hx_tmp1 = a2->__get(i);
HXDLIN(  46)				HX_VARI( Int,d) = this->compareArg(_hx_tmp,_hx_tmp1);
...
Int EnumValueMap_obj::compareArg( ::Dynamic v1, ::Dynamic v2){
            	HX_STACK_FRAME("haxe.ds.EnumValueMap","compareArg",0xcee2e55c,"haxe.ds.EnumValueMap.compareArg","/usr/local/lib/haxe/std/haxe/ds/EnumValueMap.hx",53,0xc570effe)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v1,"v1")
            	HX_STACK_ARG(v2,"v2")
