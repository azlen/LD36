...
void IntMap_obj::__construct(){
            	HX_STACK_FRAME("haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/IntMap.hx",53,0xc8b34118)
            	HX_STACK_THIS(this)
            	}
...
void IntMap_obj::set(Int key, ::Dynamic value){
            	HX_STACK_FRAME("haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/IntMap.hx",56,0xc8b34118)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(IntMap_obj,set,(void))
 ...
 ::Dynamic IntMap_obj::get(Int key){
            	HX_STACK_FRAME("haxe.ds.IntMap","get",0x721d74ec,"haxe.ds.IntMap.get","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/IntMap.hx",60,0xc8b34118)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool IntMap_obj::exists(Int key){
            	HX_STACK_FRAME("haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/IntMap.hx",64,0xc8b34118)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool IntMap_obj::remove(Int key){
            	HX_STACK_FRAME("haxe.ds.IntMap","remove",0xa86281ae,"haxe.ds.IntMap.remove","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/IntMap.hx",68,0xc8b34118)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
HX_DEFINE_DYNAMIC_FUNC1(IntMap_obj,remove,return )
 ...
 ::Dynamic IntMap_obj::keys(){
            	HX_STACK_FRAME("haxe.ds.IntMap","keys",0x6a4db8de,"haxe.ds.IntMap.keys","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/IntMap.hx",71,0xc8b34118)
            	HX_STACK_THIS(this)
