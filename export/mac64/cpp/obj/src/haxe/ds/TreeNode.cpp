...
Int h = __o_h.Default(-1);
            	HX_STACK_FRAME("haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","/usr/local/lib/haxe/std/haxe/ds/BalancedTree.hx",223,0xee0b42c4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(l,"l")
            	HX_STACK_ARG(k,"k")
            	HX_STACK_ARG(v,"v")
...
HXDLIN( 229)			HX_VARI(  ::haxe::ds::TreeNode,_this) = this->left;
HXDLIN( 229)			Int _hx_tmp1;
HXDLIN( 229)			Bool _hx_tmp2 = hx::IsNull( _this );
...
HXDLIN( 229)			HX_VARI_NAME(  ::haxe::ds::TreeNode,_this1,"_this") = this->right;
HXDLIN( 229)			Int _hx_tmp3;
HXDLIN( 229)			Bool _hx_tmp4 = hx::IsNull( _this1 );
HXDLIN( 229)			if (_hx_tmp4) {
HXLINE( 229)				_hx_tmp3 = (int)0;
            			}
            			else {
HXLINE( 229)				_hx_tmp3 = _this1->_height;
            			}
HXDLIN( 229)			if ((_hx_tmp1 > _hx_tmp3)) {
HXLINE( 229)				HX_VARI_NAME(  ::haxe::ds::TreeNode,_this2,"_this") = this->left;
HXDLIN( 229)				Bool _hx_tmp5 = hx::IsNull( _this2 );
...
HXLINE( 229)				HX_VARI_NAME(  ::haxe::ds::TreeNode,_this3,"_this") = this->right;
HXDLIN( 229)				Bool _hx_tmp6 = hx::IsNull( _this3 );
...
hx::ObjectPtr< TreeNode_obj > TreeNode_obj::__new( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r,hx::Null< Int >  __o_h)
{
	...
	_hx_result->__construct(l,k,v,r,__o_h);
	return _hx_result;
}
