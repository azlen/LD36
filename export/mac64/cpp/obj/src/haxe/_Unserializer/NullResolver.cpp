...
void NullResolver_obj::__construct(){
            	HX_STACK_FRAME("haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","/usr/local/lib/haxe/std/haxe/Unserializer.hx",477,0x60de4a67)
            	HX_STACK_THIS(this)
            	}
...
hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACK_FRAME("haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","/usr/local/lib/haxe/std/haxe/Unserializer.hx",478,0x60de4a67)
            	HX_STACK_THIS(this)
...
hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACK_FRAME("haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","/usr/local/lib/haxe/std/haxe/Unserializer.hx",479,0x60de4a67)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
