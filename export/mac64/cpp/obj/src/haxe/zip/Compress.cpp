...
void Compress_obj::__construct(Int level){
            	HX_STACK_FRAME("haxe.zip.Compress","new",0x4ddc50a9,"haxe.zip.Compress.new","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",30,0x9f8c8027)
            	HX_STACK_THIS(this)
...
Dynamic Compress_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Compress_obj::execute( ::haxe::io::Bytes src,Int srcPos, ::haxe::io::Bytes dst,Int dstPos){
            	HX_STACK_FRAME("haxe.zip.Compress","execute",0xd015e2fe,"haxe.zip.Compress.execute","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",34,0x9f8c8027)
            	HX_STACK_THIS(this)
...
void Compress_obj::setFlushMode(::hx::EnumBase f){
            	HX_STACK_FRAME("haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",38,0x9f8c8027)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
HXLINE(  38)		 ::Dynamic _hx_tmp = this->s;
HXDLIN(  38)		::String _hx_tmp1 = ::Std_obj::string(f);
HXDLIN(  38)		_hx_zip_set_flush_mode(_hx_tmp,_hx_tmp1);
            	}
...
void Compress_obj::close(){
            	HX_STACK_FRAME("haxe.zip.Compress","close",0x6942fc41,"haxe.zip.Compress.close","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",42,0x9f8c8027)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Compress_obj,close,(void))
 ...
 ::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,Int level){
            	HX_STACK_FRAME("haxe.zip.Compress","run",0x4ddf6794,"haxe.zip.Compress.run","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",45,0x9f8c8027)
            	HX_STACK_ARG(s,"s")
            	HX_STACK_ARG(level,"level")
HXLINE(  46)		HX_VARI(  ::haxe::zip::Compress,c) =  ::haxe::zip::Compress_obj::__new(level);
HXLINE(  47)		c->setFlushMode(::haxe::zip::FlushMode_obj::FINISH_dyn());
HXLINE(  48)		Int _hx_tmp = _hx_deflate_bound(c->s,s->length);
HXDLIN(  48)		HX_VARI(  ::haxe::io::Bytes,out) = ::haxe::io::Bytes_obj::alloc(_hx_tmp);
...
HXLINE(  51)			_hx_tmp1 = (( (Int)(r->__Field(HX_("read",56,4b,a7,4b),hx::paccDynamic)) ) != s->length);
            		}
            		else {
...
HXLINE(  53)		return out->sub((int)0, ::Dynamic(r->__Field(HX_("write",df,6c,59,d0),hx::paccDynamic)));
            	}
