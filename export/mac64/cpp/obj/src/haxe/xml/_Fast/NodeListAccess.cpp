...
void NodeListAccess_obj::__construct( ::Xml x){
            	HX_STACK_FRAME("haxe.xml._Fast.NodeListAccess","new",0x22c8c708,"haxe.xml._Fast.NodeListAccess.new","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",97,0x1680b11e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
HXLINE(  97)		this->_hx___x = x;
            	}
...
Dynamic NodeListAccess_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::List NodeListAccess_obj::resolve(::String name){
            	HX_STACK_FRAME("haxe.xml._Fast.NodeListAccess","resolve",0x21d97d94,"haxe.xml._Fast.NodeListAccess.resolve","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",100,0x1680b11e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE( 101)		HX_VARI(  ::List,l) =  ::List_obj::__new();
HXLINE( 102)		{
HXLINE( 102)			HX_VARI(  ::Dynamic,tmp) = this->_hx___x->elementsNamed(name);
...
HXDLIN( 102)				HX_VARI(  ::Xml,x) = ( ( ::Xml)( ::Dynamic(tmp->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 103)				l->add( ::haxe::xml::Fast_obj::__new(x));
            			}
            			_hx_goto_0:;
            		}
HXLINE( 104)		return l;
