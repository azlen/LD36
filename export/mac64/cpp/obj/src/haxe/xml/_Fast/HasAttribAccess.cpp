...
void HasAttribAccess_obj::__construct( ::Xml x){
            	HX_STACK_FRAME("haxe.xml._Fast.HasAttribAccess","new",0x4d025ce8,"haxe.xml._Fast.HasAttribAccess.new","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",67,0x1680b11e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
Bool HasAttribAccess_obj::resolve(::String name){
            	HX_STACK_FRAME("haxe.xml._Fast.HasAttribAccess","resolve",0x0ac38374,"haxe.xml._Fast.HasAttribAccess.resolve","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",70,0x1680b11e)
            	HX_STACK_THIS(this)
