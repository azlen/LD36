...
void Unserializer_obj::__construct(::String buf){
            	HX_STACK_FRAME("haxe.Unserializer","new",0xa8f5e205,"haxe.Unserializer.new","/usr/local/lib/haxe/std/haxe/Unserializer.hx",102,0x60de4a67)
            	HX_STACK_THIS(this)
...
void Unserializer_obj::setResolver( ::Dynamic r){
            	HX_STACK_FRAME("haxe.Unserializer","setResolver",0x5545046d,"haxe.Unserializer.setResolver","/usr/local/lib/haxe/std/haxe/Unserializer.hx",128,0x60de4a67)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(r,"r")
HXLINE( 128)		Bool _hx_tmp = hx::IsNull( r );
HXDLIN( 128)		if (_hx_tmp) {
HXLINE( 129)			Bool _hx_tmp1 = hx::IsNull( ::haxe::_Unserializer::NullResolver_obj::instance );
HXDLIN( 129)			if (_hx_tmp1) {
HXLINE( 129)				::haxe::_Unserializer::NullResolver_obj::instance =  ::haxe::_Unserializer::NullResolver_obj::__new();
            			}
...
Int Unserializer_obj::readDigits(){
            	HX_STACK_FRAME("haxe.Unserializer","readDigits",0x75598b17,"haxe.Unserializer.readDigits","/usr/local/lib/haxe/std/haxe/Unserializer.hx",147,0x60de4a67)
            	HX_STACK_THIS(this)
...
Float Unserializer_obj::readFloat(){
            	HX_STACK_FRAME("haxe.Unserializer","readFloat",0x5bd86dcb,"haxe.Unserializer.readFloat","/usr/local/lib/haxe/std/haxe/Unserializer.hx",172,0x60de4a67)
            	HX_STACK_THIS(this)
...
void Unserializer_obj::unserializeObject( ::Dynamic o){
            	HX_STACK_FRAME("haxe.Unserializer","unserializeObject",0x1b3e66eb,"haxe.Unserializer.unserializeObject","/usr/local/lib/haxe/std/haxe/Unserializer.hx",186,0x60de4a67)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(o,"o")
...
HX_DEFINE_DYNAMIC_FUNC1(Unserializer_obj,unserializeObject,(void))
 ...
 ::Dynamic Unserializer_obj::unserializeEnum(hx::Class edecl,::String tag){
            	HX_STACK_FRAME("haxe.Unserializer","unserializeEnum",0x5018b02d,"haxe.Unserializer.unserializeEnum","/usr/local/lib/haxe/std/haxe/Unserializer.hx",201,0x60de4a67)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC2(Unserializer_obj,unserializeEnum,return )
 ...
 ::Dynamic Unserializer_obj::unserialize(){
            	HX_STACK_FRAME("haxe.Unserializer","unserialize",0x92cca30c,"haxe.Unserializer.unserialize","/usr/local/lib/haxe/std/haxe/Unserializer.hx",233,0x60de4a67)
            	HX_STACK_THIS(this)
HXLINE( 234)		{
...
::Array< Int > Unserializer_obj::initCodes(){
            	HX_STACK_FRAME("haxe.Unserializer","initCodes",0xee42ccdb,"haxe.Unserializer.initCodes","/usr/local/lib/haxe/std/haxe/Unserializer.hx",70,0x60de4a67)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Unserializer_obj,initCodes,return )
 ...
 ::Dynamic Unserializer_obj::run(::String v){
            	HX_STACK_FRAME("haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","/usr/local/lib/haxe/std/haxe/Unserializer.hx",461,0x60de4a67)
            	HX_STACK_ARG(v,"v")
...
{
{
            	HX_STACK_FRAME("haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","/usr/local/lib/haxe/std/haxe/Unserializer.hx",63,0x60de4a67)
HXLINE(  63)		DEFAULT_RESOLVER =  ::haxe::_Unserializer::DefaultResolver_obj::__new();
            	}
{
            	HX_STACK_FRAME("haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","/usr/local/lib/haxe/std/haxe/Unserializer.hx",65,0x60de4a67)
HXLINE(  65)		BASE64 = HX_("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%:",d4,3b,03,7f);
            	}
{
            	HX_STACK_FRAME("haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","/usr/local/lib/haxe/std/haxe/Unserializer.hx",68,0x60de4a67)
