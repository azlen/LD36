...
void Serializer_obj::__construct(){
            	HX_STACK_FRAME("haxe.Serializer","new",0xcdbbc7ec,"haxe.Serializer.new","/usr/local/lib/haxe/std/haxe/Serializer.hx",101,0xdc8a8f60)
            	HX_STACK_THIS(this)
...
::String Serializer_obj::toString(){
            	HX_STACK_FRAME("haxe.Serializer","toString",0x95bdfda0,"haxe.Serializer.toString","/usr/local/lib/haxe/std/haxe/Serializer.hx",117,0xdc8a8f60)
            	HX_STACK_THIS(this)
...
void Serializer_obj::serializeString(::String s){
            	HX_STACK_FRAME("haxe.Serializer","serializeString",0xd565bc5d,"haxe.Serializer.serializeString","/usr/local/lib/haxe/std/haxe/Serializer.hx",153,0xdc8a8f60)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
...
Bool Serializer_obj::serializeRef( ::Dynamic v){
            	HX_STACK_FRAME("haxe.Serializer","serializeRef",0x0b8ed647,"haxe.Serializer.serializeRef","/usr/local/lib/haxe/std/haxe/Serializer.hx",172,0xdc8a8f60)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 176)		{
...
void Serializer_obj::serializeFields( ::Dynamic v){
            	HX_STACK_FRAME("haxe.Serializer","serializeFields",0x44c42205,"haxe.Serializer.serializeFields","/usr/local/lib/haxe/std/haxe/Serializer.hx",209,0xdc8a8f60)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 210)		{
...
void Serializer_obj::serialize( ::Dynamic v){
            	HX_STACK_FRAME("haxe.Serializer","serialize",0x3cea866c,"haxe.Serializer.serialize","/usr/local/lib/haxe/std/haxe/Serializer.hx",228,0xdc8a8f60)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
...
::String Serializer_obj::run( ::Dynamic v){
            	HX_STACK_FRAME("haxe.Serializer","run",0xcdbeded7,"haxe.Serializer.run","/usr/local/lib/haxe/std/haxe/Serializer.hx",551,0xdc8a8f60)
            	HX_STACK_ARG(v,"v")
...
{
{
            	HX_STACK_FRAME("haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/local/lib/haxe/std/haxe/Serializer.hx",55,0xdc8a8f60)
HXLINE(  55)		USE_CACHE = false;
            	}
{
            	HX_STACK_FRAME("haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/local/lib/haxe/std/haxe/Serializer.hx",67,0xdc8a8f60)
HXLINE(  67)		USE_ENUM_INDEX = false;
            	}
{
            	HX_STACK_FRAME("haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/local/lib/haxe/std/haxe/Serializer.hx",69,0xdc8a8f60)
HXLINE(  69)		BASE64 = HX_("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%:",d4,3b,03,7f);
            	}
{
            	HX_STACK_FRAME("haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/local/lib/haxe/std/haxe/Serializer.hx",70,0xdc8a8f60)
