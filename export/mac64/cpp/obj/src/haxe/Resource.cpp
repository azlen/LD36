...
Dynamic Resource_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACK_FRAME("haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","/usr/local/lib/haxe/std/cpp/_std/haxe/Resource.hx",33,0xfd53b169)
            	HX_STACK_ARG(name,"name")
HXLINE(  34)		HX_VARI( ::Array< unsigned char >,array) = ::__hxcpp_resource_bytes(name);
HXLINE(  35)		Bool _hx_tmp = hx::IsNull( array );
