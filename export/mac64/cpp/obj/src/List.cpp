...
void List_obj::__construct(){
            	HX_STACK_FRAME("List","new",0xed890070,"List.new","/usr/local/lib/haxe/std/List.hx",44,0xdb880ee3)
            	HX_STACK_THIS(this)
...
void List_obj::add( ::Dynamic item){
            	HX_STACK_FRAME("List","add",0xed7f2231,"List.add","/usr/local/lib/haxe/std/List.hx",52,0xdb880ee3)
            	HX_STACK_THIS(this)
...
void List_obj::push( ::Dynamic item){
            	HX_STACK_FRAME("List","push",0xebb5efca,"List.push","/usr/local/lib/haxe/std/List.hx",67,0xdb880ee3)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(item,"item")
...
Bool List_obj::remove( ::Dynamic v){
            	HX_STACK_FRAME("List","remove",0x4b44d634,"List.remove","/usr/local/lib/haxe/std/List.hx",137,0xdb880ee3)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 138)		HX_VARI(  ::_List::ListNode,prev) = null();
HXLINE( 139)		HX_VARI(  ::_List::ListNode,l) = this->h;
HXLINE( 140)		while(true){
HXLINE( 140)			Bool _hx_tmp = !(hx::IsNotNull( l ));
HXDLIN( 140)			if (_hx_tmp) {
HXLINE( 140)				goto _hx_goto_0;
            			}
HXLINE( 141)			if (hx::IsEq( l->item,v )) {
HXLINE( 142)				Bool _hx_tmp1 = hx::IsNull( prev );
