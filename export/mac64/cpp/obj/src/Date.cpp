...
void Date_obj::__construct(Int year,Int month,Int day,Int hour,Int min,Int sec){
            	HX_STACK_FRAME("Date","new",0x9aa26240,"Date.new","/usr/local/lib/haxe/std/cpp/_std/Date.hx",27,0xd1a513ee)
            	HX_STACK_THIS(this)
...
Float Date_obj::getTime(){
            	HX_STACK_FRAME("Date","getTime",0x0cac7da3,"Date.getTime","/usr/local/lib/haxe/std/cpp/_std/Date.hx",31,0xd1a513ee)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,getTime,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACK_FRAME("Date","now",0x9aa26af6,"Date.now","/usr/local/lib/haxe/std/cpp/_std/Date.hx",51,0xd1a513ee)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::new1( ::Dynamic t){
            	HX_STACK_FRAME("Date","new1",0xb37395f1,"Date.new1","/usr/local/lib/haxe/std/cpp/_std/Date.hx",54,0xd1a513ee)
            	HX_STACK_ARG(t,"t")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,new1,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_STACK_FRAME("Date","fromTime",0x44fd3cb7,"Date.fromTime","/usr/local/lib/haxe/std/cpp/_std/Date.hx",57,0xd1a513ee)
            	HX_STACK_ARG(t,"t")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_STACK_FRAME("Date","fromString",0x5ead97fb,"Date.fromString","/usr/local/lib/haxe/std/cpp/_std/Date.hx",64,0xd1a513ee)
            	HX_STACK_ARG(s,"s")
