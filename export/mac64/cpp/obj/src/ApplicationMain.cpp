...
HXLINE( 115)				 ::Dynamic _hx_tmp1 = ::Reflect_obj::field(hx::ClassOf< ::Main >(),HX_("main",39,38,56,48));
HXDLIN( 115)				::Reflect_obj::callMethod(hx::ClassOf< ::Main >(),_hx_tmp1,::cpp::VirtualArray_obj::__new(0));
            			}
            			else {
...
HXLINE( 121)				Bool _hx_tmp2 = ::Std_obj::is(instance,hx::ClassOf< ::openfl::_legacy::display::DisplayObject >());
...
HXLINE(  29)		::openfl::_legacy::Lib_obj::setPackage(HX_("HaxeFlixel",42,8f,0c,ac),HX_("HelloWorld",00,76,b5,bd),HX_("com.example.myapp",84,30,57,c1),HX_("0.0.1",35,3d,c8,c1));
...
HXLINE(  52)		::openfl::_legacy::Lib_obj::create( ::Dynamic(new _hx_Closure_0()),(int)1080,(int)675,(int)60,(int)0,((int)((int)_hx_tmp | (int)(int)0) | (int)(int)0),HX_("HelloWorld",00,76,b5,bd),null(),null());
            	}
