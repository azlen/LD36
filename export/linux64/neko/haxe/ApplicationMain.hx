...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "HelloWorld", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "HelloWorld";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HelloWorld", null, { width: 1080, height: 675 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1080, height: 675 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 1080, 675, "null");
		#end
		#else
		create ();
		#end
